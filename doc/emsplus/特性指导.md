...
数据规划 :根据假设的场景，EMSPlus内部IP规划参见[表1](#d0e631__EMSPlus%E5%86%85%E9%83%A8IP%E8%A7%84%E5%88%92-3A76FB88)。
名称|地址|模块号
---|---|---
...
配置步骤 :手工部署时，根据规划进行配置，参见[表2](#d0e631__%E9%85%8D%E7%BD%AE%E6%AD%A5%E9%AA%A4%E4%BF%A1%E6%81%AF-3A771330)。实例化部署时，所有的配置都可以在Inputs参数中配置。
步骤|说明|操作
---|---|---
...
步骤 :在EMSPlus客户端的Logging或者IPDR窗口，单击功能操作区的Task，功能操作区显示已有的定时任务，如[图1](#%E5%88%9B%E5%BB%BA%E5%AE%9A%E6%97%B6%E4%BB%BB%E5%8A%A1-2BA66428__369e8a95-8429-4174-8e2f-58b210528b9d)所示。
图1  定时任务列表
...
配置前提 :已加载License文件。 
配置过程 :在命令终端窗口执行[CHECK CONSISTENCY](None)命令。
配置实例 :场景说明 :导入License文件后，当需要确认各节点License是否一致时，执行[CHECK CONSISTENCY](None)命令。
...
配置过程 :选择目标节点模块号，执行[SYNC LICENSE](None)命令。命令参数说明参见[表1](#z03b959bee9db41fb97d699c40413a509__7c4d01fa-f79e-423e-891e-06cebcb284b6)。
参数名称|参数说明
---|---
MODULE|目标节点模块号。当该参数为空时，默认选择全部的业务节点。
配置实例 :场景说明 :在MAN节点License正常的情况下，执行[CHECK CONSISTENCY](None)命令后，存在业务节点与MAN节点的License文件不一致，此时需要执行[SYNC LICENSE](None)命令。
配置步骤 :在EMSPlus客户端，选择菜单系统→命令终端
...
注意事项|||
签名||测试日期|
缩略语 :缩略语 :DCU :Data Collection Unit数据采集单元
### MML 
...
配置过程 :使用命令[SET SNTPCLNT](None)，配置NTP客户端参数。该过程将上级NTP服务器配置为时钟源，用于为MAN节点提供NTP时间同步服务。
...
相关信息 :本节涉及到的概念：操作集、父节点、子节点，相应的说明以[图1](#%E8%A7%92%E8%89%B2%E7%AE%A1%E7%90%86%E6%93%8D%E4%BD%9C-458FD1C2__1d8c253c-89e8-4b23-8c95-3c6d02e778c2)为例。
图1  安全管理
...
前提 :用户的安全策略已配置，具体操作参见“[设置安全策略](t-0013792756.html#%E5%91%BD%E4%BB%A4%E9%9B%86%E7%AE%A1%E7%90%86%E6%93%8D%E4%BD%9C-458FBF87)”
。
步骤 :新建用户
在EMSPlus客户端，选择菜单System→MML Terminal
...
缩略语 :缩略语 :FTP :File Transfer Protocol文件传输协议
IP :Internet Protocol因特网协议
SFTP :Secure File Transfer Protocol安全文件传输协议
...
步骤 :在EMSPlus客户端，单击告警管理，打开告警管理页面，如[图1](%E6%9F%A5%E8%AF%A2%E5%91%8A%E8%AD%A6%E5%92%8C%E9%80%9A%E7%9F%A51.html#%E6%9F%A5%E8%AF%A2%E5%BD%93%E5%89%8D%E5%91%8A%E8%AD%A6-63C4A2CF__3a56be87-84c5-4a20-9b7e-cef53a94af42)示。
图1  告警管理页面
[]images/q.png)
...
单击确定按钮，将列出符合条件的告警。
相关任务 :维护人员可以查看告警的详细信息，具体操作参见“[告警处理](t-0013792795.html#Auto_concept)”
。
##### 查询历史告警 
摘要 :历史告警查询功能支持直接查询所有历史告警信息，同时也支持用户按照设置查询条件，只查看符合条件的告警。 
步骤 :在EMSPlus客户端，单击告警管理，打开告警管理页面，如[图4](%E6%9F%A5%E8%AF%A2%E5%91%8A%E8%AD%A6%E5%92%8C%E9%80%9A%E7%9F%A51.html#%E6%9F%A5%E8%AF%A2%E5%8E%86%E5%8F%B2%E5%91%8A%E8%AD%A6-63C4A734__ae0f741e-c495-48a6-a4ed-3b53087ded74)所示。
图4  告警管理页面
...
单击确定按钮，将列出符合条件的告警。
相关任务 :维护人员可以查看告警的详细信息；单击页面下方的按钮，执行对应的操作，具体操作参见“[导出告警信息](t-0013792795.html#%E5%AF%BC%E5%87%BA%E5%91%8A%E8%AD%A6%E6%93%8D%E4%BD%9C-D24020A6)”
。
##### 查询通知 
...
相关任务 :维护人员可以查看通知的详细信息；单击页面下方的按钮，执行对应的操作，具体操作参见“[导出告警信息](t-0013792795.html#%E5%AF%BC%E5%87%BA%E5%91%8A%E8%AD%A6%E6%93%8D%E4%BD%9C-D24020A6)”
。
#### 告警处理 
#### 告警处理 
##### 查看告警详情和处理建议 
...
步骤 :在当前告警查询页面，选中需要导出的告警条目，单击Export按钮，如[图5](t-0013792795.html#%E5%AF%BC%E5%87%BA%E5%91%8A%E8%AD%A6%E6%93%8D%E4%BD%9C-D24020A6__%E5%AF%BC%E5%87%BA%E9%80%9A%E7%9F%A5-85D7C9D7)所示。
 说明： 
...
步骤 :在EMSPlus客户端，单击告警管理，打开告警管理页面，如[图1](#%E8%AE%BE%E7%BD%AE%E5%91%8A%E8%AD%A6%E8%BF%87%E6%BB%A4%E8%A7%84%E5%88%99-DA627431__2ee0228d-702d-48dc-b07d-8a586816e365)所示。
图1  告警管理页面
...
步骤 :在EMSPlus客户端，单击告警管理，打开告警管理页面，如[图1](#%E8%AE%BE%E7%BD%AE%E5%91%8A%E8%AD%A6%E7%AE%B1-DC7E8D3C__309f642d-d139-4197-9993-86f41ddaab19)所示。
图1  告警管理页面
...
系统架构 :EMSPlus系统由MAN、DPU、MDS、DCU、MU等模块组成，如[图1](#topic1__EMSPlus%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84-66D829C0)所示。
图1  EMSPlus系统架构
...
客户收益 :对运营商和用户的受益说明参见[表1](#topic1__XXX%E7%89%B9%E6%80%A7%E6%94%B6%E7%9B%8A%E8%AF%B4%E6%98%8E-486D0F21)。
收益方|收益说明
---|---
运营商|节约开局成本。
终端用户|此特性对终端用户不可见。
...
涉及网元 :涉及的网元及其功能参见[表1](#topic1__%E6%B6%89%E5%8F%8A%E7%9A%84%E7%BD%91%E5%85%83-4569E028)。
网元|描述
---|---
...
实现原理 :系统架构 :EMSPlus的系统架构如[图1](#topic1__b707488f-04fe-4286-afef-cfe2ee9214f3)所示。
图1  系统架构
...
业务流程 :CloudStudio在线缩扩容机制，整体流程如[图2](#topic1__NF%E7%BC%A9%E6%89%A9%E5%AE%B9%E6%B5%81%E7%A8%8B%E5%9B%BE-6E74D44C)所示（图中虚框内是需要EMSPlus产品实现的部分）。
图2  VNF缩扩容流程图
...
本文的TECS界面仅供参考。
步骤 :登录到VNFM客户端的/home/mano/ngomm/vnfm_1/ftpvnf/vnfd/73dce03b-6a65-4e9c-a870-27b37f5a79ae路径。EMSPlus虚机扩容操作会在该路径下生成一个vnfd_model_bak.json文件，如[图1](#%E6%96%B0%E5%BB%BAXX-0B9872C5__6fc7f374-4a6a-4fa6-bb96-7b75d7e4e699)所示。
...
实现原理 :系统架构 :EMSPlus系统架构如[图1](#topic1__%E5%8C%97%E5%90%91%E8%87%AA%E5%AE%9A%E4%B9%89%E8%BE%93%E5%87%BA%E9%80%BB%E8%BE%91%E5%9B%BE-ED2C8978)所示。
...
涉及网元 :涉及的网元及其功能参见[表1](#topic1__%E6%B6%89%E5%8F%8A%E7%9A%84%E7%BD%91%E5%85%83%E5%8F%8A%E5%85%B6%E5%8A%9F%E8%83%BD-ED2D680D)。
功能单元|描述
---|---
...
数据规划 :根据实际情况进行配置，假设场景的数据规划参见[表1](#%E6%96%B0%E5%BB%BAXX-0B9872C5__d194b5a5-9433-4aa8-ad77-7f196017807e)。
参数名称|参数值|备注
---|---|---
...
步骤 :在NetNumen U31客户端窗口，单击工具栏中的[]images/%E5%BF%AB%E7%85%A77.png)图标，切换到MML Terminal窗口，如[图1](#%E6%96%B0%E5%BB%BAXX-0B9872C5__30db32b1-0a30-4426-ae9f-4b2295a3c47d)所示。
图1  命令终端
...
前提 :EMSPlus已接入NetNumen U31。
步骤 :在NetNumen U31客户端窗口，单击网元树中的EMSPlus网元，切换到NE Alarms Table页签，查看当前告警列表，如[图1](#z82bdb7c9cf974b2894f9eb43acd1b3de__89ba1e8f-c338-4863-b791-be6b6b3803dd)所示。
图1  查看当前告警
...
相关任务 :右击Detail Content区域的字段，选择快捷菜单，如[图9](#%E6%96%B0%E5%BB%BAXX-0B9872C5__20bd986a-3f2a-4c40-836e-f1fafd6c91b8)所示，可执行相关的操作。
图9  快捷菜单
...
运营商|提升运营商的网元统计能力和故障定位手段。
终端用户|此特性对终端用户不可见。
实现原理 :实现原理 :系统架构 :EMSPlus的Hadoop业务，整体流程如[图1](1521793937101.html#new1ec9f6d76a7c4a4399f59622150a4f2b__c2c2f93c-dec4-49d1-9b28-7636f6950960)所示。
图1  Hadoop业务流程
...
终端用户|该功能对终端用户不可见。
实现原理 :系统架构 :PING功能实现原理如[图1](#topic1__8d8acdfa-67a7-4c9d-ad58-f48d98ba9c32)所示。
图1  实现原理
[]images/8.png)
涉及网元 :涉及的网元及其功能参见[表1](#topic1__%E6%B6%89%E5%8F%8A%E7%9A%84%E7%BD%91%E5%85%83-4569E028)。
网元|描述
...
步骤 :执行[route](None)命令，查看其输出确认所配置的路由已经加到系统中。
...
实现原理 :系统架构 :FTU节点采用主流的数据收集工具的架构，主要包含Reader、Parser和Sender，用于FTU节点的数据采集、内容解析和消息传递，如[图1](#topic1__57568610-13d8-4594-a625-fcda546d28ae)所示。
图1  FTU节点实现原理
[]images/image.png)
涉及网元 :该特性由本网元单独实现，无需其他网元的配合。 
...
License要求 :该特性为EMSPlus网元的基本特性，无需License支持。
对其他网元的要求 :该特性不涉及对其他网元的要求。 
O&M相关 :命令 :新增配置项参见[表1](#topic1__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
命令|描述
---|---
...
前提 :已登录EMSPlus客户端。
步骤 :在EMSPlus客户端的Terminal窗口，执行[ADD FTUDSPCFG](None)命令，增加FTU分发配置，如[图1](#%E6%96%B0%E5%BB%BAXX-0B9872C5__af128cba-307e-4929-8e21-92b436e5a210)所示。
图1  创建FTU分发配置
...
前提 :已创建FTU分发配置。 
已登录EMSPlus客户端。 
步骤 :在EMSPlus客户端的Terminal窗口，执行[SHOW FTUTASK](None)命令，先查询系统中的FTU任务名称，如[图1](#%E6%96%B0%E5%BB%BAXX-0B9872C5__06c81d39-d8b6-4504-a5c1-9b87469796d4)所示。
图1  查看FTU任务配置
...
前提 :已登录EMSPlus客户端。
步骤 :在EMSPlus客户端的Terminal窗口，执行[SYNC FTUCFG](None)命令，将FTU的配置数据同步到FTU模块，如[图1](#%E6%96%B0%E5%BB%BAXX-0B9872C5__65f710f4-90b9-4e72-be60-4fc14f4db7c1)所示。
图1  同步FTU配置
...
实际结果|||
签名||测试日期|
缩略语 :缩略语 :MDS :Message Dispatch Service消息分发服务
...
系统架构 :针对GDPR的影响，EMSPlus系统结构如[图1](#topic1__548bc1a8-dc58-416c-8a0d-131098c74cf0)所示。
图1  GDPR安全系统架构图
...
终端用户|此特性对终端用户不可见。
实现原理 :系统架构 :EMSPlus系统的备份原理如[图1](#topic1__57dcc391-a0fc-412e-8c5d-a2cb17c0ce2d)所示。
图1  系统备份原理图
