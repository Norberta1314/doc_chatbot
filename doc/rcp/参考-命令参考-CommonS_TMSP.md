...
修改自愈级别配置前后，可以通过[SHOW AUTOHEALINGLV](../mml/1240003.html)命令查询自愈级别配置信息。
...
当需要关闭指定类型的SC的自动弹性功能或者需要修改指定类型的SC的弹性缩容冷却时间时，可以使用[ADD SCALEBASECFGBYSC](../mml/1241504.html)命令新增SC的弹性基础配置。

若指定类型的SC的弹性基础配置与预期不符时，可以使用[SET SCALEBASECFGBYSC](../mml/1241505.html)命令修改SC的弹性基础配置。

当不再需要对指定类型的SC进行弹性基础配置时，可以使用[DEL SCALEBASECFGBYSC](../mml/1241506.html)命令删除SC的弹性基础配置。

系统在每个监控周期内会读取弹性相关的全部配置，新的配置数据会在下一个监控周期生效。 

开启自动弹性功能前需通过[SHOW SCALEBASECFGBYSC](../mml/1241507.html)命令检查SC弹性基础配置是否符合预期。
...
命令执行成功后，可以通过[SHOW SCALEBASECFGBYSC](../mml/1241507.html)命令查看配置结果。
...
命令执行成功后，可以通过[SHOW SCALEBASECFGBYSC](../mml/1241507.html)命令查看配置是否已删除。
...
执行该命令后，若发现SC弹性基础配置不符合预期，可以通过[SET SCALEBASECFGBYSC](../mml/1241505.html)命令进行修改。
...
当需要禁用指定类型的SC的指定类型的弹性策略，或者需要针对某个类型的SC进行弹性策略配置时，可以使用[ADD SCALEPOLICYBYSC](../mml/1241508.html)命令新增SC的弹性策略配置。

若指定类型的SC的弹性策略配置与预期不符时，可以使用[SET SCALEPOLICYBYSC](../mml/1241509.html)命令修改SC的弹性策略配置。

当不再需要对指定类型的SC进行弹性策略配置时，可以使用[DEL SCALEPOLICYBYSC](../mml/1241510.html)命令删除SC的弹性策略配置。

系统在每个监控周期内会读取弹性相关的全部配置，新的配置数据会在下一个监控周期生效。 

开启自动弹性功能前需通过[SHOW SCALEPOLICYBYSC](../mml/1241511.html)命令检查SC弹性策略配置是否符合预期。
...
命令执行成功后，可以通过[SHOW SCALEPOLICYBYSC](../mml/1241511.html)命令查看配置结果。
...
---|---|---|---
service_component|SC类型|参数可选性: 必选参数类型: 字符串参数范围: 1-64|该参数用于指定SC的类型，可以通过SHOW SCTYPE命令进行查询。
policy_type|弹性策略类型|参数可选性: 必选参数类型: 枚举，参见枚举定义默认值: CPU_RATIO|该参数用于指定弹性策略类型。业务上报不同类型的KPI对应不同类型的弹性策略，主要包括以下几种：上下文占用率数据库占用率业务负载占用率吞吐率租户容量比其中，业务负载占用率是各类型的SC通用的弹性策略类型。
policy_scope|弹性策略范围|参数可选性: 必选参数类型: 枚举，参见枚举定义默认值: SCOPE_WITHIN_SCGROUP|该参数用于指定弹性策略的作用范围。各参数选项的含义是：组内：当业务上报的SC组内的KPI满足自动弹性条件时，系统会对SC组内的SC实例进行自动弹性操作。组间：当业务上报的SC组间的KPI满足自动弹性条件时，系统会对SC组整组进行自动弹性操作。对于全局弹性策略配置来说，同一类型的弹性策略适用于组内和组间两种弹性策略范围。但是对于同一类型的SC的弹性策略配置来说，同一类型的弹性策略只适用于组内或组间一种弹性策略范围，需要在使用ADD SCALEPOLICYBYSC命令新增SC弹性策略配置时指定弹性策略范围。若需要修改SC的弹性策略范围，需要先使用DEL SCALEPOLICYBYSC命令删除该弹性策略配置再重新增加。
active_flag|激活标记|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: disable|该参数用于设置弹性策略的激活标记。各参数选项的含义是：启用：该弹性策略为启用状态，对于该SC类型，该弹性策略配置优先于相同类型的全局弹性策略配置生效。禁用：该弹性策略为禁用状态，对于该SC类型，该策略类型的SC以及全局弹性策略配置均不生效，即系统不会根据业务上报的此类型KPI判断是否进行自动弹性操作。若没有配置SC的弹性策略，则默认全局弹性策略生效。并且只有在没有配置SC的弹性策略的情况下，同一类型的SC、同一类型的全局弹性策略在组内和组间范围均生效。
scaleout_threshold|弹性扩容阈值（%）|参数可选性: 任选参数类型: 数字参数范围: 0-100默认值: 60|该参数用于设置弹性策略的弹性扩容阈值。SC开启自动弹性功能后，当其上报的KPI超过对应弹性策略的弹性扩容阈值时，系统会对该类型的SC进行自动弹性扩容操作。若同一种类型的SC有多种类型的KPI上报，只要其中一种KPI满足自动弹性扩容条件，系统就会对该类型的SC进行自动弹性扩容操作。对于部署策略为Co-Deploy的多种类型的SC，只要其中一种SC满足自动弹性扩容条件，系统就会对关联的全部类型的SC进行自动弹性扩容操作。
scalein_threshold|弹性缩容阈值（%）|参数可选性: 任选参数类型: 数字参数范围: 0-100默认值: 20|该参数用于设置弹性策略的弹性缩容阈值。SC开启自动弹性功能后，当其上报的KPI低于对应弹性策略的弹性缩容阈值时，系统会对该类型的SC进行自动弹性缩容操作。若同一种类型的SC有多种类型的KPI上报，必须全部KPI满足自动弹性缩容条件，系统才会对该类型的SC进行自动弹性缩容操作。对于部署策略为Co-Deploy的多种类型的SC，必须全部SC满足自动弹性缩容条件，系统才会对关联的全部类型的SC进行自动弹性缩容操作。
step_type|弹性步长类型|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: VMNUM|该参数用于设置弹性策略的弹性步长类型，即当系统进行自动弹性扩容或缩容操作时，一次性操作的SC数量的计算方式。各参数选项的含义是：VM数量：弹性扩容/缩容步长表示一次性扩容或缩容的虚机数量，只适用于IAAS场景。百分比：弹性扩容/缩容步长表示一次性扩容或缩容当前SC数量的百分比值，适用于所有场景。SC数量：弹性扩容/缩容步长表示一次性扩容或缩容的SC数量，只适用于CAAS场景。
scaleout_step|弹性扩容步长|参数可选性: 任选参数类型: 数字参数范围: 1-100默认值: 1|该参数用于设置弹性策略的弹性扩容步长，即系统在进行自动弹性扩容操作时，一次性扩容的对应弹性步长类型的数值。若同一种类型的SC有多种类型的KPI满足自动弹性扩容条件，则实际的弹性扩容步长取对应弹性策略中弹性扩容步长的最大值。对于部署策略为Co-Deploy的多种类型的SC，若其中有多种SC满足自动弹性扩容条件，则实际的弹性扩容步长取对应SC的弹性扩容步长的最大值。
scalein_step|弹性缩容步长|参数可选性: 任选参数类型: 数字参数范围: 1-100默认值: 1|该参数用于设置弹性策略的弹性缩容步长，即系统在进行自动弹性缩容操作时，一次性缩容的对应弹性步长类型的数值。若同一种类型的SC有多种类型的KPI上报，则实际的弹性缩容步长取对应弹性策略中弹性缩容步长的最小值。对于部署策略为Co-Deploy的多种类型的SC，则实际的弹性缩容步长取对应SC的弹性缩容步长的最小值。
...
---|---|---|---
service_component|SC类型|参数可选性: 任选参数类型: 字符串参数范围: 1-64|该参数用于显示SC的类型。
policy_type|弹性策略类型|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: CPU_RATIO|该参数用于显示弹性策略类型。业务上报不同类型的KPI对应不同类型的弹性策略，主要包括以下几种：上下文占用率数据库占用率业务负载占用率吞吐率租户容量比其中，业务负载占用率是各类型的SC通用的弹性策略类型。
policy_scope|弹性策略范围|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: SCOPE_WITHIN_SCGROUP|该参数用于显示弹性策略的作用范围。各参数选项的含义是：组内：当业务上报的SC组内的KPI满足自动弹性条件时，系统会对SC组内的SC实例进行自动弹性操作。组间：当业务上报的SC组间的KPI满足自动弹性条件时，系统会对SC组整组进行自动弹性操作。对于全局弹性策略配置来说，同一类型的弹性策略适用于组内和组间两种弹性策略范围。但是对于同一类型的SC的弹性策略配置来说，同一类型的弹性策略只适用于组内或组间一种弹性策略范围，需要在使用ADD SCALEPOLICYBYSC命令新增SC弹性策略配置时指定弹性策略范围。若需要修改SC的弹性策略范围，需要先使用DEL SCALEPOLICYBYSC命令删除该弹性策略配置再重新增加。
active_flag|激活标记|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: disable|该参数用于显示弹性策略的激活标记。各参数选项的含义是：启用：该弹性策略为启用状态，对于该SC类型，该弹性策略配置优先于相同类型的全局弹性策略配置生效。禁用：该弹性策略为禁用状态，对于该SC类型，该策略类型的SC以及全局弹性策略配置均不生效，即系统不会根据业务上报的此类型KPI判断是否进行自动弹性操作。若没有配置SC的弹性策略，则默认全局弹性策略生效。并且只有在没有配置SC的弹性策略的情况下，同一类型的SC、同一类型的全局弹性策略在组内和组间范围均生效。
scaleout_threshold|弹性扩容阈值（%）|参数可选性: 任选参数类型: 数字参数范围: 0-100默认值: 60|该参数用于显示弹性策略的弹性扩容阈值。SC开启自动弹性功能后，当其上报的KPI超过对应弹性策略的弹性扩容阈值时，系统会对该类型的SC进行自动弹性扩容操作。若同一种类型的SC有多种类型的KPI上报，只要其中一种KPI满足自动弹性扩容条件，系统就会对该类型的SC进行自动弹性扩容操作。对于部署策略为Co-Deploy的多种类型的SC，只要其中一种SC满足自动弹性扩容条件，系统就会对关联的全部类型的SC进行自动弹性扩容操作。
scalein_threshold|弹性缩容阈值（%）|参数可选性: 任选参数类型: 数字参数范围: 0-100默认值: 20|该参数用于显示弹性策略的弹性缩容阈值。SC开启自动弹性功能后，当其上报的KPI低于对应弹性策略的弹性缩容阈值时，系统会对该类型的SC进行自动弹性缩容操作。若同一种类型的SC有多种类型的KPI上报，必须全部KPI满足自动弹性缩容条件，系统才会对该类型的SC进行自动弹性缩容操作。对于部署策略为Co-Deploy的多种类型的SC，必须全部SC满足自动弹性缩容条件，系统才会对关联的全部类型的SC进行自动弹性缩容操作。
step_type|弹性步长类型|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: VMNUM|该参数用于显示弹性策略的弹性步长类型，即当系统进行自动弹性扩容或缩容操作时，一次性操作的SC数量的计算方式。各参数选项的含义是：VM数量：弹性扩容/缩容步长表示一次性扩容或缩容的虚机数量，只适用于IAAS场景。百分比：弹性扩容/缩容步长表示一次性扩容或缩容当前SC数量的百分比值，适用于所有场景。SC数量：弹性扩容/缩容步长表示一次性扩容或缩容的SC数量，只适用于CAAS场景。
scaleout_step|弹性扩容步长|参数可选性: 任选参数类型: 数字参数范围: 1-100默认值: 1|该参数用于显示弹性策略的弹性扩容步长，即系统在进行自动弹性扩容操作时，一次性扩容的对应弹性步长类型的数值。若同一种类型的SC有多种类型的KPI满足自动弹性扩容条件，则实际的弹性扩容步长取对应弹性策略中弹性扩容步长的最大值。对于部署策略为Co-Deploy的多种类型的SC，若其中有多种SC满足自动弹性扩容条件，则实际的弹性扩容步长取对应SC的弹性扩容步长的最大值。
scalein_step|弹性缩容步长|参数可选性: 任选参数类型: 数字参数范围: 1-100默认值: 1|该参数用于显示弹性策略的弹性缩容步长，即系统在进行自动弹性缩容操作时，一次性缩容的对应弹性步长类型的数值。若同一种类型的SC有多种类型的KPI上报，则实际的弹性缩容步长取对应弹性策略中弹性缩容步长的最小值。对于部署策略为Co-Deploy的多种类型的SC，则实际的弹性缩容步长取对应SC的弹性缩容步长的最小值。
...
命令执行成功后，可以通过[SHOW SCALEPOLICYBYSC](../mml/1241511.html)命令查看配置是否已删除。
...
执行该命令后，若发现SC弹性策略配置不符合预期，可以通过[SET SCALEPOLICYBYSC](../mml/1241509.html)命令进行修改。
...
---|---|---|---
service_component|SC类型|参数可选性: 任选参数类型: 字符串参数范围: 1-64|该参数用于指定SC的类型，可以通过SHOW SCTYPE命令进行查询。
policy_type|弹性策略类型|参数可选性: 任选参数类型: 枚举，参见枚举定义默认值: CPU_RATIO|该参数用于指定弹性策略类型。业务上报不同类型的KPI对应不同类型的弹性策略，主要包括以下几种：上下文占用率数据库占用率业务负载占用率吞吐率租户容量比其中，业务负载占用率是各类型的SC通用的弹性策略类型。
...
该命令执行完成后，可以通过[SHOW PKG](../mml/1240227.html)命令查询对应版本包是否存在，来确认加载操作是否成功。 
...
IAAS环境中，执行激活操作之后可以通过[SHOW VRU](../mml/1240301.html)/[SHOW VERSION DETAIL](../mml/1240226.html)命令确认激活操作是否成功。

CAAS环境中，执行激活操作之后可以通过[SHOW WORKLOAD](../mml/1240281.html)命令确认激活操作是否成功。
...
[](None)标识|名称|类型|说明
---|---|---|---
ACT_PKG_RES|操作结果|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-255|该参数用于显示命令的操作结果。结果包括：激活成功。激活正在进行。正在执行相同的命令，请稍后再试激活超时版本包不存在实例名称错误激活失败重启虚机失败版本包已激活激活信息错误版本已激活或实例号不存在升级中无法激活NFS实例未部署，不能被激活版本不匹配
...
ACTIVATE PKG:VNFINSTNAME="AMF21",PKGSEQUENCE ="qw1",ENABLE="NO",UPGRADEMODE="CONFIGANDVERSION"
` 
...
对NFS补丁包，可以通过本命令去激活并立即生效版本包，更新NF中容器的运行版本，IAAS环境中，也可以只去激活，再通过[ENABLE VERSION](../mml/1240233.html)命令更新某类容器的运行版本，或通过[REDEPLOY VRU](../mml/1240322.html)命令更新某个容器的运行版本。

执行去激活操作之后，通过[SHOW PKG](../mml/1240227.html)命令检查待去激活版本记录中“是否激活”字段为FALSE，表示去激活操作成功。
...
[](None)标识|名称|类型|说明
---|---|---|---
DEACT_PKG_RES|操作结果|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-255|该参数用于显示命令的操作结果。结果包括：去激活成功。去激活正在进行。正在执行相同的命令，请稍后再试超时版本包不存在实例号不存在去激活失败重启虚机失败版本包未激活态解码失败版本包类型不支持NFS实例未部署，不能被去激活！
...
当使用[ACTIVATE PKG](../mml/1240229.html)命令激活NFS补丁包（业务容器镜像版本包）或使用[DEACTIVATE PKG](../mml/1240232.html)命令去激活NFS补丁包，但NFS补丁包未立即生效时，可以使用该命令使NFS补丁包生效。

生效版本成功后，可以通过[SHOW VRU](../mml/1240301.html)命令查看“是否已生效”，该字段为“是”，表明新版本已生效。
...
`
生效版本包，“NFS类型”为"CommonS_TMSP"，“ NFS实例号”为"0", 则"NFS实例名称"为"CommonS_TMSP_0"。
ENABLE VERSION:NFSNAME="CommonS_TMSP_0" 
` 
...
删除版本包成功后，可以通过[SHOW PKG](../mml/1240227.html)命令查看待删除的版本包已不存在。


[](None)注意事项 

执行命令之前，请执行[SHOW PKG](../mml/1240227.html)命令查看版本包状态，确认此版本包处于去激活状态，不能删除处于激活状态的版本包。
...
删除成功后，可以通过[SHOW PKG](../mml/1240227.html)命令查看未使用版本包已经删除。


[](None)注意事项 

执行该命令前，请执行[SHOW PKG](../mml/1240227.html)命令查看版本包状态：
...
[SHOW VERSION](../mml/1240225.html)命令只能查询到NF中运行的版本信息，而该命令可以查询本NF以及本NF所包括的所有NFS中运行的版本信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
FILTERSTATUS|按状态过滤|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-3|该参数用于显示不同状态的NFS实例，不输入该参数时，默认显示的是所有的NFS实例信息，当该参数输入为1时，显示的是激活的NFS实例信息，当该参数输入为2时，显示的是未激活的NFS实例信息。
...
在通过[ADD PKG](../mml/1240228.html)命令加载版本包后，可以通过该命令查询对应版本包是否存在，来确认加载操作是否成功。在通过[ACTIVATE PKG](../mml/1240229.html)命令激活版本包、通过[DEACTIVATE PKG](../mml/1240232.html)命令去激活版本包操作后，可以通过该命令查询对应版本包是否已激活或者去激活，来确认操作是否成功。


[](None)注意事项 

该命令查询到的是网管系统已有的版本包信息，包括通过[ADD PKG](../mml/1240228.html)命令添加的版本包，升级工具中添加的版本包，以及在MANO上进行实例化操作时上传的版本包。
...
该命令执行完成后，可以通过[SHOW HOTPATCH](../mml/1240207.html)命令查询对应热补丁包是否存在，来确认加载操作是否成功。 
...
该命令用于激活已添加的热补丁包。通过[ADD HOTPATCH](../mml/1240200.html)命令加载热补丁包后，可以通过本命令激活热补丁包。

执行激活操作之后可以通过[SHOW HOTPATCH RUNNING STATE](../mml/1240206.html)命令确认激活后的热补丁是否生效。


[](None)注意事项 

如验证热补丁有效性，激活后而不实际生效热补丁包，可通过[VALIDATE HOTPATCH](../mml/1240204.html)命令操作指定验证热补丁。
...
对于已通过[ACTIVATE HOTPATCH](../mml/1240201.html)命令加载的热补丁包，如果不再需要生效该热补丁包，可以通过本命令去激活。查看热补丁包是否已经激活过，可通过[SHOW HOTPATCH](../mml/1240207.html)命令查看热补丁包的状态。

执行去激活操作之后可以通过[SHOW HOTPATCH RUNNING STATE](../mml/1240206.html)命令查看去激活的热补丁是否不在运行列表中。


[](None)注意事项 

如验证热补丁去激活的有效性，可通过[VALIDATE HOTPATCH](../mml/1240204.html)命令操作指定验证去激活热补丁。
...
通过[SHOW HOTPATCH](../mml/1240207.html)命令查看热补丁包状态。如待删除的热补丁包为未激活状态，可通过该命令删除热补丁包。

执行删除操作之后，再次通过[SHOW HOTPATCH](../mml/1240207.html)命令确认操作的热补丁是否已删除。
...
查询热补丁所关联的热补丁包信息，可通过[SHOW HOTPATCH](../mml/1240207.html)命令操作并查看结果。
...
查询热补丁所关联的热补丁包和补丁文件信息，可通过[SHOW HOTPATCH](../mml/1240207.html)与[SHOW HOTPATCH DETAIL](../mml/1240205.html)命令操作并查看结果。
...
查询热补丁包中的热补丁文件详细信息，可通过[SHOW HOTPATCH DETAIL](../mml/1240205.html)命令操作并查看结果。
...
可删除通过[ADD HOTPATCH](../mml/1240200.html)命令添加但未激活状态的热补丁包。

可删除通过[DEACTIVATE HOTPATCH](../mml/1240202.html)命令去激活的热补丁版本包。
...
使用该命令删除镜像补丁前，要确认该镜像补丁已经从虚机上卸载。通过[UNINSTALL OSPATCH](../mml/1240312.html)命令执行卸载镜像补丁操作时，若返回操作成功，表明已成功卸载。

通过[SHOW OSPATCH](../mml/1240310.html)命令查询系统中已经加载的镜像补丁信息，如果该镜像补丁没有对应的激活时间，则表明该镜像补丁可以删除。
...
可以通过[SHOW OSVERSION](../mml/1240309.html)获取要卸载的虚机名称，镜像版本号和补丁版本号。
...
可通过[SHOW VMDETAIL](../mml/1240305.html)命令来查询OMU的CPU使用率。
...
该命令仅支持查询部署状态为已部署虚机的安全加固补丁信息。 

若使用该命令查询到的安全加固补丁大、小版本号均为空，说明该虚机尚未进行过安全加固补丁升级；若使用该命令查询到的安全加固补丁大、小版本号均为"N/A"，说明对该虚机进行的安全加固补丁升级或回退操作失败，该虚机的加固状态未知，需重新加固。 
...
修改前后，可通过执行命令[SHOW VNF](../mml/1242311.html)查询相关参数修改前后的值。


[](None)注意事项 

当VNF管理状态为锁定或关闭中状态时，不可以使用[RESET VM](../mml/1240304.html)命令复位虚机。
...
仅支持P7及以上镜像版本对该配置进行修改，默认配置方式是以root用户启动容器。 
...
[](None)标识|名称|类型|说明
---|---|---|---
ENABLE|是否启用|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-127|该参数用于查询是否以root用户启动VRUs。是：以root用户启动VRUs。否：以非root用户启动VRUs。用户未配置：表示用户未通过命令SET RUNASROOT进行过该配置。
...
该命令的配置结果可以通过[SHOW RUNASROOT](../mml/1240334.html)命令进行查询。
...
该命令正在执行中时，为防止命令冲突导致执行失败，请勿执行命令[SET SELINUX](../mml/1240343.html)。
...
该命令的配置结果可以通过[SHOW PERFORMANCE PARAMETER](../mml/1240340.html)命令进行查询。
...
该命令的配置结果可以通过[SHOW SELINUX](../mml/1240344.html)命令进行查询。
...
该命令正在执行中时，为防止命令冲突导致执行失败，请勿执行命令[SET RUNASROOT](../mml/1240335.html)。
...
扩容后，可通过执行命令[SHOW EXTEND DISK](../mml/1240346.html)查询扩容的数据盘。
...
虚拟机数据盘通过命令[EXTEND DISK](../mml/1240345.html)命令进行数据盘扩容（即为虚拟机额外挂载一个数据盘）后，可通过执行本命令回退到扩容前的状态（即删除额外挂载的数据盘）。

执行回退操作（即对虚拟机数据盘进行缩容操作）后，可通过执行命令[SHOW EXTEND DISK](../mml/1240346.html)查询缩容后的数据盘状态。
...
修改后，可通过执行命令[SHOW AUDIT](../mml/1240350.html)查询相关参数的设置。
...
该命令执行成功后，OMU虚拟机会根据用户配置模式决定是否启用0核隔离。通过[SHOW EXCLUDED CPU0](../mml/1240354.html)命令可以查看配置详情。
...
查询结果是用户未配置的情况下，0核是否会被占用由系统调度决定。 
...
执行该命令前后，可以通过[SHOW NETWORK PARAMETER](../mml/1240356.html)命令查询修改前后的配置信息。
...
在对NF进行设置、增加、删除等操作前后可以通过[SHOW NF](../mml/1242300.html)命令进行查询。
...
若不指定NFID Node，则默认与VNF实例标识相同。VNF实例标识可以通过[SHOW VNF](../mml/1242311.html)命令进行查询。

增加NF成功后，该部署实例能提供此类型网元的功能和服务，可以通过[SHOW NF](../mml/1242300.html)命令进行查询。


[](None)注意事项 

已配置的NF类型总长度限制为100（每个NF类型之间包含一个分隔符）。 
...
[](None)标识|名称|类型|说明
---|---|---|---
OPRESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义|该参数用于表示执行该命令的操作结果：操作成功。正在执行相同的命令，请稍后再试！输入的NF类型已存在！NF不存在！输入的NFID Node已存在！输入的NFID Node长度超出限制！输入的NF类型别名长度超出限制！保存NF失败！配置的NF类型总长度超出限制！输入的NFID Node含有非法字符！
...
修改前后，可通过执行命令[SHOW NF](../mml/1242300.html)查询相关参数修改前后的值。
...
[](None)标识|名称|类型|说明
---|---|---|---
OPRESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义|该参数用于表示执行该命令的操作结果：操作成功。正在执行相同的命令，请稍后再试！NF不存在！输入的NF类型别名长度超出限制！设置NF类型别名失败！输入的NFID Node已存在！输入的NFID Node长度超出限制！设置NFID Node失败！没有输入任何一个要设置的参数的值！输入的NFID Node含有非法字符！
...
删除NF成功后，该NF将无法正常提供业务，可以通过[SHOW NF](../mml/1242300.html)命令查询该NF是否已被删除。
...
当需要配置NFS实例的显示名称时可以执行命令[SET NFS DISPLAYNAME](../mml/1242326.html)进行修改。

一个NFS实例只有成功部署才能正常工作。要完成一个NFS实例的部署，需先执行命令[ADD NFS](../mml/1242303.html)，再执行命令[ACTIVATE NFS](../mml/1242314.html)；要彻底删除一个NFS实例的记录，需先执行命令[DEACTIVATE NFS](../mml/1242315.html)，再执行命令[DEL NFS](../mml/1242304.html)。与NFS实例部署相关的操作：
...
当NFS实例出现严重故障或异常导致服务不可用时可以执行命令[RESET NFS](../mml/1242305.html)进行重启。
...
DEL DIALTESTSWITCH:SERVICETYPENAME=A,SERVICEINSTANCE=0
` 
...
[](None)标识|名称|类型|说明
---|---|---|---
servicetypename|服务类型名称|参数可选性: 任选参数类型: 字符串参数范围: 1-32|该参数用于设置服务类型名称。服务类型名称为字符串类型，范围是[1,32]。
serviceinstance|服务实例号|参数可选性: 任选参数类型: 数字参数范围: 0-255|该参数用于设置服务实例号。服务实例号为整数型，范围是[0,255]。
...
DEL DIALTESTUSER:SERVICETYPENAME=A,SERVICEINSTANCE=0,TYPE=IMSI,VALUE="460000012345678"
` 
...
增加NFS成功后，会增加一条该类型和规格的NFS实例的记录，该NFS实例仍是未部署状态，可以通过执行[SHOW NFS](../mml/1242302.html)命令查询该NFS实例的信息。


[](None)注意事项 

增加NFS时，NFS版本包序列号是可选参数。当未指定NFS版本包序列号时，从VNF当前使用的版本路径下读取NFS包信息。当指定NFS版本包序列号时，根据序列号获取版本路径，读取NFS包信息。可以通过[SHOW PKG](../mml/1240227.html)命令查询版本包信息。

同一类型的NFS最多只能有64个实例，超过此值将无法再继续增加。 

执行[ADD NFS](../mml/1242303.html)命令后需执行[ACTIVATE NFS](../mml/1242314.html)命令激活该NFS实例，使其完成部署。
...
[](None)标识|名称|类型|说明
---|---|---|---
NFSTYPE|NFS类型|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数用于指定要增加的NFS实例的类型，该类型的NFS版本包或包含该类型的VNF版本包必须存在，可以通过SHOW PKG命令查询版本包信息。
...
PKGSEQUENCE|NFS版本包序列号|参数可选性: 任选参数类型: 字符串参数范围: 1-64|该参数用于指定要增加的NFS实例的版本包序列号，每个版本包对应的序列号是唯一的，可以通过SHOW PKG命令查询版本包序列号。
...
激活NFS成功后，该NFS实例变为已部署状态，该NFS实例下的所有类型的SC都会进行弹性扩容，从而正常工作。可以通过[SHOW NFS](../mml/1242302.html)命令查询激活成功后的NFS实例的信息。


[](None)注意事项 

该命令只能对未部署的NFS实例进行激活操作，可以通过[SHOW NFS](../mml/1242302.html)命令查询NFS实例的部署状态。

执行命令需要一定时间，可在结果中查看进度。 

命令执行成功后需等待VRU启动，可以通过[SHOW VRU](../mml/1240301.html)命令查看VRU状态。
...
去激活NFS成功后，不会删除该NFS实例的记录，该NFS实例会变为未部署状态，该NFS实例下的所有SC全部会进行弹性缩容，并且无法正常工作或对外提供服务，同时释放其占用的部署资源。可以通过[SHOW NFS](../mml/1242302.html)命令查询NFS实例的部署状态等信息。
...
该命令只能对已部署的NFS实例进行去激活操作，可以通过[SHOW NFS](../mml/1242302.html)命令查询NFS实例的部署状态。
...
删除NFS成功后，会彻底删除该NFS实例的记录，即通过执行[SHOW NFS](../mml/1242302.html)命令将无法再查询到该NFS实例的信息。
...
该命令只能对未部署的NFS实例进行删除操作，因此如果要删除一个已部署的NFS实例，需先执行[DEACTIVATE NFS](../mml/1242315.html)命令去激活该NFS实例，再执行[DEL NFS](../mml/1242304.html)命令将其删除。可以通过[SHOW NFS](../mml/1242302.html)命令查询NFS实例的部署状态。
...
重启NFS的实质是重启该NFS下的全部SC实例，重启成功后服务会恢复正常，可以通过执行命令[SHOW NFSSTATUS](../mml/1242323.html)查询NFS的状态。


[](None)注意事项 

重启NFS的过程将导致该服务不可用，操作需谨慎。若仅部分SC实例出现故障，可以执行命令[RESET SC](../mml/1243500.html)重启SC。

重启公共服务可能会导致其他命令执行失败并严重超时，因此如果正在执行其他命令时，不要进行重启NFS操作。 

重启公共服务成功后需等待VRU启动。在IAAS场景下，可以通过[SHOW VRU](../mml/1240301.html)命令查看VRU状态。在CAAS场景下，可以通过[SHOW POD](../mml/1240280.html)命令查看VRU状态。
...
若NFS实例未部署，则该NFS实例的状态为未部署，可以通过[SHOW NFS](../mml/1242302.html)命令查询NFS实例的部署状态。

当NFS实例的状态为故障时，可以通过[SHOW SCSTATUS](../mml/1243511.html)命令查询该NFS实例下的SC集群的服务状态。
...
修改前后，可通过执行[SHOW NFS](../mml/1242302.html)命令查询NFS实例的名称。


[](None)注意事项 

执行此命令前需确保NFS呈现配置里的呈现服务别名为启用，呈现服务别名可通过执行[SHOW NFSPRESENTATION](../mml/1242341.html)命令进行查询。若呈现服务别名为禁用，则无法执行此命令，可通过执行[SET NFSPRESENTATION](../mml/1242340.html)命令将呈现服务别名设置为启用后再执行此命令。
...
可以通过[SHOW NFS](../mml/1242302.html)和[SHOW SCTYPE](../mml/1243505.html)等命令查询修改后的NFS实例以及SC类型的信息。
...
修改前后，可通过执行命令[SHOW NFSPRESENTATION](../mml/1242341.html)查询相关参数修改前的值以及修改后的值。
...
修改SC规格(MODIFY SCSIZE)：修改SC实例的部署规格（仅限IAAS环境下使用）。 
...
闭塞SC(BLOCK SC)：适用于业务测试时特定SC实例出现故障或异常等场景。 
...
在资源限额生效的情况下，有时候会出现由于容器资源限额不合适（一般是限额过小），导致业务容器运行异常。此时可以通过该命令[MODIFY SCRESOURCELIMITFLAG](../mml/1240387.html)关闭容器资源限额开关，并将相关容器重建，从而恢复容器正常运行。
...
当命令显示SC性能([SHOW POD](../mml/1240280.html))不能满足查询SC性能统计的需要时，按SC测量对象名信息配置是SC性能统计的可选配置。
...
当SC性能统计([SHOW POD](../mml/1240280.html))不能满足某类服务组件的需要时，可以使用该配置定制，通过设置SC名称与别名的对应关系，在创建测试任务时可以选择创建的记录，进而可以查询到SC的基本性能，包括内存和CPU使用率等实时信息。
...
重启SC成功后，出现故障或异常的SC实例会恢复正常，可以通过执行命令[SHOW SCINFO](../mml/1243504.html)查询SC实例的信息。


[](None)注意事项 

对于业务NFS下的SC实例，请确保在执行该操作前已执行命令[BLOCK SC](../mml/1243502.html)以迁移业务，从而避免业务损失。
...
倒换SC成功后，业务会从原来的主用SC实例迁移到原来的备用SC实例，原来的备用SC实例将转为主用进而接替原来的主用SC实例正常工作，原来的主用SC实例转为备用。可以通过执行命令[SHOW SCINFO](../mml/1243504.html)查询SC实例的信息。
...
倒换公共服务下的SC实例操作发起后，需等待SC实例完成倒换操作。稍后可通过[SHOW SCINFO](../mml/1243504.html)命令查询SC实例的信息。

倒换TMSP/OAM公共服务下的SC类型时，该命令不做备用SC组内编号校验，所以无需指定该参数。 
...
业务测试或故障定位结束后可以通过执行命令[UNBLOCK SC](../mml/1243503.html)解闭塞SC实例。可以通过执行命令[SHOW SCINFO](../mml/1243504.html)查询SC实例的信息。
...
解闭塞SC成功后，该SC实例将从闭塞状态转为正常工作状态。可以通过执行命令[SHOW SCINFO](../mml/1243504.html)查询SC实例的信息。
...
SCSTATUS|SC状态|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-4默认值: INVALID|该参数用于表示查询到的SC实例的运行状态。各参数选项的含义是：N/A：未查询到SC实例的有效状态。初始态：SC实例为启动状态。工作态：SC实例为正常工作状态。宕机：SC实例为故障或异常状态。闭塞：SC实例为闭塞状态，即业务的SC实例在执行BLOCK SC命令后的状态。
...
DEPLOYPOLICY|部署策略|参数可选性: 必选参数类型: 字符串参数范围: 0-16|该参数用于表示查询到的SC类型的部署策略，主用包括NORMAL、UNION、PER_VM以及CO-DEPLOY等。各参数选项的含义是：NORMAL：正常部署。UNION：同一服务下的多种SC类型部署在同一虚机上。PER_VM：每个虚机（或指定的虚机类型）上都需要部署。CO-DEPLOY：不同服务下的多种SC类型部署在同一虚机上。
...
增加SC实例成功后，可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询SC组的组内当前实例数，还可以通过[SHOW SCINFO](../mml/1243504.html)命令查询SC实例的信息。


[](None)注意事项 

弹性扩容增加的SC实例数必须是部署步长的整数倍，部署步长可以通过[SHOW SCTYPE](../mml/1243505.html)命令查询。

弹性扩容后SC组的组内实例数不能大于组内最大实例数，即SC组内最大主用个数和最大备用个数之和，这两个参数值可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询。
...
减少SC实例成功后，可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询SC组的组内当前实例数，还可以通过[SHOW SCINFO](../mml/1243504.html)命令查询SC实例的信息。


[](None)注意事项 

弹性缩容减少的SC实例数必须是部署步长的整数倍，部署步长可以通过[SHOW SCTYPE](../mml/1243505.html)命令查询。

弹性缩容后SC组的组内实例数不能小于组内最小实例数，SC组内最小实例数可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询。
...
修改前后，可通过执行命令[SHOW SCTYPE](../mml/1243505.html)查询相关参数修改前后的值。
...
修改亲和标签操作成功后需等待VRU启动，在此期间不要执行其他的弹缩相关命令，可以通过[SHOW VRU](../mml/1240301.html)命令查看VRU状态。

最小SC组数不能大于该SC类型当前已部署的SC组数，可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询SC组的信息。
...
## 修改SC规格(MODIFY SCSIZE) 
## 修改SC规格(MODIFY SCSIZE) 


[](None)功能说明 

小心：该命令属于高危命令，用于修改NFS实例下指定SC的规格。该操作将删除SC并根据版本中的NFS描述文件重新部署该SC。该操作将导致业务中断并且服务不可用，并且需要确保有足够的资源。因此执行该命令前，需要与中兴通讯技术支持人员确认后才可以实施。 

该命令用于修改NFS实例下指定SC的规格。 

当一个NFS实例下的SC的部署规格和关联的虚机资源已无法满足业务对性能的需求时，使用该命令。 

该命令支持批量修改SC规格，即可以输入多个需要并发处理的NFS的实例名称、SC类型以及SC的目标规格。 

可以通过[SHOW SCTYPE](../mml/1243505.html)命令查询修改后的SC类型的信息。


[](None)注意事项 

"CommonS_TMSP"、"CommonS_OAM"等类型的NFS实例（公共服务）不能修改SC规格。 

执行命令需要一定时间，可在结果中查看进度。在此期间，不要执行其他弹缩相关的命令。 

命令执行成功后需要等待SC实例完成部署。 

如果有多个需要并发处理的SC，其实例名称，类型和目标规格需要一一对应。 
...
[](None)标识|名称|类型|说明
---|---|---|---
NFSNAME|NFS实例名称|参数可选性: 必选参数类型: 字符串参数范围: 1-2000|该参数用于指定要修改SC规格的NFS实例名称，可以通过SHOW NFS命令查询已存在的NFS实例。支持输入多个NFS实例名称，中间用"/"分隔，如"CommonS_IPS_0/CommonS_SIG_0"。
SCTYPE|SC类型|参数可选性: 必选参数类型: 字符串参数范围: 1-640|该参数用于指定要修改规格的SC类型，可以通过SHOW SCTYPE命令查询已存在的SC类型。支持输入多个SC类型，中间用"/"分隔，如"sc-sig/sc-ips"。
SCSIZE|SC目标规格|参数可选性: 必选参数类型: 字符串参数范围: 1-640|该参数用于指定SC目标规格，即修改后的SC的规格。SC规格主要包括"SIZE_S"、"SIZE_M"、"SIZE_L"等。业务可以根据对性能的要求选择不同的SC规格。可以通过SHOW SCTYPE命令查询修改前后的SC的规格。支持输入多个SC目标规格，中间用"/"分隔，如"SIZE_S/SIZE_M"。
...
`
修改实例名称为"CommonS_SIG_0"，SC类型为"sc-sig"的SC规格为"SIZE_S"，同时修改实例名称为"CommonS_IPS_0"，SC类型为"sc-ips"的SC规格为"SIZE_M"。
MODIFY SCSIZE:NFSNAME="CommonS_SIG_0/CommonS_IPS_0",SCTYPE="sc-sig/sc-ips",SCSIZE="SIZE_S/SIZE_M"
` 
...
## 修改资源限额生效开关(MODIFY SCRESOURCELIMITFLAG) 
## 修改资源限额生效开关(MODIFY SCRESOURCELIMITFLAG) 


[](None)功能说明 

在资源限额生效的情况下，由于容器资源限额不合适（一般是限额过小），导致业务容器运行异常。该命令用于关闭容器资源限额开关，不对容器资源进行限制，并进行容器重建，从而恢复容器的正常运行。 
...
[](None)标识|名称|类型|说明
---|---|---|---
NFSNAME|NFS实例名称|参数可选性: 必选参数类型: 字符串参数范围: 1-200|该参数用于指定要修改资源限额开关的NFS实例的名称，可以通过SHOW NFS命令查询已存在的NFS实例。
SCTYPE|SC类型|参数可选性: 必选参数类型: 字符串参数范围: 1-64|该参数用于指定要修改资源限额开关的SC实例的类型，可以通过SHOW SCTYPE命令进行查询。
SCRESOURCELIMITFLAG|资源限额开关|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-1|该参数用于配置是否关闭资源限额。DISABLE_LIMIT_FLAG：关闭资源限额开关，关闭后，该SC类型的所有容器均会重建，容器使用的资源仅受操作系统最大资源限制。ENABLE_LIMIT_FLAG：开启资源限额开关，开启后，该SC类型的容器受用户在SC描述文件中配置的资源限额的限制。
...
[](None)标识|名称|类型|说明
---|---|---|---
OPERATERESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-255|该参数用于显示操作结果：操作成功。正在执行相同的命令，请稍后再试！配置没有发生变化！超时！输入参数有误，找不到VRU实例！该SC_TYPE不支持此操作！该SC_TYPE未配置CPU或内存配额！该SC_TYPE未配置资源限额启动开关！VRU重建失败！
...
`
开启NFS名称为CommonS_IPS_0、SC类型为sc-ips的VRU资源限额开关。
MODIFY SCRESOURCELIMITFLAG:NFSNAME="CommonS_IPS_0",SCTYPE="sc-ips",SCRESOURCELIMITFLAG="ENABLE_LIMIT_FLAG"
` 
...
该命令用于查询指定NFS下的SC组信息，包括SC类型、组号、组内最大主用/备用个数、组内当前/目标/最小实例数以及虚机组标签等。 
...
SERVERGROUP|虚机组标签|参数可选性: 必选参数类型: 字符串参数范围: 0-64|该参数用于表示查询到的SC组的虚机组标签。配置了指定虚机组名称的SC只能部署到该虚机组内的虚机上。虚机的虚机组名称可以通过SHOW VM命令查询。
...
SC类型        SC组号 SC组内最大主用个数 SC组内最大备用个数 SC组内当前实例数 SC组内目标实例数 SC组内最小实例数 虚机组标签 
----------------------------------------------------------------------------------------------------------------
...
小心：设置虚机组标签功能仅限某些特殊业务及场景使用，一般不建议使用，操作不当可能会导致SC选择不到正确的虚机而部署失败。因此执行该操作前，需要与中兴通讯技术支持人员确认后才可以实施。 

该命令用于设置SC组的相关参数，包括组内最大主用/备用个数、组内最小实例数以及虚机组标签等。 

当需要根据业务需求对相关参数值进行调整时、或需要执行弹性扩容或缩容相关命令前，可以使用该命令。 

修改前后，可通过执行命令[SHOW SCGROUP](../mml/1242318.html)查询相关参数修改前的值以及修改后的值。
...
配置虚机组标签前需要确认业务需求，否则不要进行配置。并且该配置不会影响已部署的SC，即已配置好虚机组标签的SC不能通过此命令重新选择不同虚机组标签的虚机进行部署。 
...
对于IAAS场景，SC组内最大主用、备用个数以及最小实例数必须是弹性步长的整数倍。弹性步长可通过SHOW SCTYPE命令查询。 

 

配置后可通过执行命令[SHOW SCGROUP](../mml/1242318.html)查询相关参数是否配置成功。
...
SERVERGROUP|虚机组标签|参数可选性: 任选参数类型: 字符串参数范围: 0-64|该参数用于设置SC组的虚机组标签。配置了指定虚机组标签的SC只能部署到该虚机组内的虚机上。虚机的虚机组标签可以通过SHOW VM命令查询。该参数不要随意修改，仅限某些特殊业务及场景使用。
...
`
设置NFS实例名称为"Nupf_PacketForward_0"、SC类型为"sc-upf-pf"、SC组号为1的SC组的各项参数值，将SC组内最大主用/备用个数设置为2，SC组内最小实例数设置为1，虚机组标签设置为“aaa”。
...
激活SC组成功后，该SC组成为已部署状态，能够正常工作以满足业务的需求。可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询并显示已部署的SC组的信息。后续可以根据业务需求进行SC组内的弹性扩容或缩容操作。
...
该命令只能对已存在记录且未部署的SC组进行激活操作，可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询并显示未部署的SC组的信息。
...
去激活SC组成功后，不会彻底删除SC组的记录，该SC组成为未部署状态，组内当前实例数为0，该SC组无法正常工作并且已释放占用的资源。可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询并显示未部署的SC组的信息。
...
该命令只能对已部署的SC组进行去激活操作，可以通过[SHOW SCGROUP](../mml/1242318.html)命令查询并显示已部署的SC组的信息。并且执行命令后该SC已部署的SC组数不能小于最小SC组数，否则无法执行去激活操作。最小SC组数可以通过[SHOW SCTYPE](../mml/1243505.html)命令进行查询，通过[SET SC](../mml/1243509.html)命令进行修改。
...
SHOW SERVICESUBABILITY:SERVICETYPE="Nsmf_NupfManage",SERVICEINSTANCE=0,SCTYPE="SC_SMF_UM"
...
在实际业务场景中，TMSP平台需要提供对运行在平台上的虚拟机进行自愈配置、重新启动、关闭虚机、开启虚机、隔离虚机、解隔离虚机、回收虚机、查询虚拟机相关信息以及释放虚拟机缓存等操作功能，进而对虚拟机进行管理。 
...
虚机缓存不足时，需要进行虚机缓存释放，使用命令DROP VMCACHE可释放虚机的缓存，执行前后可使用SHOW VMDETAIL查询虚机缓存大小和缓存释放情况。 
...
虚机类型可以通过[SHOW VMTYPE](../mml/1240306.html)命令查询。

NF实例可以通过[SHOW NF](../mml/1242300.html)命令查询。
...
可以通过[SHOW VMTYPE](../mml/1240306.html)命令查询虚机类型。


[](None)注意事项 

当对某种类型虚机进行自愈配置后，后续对该类型虚机进行自愈时以该配置为准，[SET AUTOHEALINGGLB](../mml/1240000.html)命令配置的自愈策略对此类型的虚机不生效。
...
删除配置后，该虚机类型将会按照[SET AUTOHEALINGGLB](../mml/1240000.html)命令配置的全局自愈配置进行自愈操作。
...
若查询发现当前配置不符合需求，可以使用[SET VMAUTOHEALING](../mml/1240005.html)命令修改配置，或使用[DEL VMAUTOHEALING](../mml/1240006.html)命令删除配置。
...
可以通过[SHOW VMAUTOHEALINGLV](../mml/1240011.html)命令查询配置信息。


[](None)注意事项 

当添加特定虚机类型的自愈级别后，该类型的虚机在自愈时，将按照该命令配置的内容进行自愈流程处理，[SET AUTOHEALINGLV](../mml/1240002.html)命令配置的自愈级别对此类型的虚机不生效。
...
删除配置后，该虚机类型将会按照[SET AUTOHEALINGLV](../mml/1240002.html)命令配置的全局自愈级别进行自愈操作。
...
当命令显示虚机性能([SHOW VM](../mml/1240300.html))不能满足查询虚机性能统计的需要时，按虚机测量对象名信息配置是虚机性能统计的可选配置。
...
当虚机性能统计([SHOW VM](../mml/1240300.html))不能满足某类服务组件的需要时，可以使用该配置定制，通过设置虚机名称与别名的对应关系，在创建测试任务时可以选择创建的记录，进而可以查询到虚机的基本性能，包括内存、磁盘和CPU使用率等实时信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMMEASINSTANCENAME|虚机测量对象名|参数可选性: 必选参数类型: 字符串参数范围: 1-64|该参数表示查询的虚机测量对象的名称。对应SHOW VM命令的”虚机内部名称“信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMMEASINSTANCENAME|虚机测量对象名|参数可选性: 任选参数类型: 字符串参数范围: 1-64|该参数表示查询的虚机测量对象的名称。对应SHOW VM命令的”虚机内部名称“信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMSPEC|虚机规格测量对象名|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数表示需要创建测量任务的虚机规格名称。该参数可以通过SHOW VMTYPE命令输出信息的描述字段获取。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMSPEC|虚机规格测量对象名|参数可选性: 任选参数类型: 字符串参数范围: 1-32|该参数表示需要创建测量任务的虚机规格名称。该参数可以通过SHOW VMTYPE命令输出信息的描述字段获取。
...
当命令显示虚机性能([SHOW VM](../mml/1240300.html))不能满足查询虚机核性能统计的需要时，按虚机CPU核测量对象信息配置是虚机性能统计的可选配置。
...
当虚机性能统计([SHOW VM](../mml/1240300.html))不能满足某类服务组件的需要时，可以使用该配置定制，通过设置虚机核测量对象名称与别名的对应关系，在创建测试任务时可以选择创建的记录，进而可以查询到虚机核相关的基本性能，包括CPU核使用率等实时信息。
...
当命令显示虚机性能([SHOW VM](../mml/1240300.html))不能满足查询虚机硬盘分区性能统计的需要时，按虚机硬盘分区测量对象信息配置是虚机性能统计的可选配置。
...
当虚机性能统计([SHOW VM](../mml/1240300.html))不能满足某类服务组件的需要时，可以使用该配置定制，通过设置虚机硬盘分区测量对象名称与别名的对应关系，在创建测试任务时可以选择创建的记录，进而可以查询到虚机的分区相关基本性能，包括磁盘空间和使用率等实时信息。
...
按严重程度，剩余内存越小告警级别越高，配置的阈值根据告警级别从高到低顺序增大。 


告警阈值为0表示对应级别告警不检查，允许从最低级别起单个或多个级别配置为0，不允许跨级别配置为0；比如一级告警阈值=500，二级告警阈值=800，三级告警阈值=0，四级告警阈值=0。 
...
虚机名称或类型         剩余容量一级告警阈值(MB)      剩余容量二级告警阈值(MB)     剩余容量三级告警阈值(MB)     剩余容量四级告警阈值(MB)
...
按严重程度，资源使用率越高告警级别越高，配置的阈值根据告警级别从高到低顺序减小。 


告警阈值为0表示对应级别告警不检查，允许从最低级别起单个或多个级别配置为0，不允许跨级别配置为0； 比如一级告警=90，二级告警=70，三级告警=0，四级告警=0。 
...
TMSP平台需要提供设置和查询仲裁服务所在虚机的功能。 

仲裁是指，当两个数据中心之间的链路故障或其中一个数据中心故障时，两个数据中心之间无法实时同步，此时只能由其中一个数据中心继续提供服务。为了保证数据一致性，双活系统通过仲裁机制决定哪端数据中心继续提供业务。仲裁机制的功能由仲裁服务所在虚机提供。 
...
VM仲裁服务管理用于查询当前提供仲裁服务的虚机信息，出于资源限制或现有仲裁节点可能无法工作时，可用本命令重新设置提供仲裁服务的虚机。 

VM仲裁服务管理命令主要包括查询、设置操作： 
...
设置仲裁虚机(SET QUORUM VM)：修改仲裁服务所在虚机，使用配置的虚机提供仲裁服务。 
...
### 设置提供仲裁服务的虚机(SET QUORUM VM) 
### 设置提供仲裁服务的虚机(SET QUORUM VM) 


[](None)功能说明 

该命令用于设置当前NF中仲裁服务所在虚机。命令成功后该虚机可提供仲裁服务。可用[SHOW QUORUM VM](../mml/1240336.html) 命令查询当前已设置的仲裁虚机信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMLIST|虚机名称列表|参数可选性: 必选参数类型: 字符串参数范围: 3-512|该参数用于输入待设置仲裁服务的虚机名称列表，多个虚机名称之间用"/"分隔。虚机数目只能是1、3、5。虚机名称需要能够在SHOW VM命令显示的结果中查询到，否则本命令会执行失败。虚机名称由以下两部分组成，以IPU0001为例进行说明。虚机类型：IPU编号：0001
...
`
设置IPU0001、IPU0002、IPU0003为仲裁服务所在虚机。
SET QUORUM VM:VMLIST="IPU0001/IPU0002/IPU0003"
` 
...
TMSP平台需要对VM操作进行配置。VM操作按批次进行，需要对不同的操作类型进行相应的设置，确定该类VM操作的单批次最大虚机数、单批次最大超时时间。 
...
新增VM操作配置(ADD VMLCMCFG)：新增虚机预占/取消预占/创建操作的单批次最大虚机数和单批次最大超时时长。 

 
修改VM操作配置(SET VMLCMCFG)：修改虚机预占/取消预占/创建操作的单批次最大虚机数和单批次最大超时时长。 

 
删除VM操作配置(DEL VMLCMCFG)：删除虚机预占/取消预占/创建操作的配置。 

 
查询VM操作配置(SHOW VMLCMCFG)：查询虚机预占/取消预占/创建操作的配置信息。 
...
当需要调整虚机的某类操作的相关配置信息时，使用该命令。 

可以通过[SHOW VMLCMCFG](../mml/1240017.html)命令查询虚机的指定操作类型的配置信息。


[](None)注意事项 

当添加特定操作类型的VM操作配置后，对虚机进行该类操作时，将按照该命令配置的内容进行虚机操作处理。 
...
[](None)标识|名称|类型|说明
---|---|---|---
operatetype|操作类型|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-2默认值: VM_OPTYPE_PRE_OCCUPY|该参数用于指定虚机操作类型，包含以下选项。预占：对虚机资源进行预占，其他操作不能使用该虚机资源。取消预占：取消对虚机资源的预占，其他操作可以使用该虚机资源。创建：指创建虚机的操作。
maxvms|单批次最大虚机数|参数可选性: 任选参数类型: 数字参数范围: 1-400默认值: 100|虚机操作按批次进行，该参数用于设置单批次可以操作的最大虚机数。
maxtimeout|单批次最大超时（分钟）|参数可选性: 任选参数类型: 数字参数范围: 1-60默认值: 25|该参数用于设置单批次最大超时时长。如果达到了超时时长虚机还没有操作完毕，则认为操作失败。
...
`
新增虚机预占操作的配置，单批次最大虚机数为200，单批次最大超时时长为30分钟。
ADD VMLCMCFG:operatetype="VM_OPTYPE_PRE_OCCUPY",MAXVMS="200",MAXTIMEOUT="30"
` 


### 修改VM操作配置(SET VMLCMCFG) 
### 修改VM操作配置(SET VMLCMCFG) 


[](None)功能说明 

该命令用于修改指定虚机操作类型的配置信息。 

当维护人员需要修改虚机指定类型操作的单批次最大虚机数和单批次最大超时时间时，使用该命令。 

可以通过[SHOW VMLCMCFG](../mml/1240017.html)命令查询配置信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
operatetype|操作类型|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-2默认值: VM_OPTYPE_PRE_OCCUPY|该参数用于指定虚机操作类型，包含以下选项。预占：对虚机资源进行预占，其他操作不能使用该虚机资源。取消预占：取消对虚机资源的预占，其他操作可以使用该虚机资源。创建：指创建虚机的操作。
maxvms|单批次最大虚机数|参数可选性: 任选参数类型: 数字参数范围: 1-400默认值: 100|虚机操作按批次进行，该参数用于设置单批次可以操作的最大虚机数。
maxtimeout|单批次最大超时（分钟）|参数可选性: 任选参数类型: 数字参数范围: 1-60默认值: 25|该参数用于设置单批次最大超时时长。如果达到了超时时长虚机还没有操作完毕，则认为操作失败。
...
`
修改虚机预占操作的配置，单批次最大虚机数为200，单批次最大超时时长为30分钟。
SET VMLCMCFG:operatetype="VM_OPTYPE_PRE_OCCUPY",MAXVMS="200",MAXTIMEOUT="30"
` 


### 删除VM操作配置(DEL VMLCMCFG) 
### 删除VM操作配置(DEL VMLCMCFG) 


[](None)功能说明 

该命令用于删除虚机指定类型操作的相关配置。 

当业务不需要针对虚机指定类型操作进行配置时，使用该命令进行删除。 


[](None)注意事项 

删除配置后，虚机的该类型操作将会按照默认值进行。 
...
`
删除虚机预占操作的配置。
DEL VMLCMCFG:operatetype="VM_OPTYPE_PRE_OCCUPY"
` 


### 查询VM操作配置(SHOW VMLCMCFG) 
### 查询VM操作配置(SHOW VMLCMCFG) 


[](None)功能说明 

该命令用于查询虚机指定类型操作的相关配置信息。 
...
`
查询虚机预占操作的配置。
SHOW VMLCMCFG:operatetype="VM_OPTYPE_PRE_OCCUPY"

((No.1) : SHOW VMLCMCFG:operatetype="VM_OPTYPE_PRE_OCCUPY"

操作类型 单批次最大虚机数 单批次最大超时（分钟） 
------------------------------------------------
预占      200             30   
------------------------------------------------
记录数：1
...
开局后，为了配置虚机的内存回收水线，TMSP平台提供设置、查询虚机内存回收水线功能。内存回收水线表示操作系统保留内存的数量。当内存达到水线以下后，内核会触发内存回收。因此该值设置过高，导致应用程序的可使用内存减少，会造成内存浪费；设置过低，触发系统OOM（Out Of Memory）的几率更高。 
...
设置内存回收水线：设置当前NF内虚机内存回收水线，用户需要输入虚机类型，虚机规格和内存回收水线值。 

 
查询内存回收水线：查询当前NF的虚机内存水线配置，包含所有规格和类型虚机对应的回收水线值。 
...
### 设置内存回收水线(SET MINFREEKBYTES) 
### 设置内存回收水线(SET MINFREEKBYTES) 


[](None)功能说明 

该命令用于设置当前NF中虚机的内存回收水线。可通过[SHOW MINFREEKBYTES](../mml/1240370.html) 命令查看当前NF中各规格虚机的内存水线配置。

内存回收水线表示操作系统保留内存的数量。当内存达到水线以下后，内核会触发内存回收。因此该值设置过高，导致应用程序的可使用内存减少，会造成内存浪费；设置过低，触发系统OOM（Out Of Memory）的几率更高。 

建议按照“100G物理内存设置1G左右左右的水线值”的比例进行设置。 


[](None)注意事项 

该配置执行时，只针对当前运行状态正常的虚机生效，运行状态异常的虚机，需要重启后生效。 
...
[](None)标识|名称|类型|说明
---|---|---|---
VMTYPE|类型|参数可选性: 必选参数类型: 字符串参数范围: 1-8|该参数用于设置待设置内存回收水线的虚机类型。虚机类型可以通过SHOW MINFREEKBYTES命令输出信息的类型字段获取。
VMSIZE|规格|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数用于设置待设置内存回收水线的虚机规格。虚机类型可以通过SHOW MINFREEKBYTES命令输出信息的规格字段获取。
MINFREEKBYTES|内存回收水线(KB)|参数可选性: 必选参数类型: 数字参数范围: 67584-1048576|该参数用于设置待设置内存回收水线值。该参数取值范围为67584到1048576。
...
`
设置类型为GSU，规格为GSU-C8-E的虚机内存回收水线为262144kb。
SET MINFREEKBYTES: VMTYPE="GSU", VMSIZE="GSU-C8-E",MINFREEKBYTES="262144"
` 


### 查询内存回收水线(SHOW MINFREEKBYTES) 
### 查询内存回收水线(SHOW MINFREEKBYTES) 


[](None)功能说明 

该命令用于查看当前NF中各规格虚机的内存回收水线配置。可用[SET MINFREEKBYTES](../mml/1240369.html) 命令进行设置。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMTYPE|类型|参数可选性: 必选参数类型: 字符串参数范围: 1-8|该参数用于显示当前NF中虚机的类型。
VMSIZE|规格|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数用于显示当前NF中虚机的规格。
MINFREEKBYTES|内存回收水线(KB)|参数可选性: 必选参数类型: 字符串参数范围: 0-16|该参数用于显示当前NF中虚机的内存回收水线，如果用户未配置，显示“Default”。
...
通常情况下，每个网口都有一个流量队列用来接收和发送网络数据包，一个队列的中断由一个vCPU处理（即队列收到数据包后会触发中断，通知vCPU来处理数据包）。随着虚机网口流量增大，单个vCPU处理负荷过高。支持网口多队列功能后，网口多个队列的中断可以由多个vCPU分担处理，降低单个vCPU的负载。 

TMSP提供增加、删除、查询虚机网口队列中断绑核策略，来满足用户可以将mgt、service、oam网口各队列的中断绑到指定的vCPU上的需求，达到分担中断负载的目的。 
...
VM网口队列中断绑核设置包括增加、删除和查询操作： 


 
增加虚机网口队列中断绑核策略：该命令用于自定义虚机网口队列的中断绑核策略。用户需要输入虚机类型，虚机规格和网络平面来配置单队列中断绑核或多队列中断绑核。 

 
删除虚机网口队列中断绑核策略：该命令用于删除用户自定义的虚机网口队列中断绑核策略。用户需要输入已经配置中断绑核策略的虚机类型、虚机规格和网络平面来删除相应的虚机网口队列中断绑核策略。 

 
查询虚机网口队列中断绑核策略：该命令用于查询用户自定义的虚机网口队列中断绑核策略，包含已经配置策略的虚机类型、虚机规格、网络平面、单队列中断绑核和多队列中断绑核。 
...
### 增加网口队列中断绑核策略(ADD VNICQCPU) 
### 增加网口队列中断绑核策略(ADD VNICQCPU) 


[](None)功能说明 

通常情况下，每个网口都有一个流量队列用来接收和发送网络数据包，一个队列由一个vCPU处理。网口多队列技术，可以让每个网口配置多个流量队列，将各个队列通过中断绑定到不同的vCPU上（即每个队列收到数据包后会触发中断，通知绑定的vCPU来处理），以满足网卡的需求。 

该命令用于设置当前NF中虚机网口队列的中断绑核策略，用户可以根据虚机类型、规格和网络平面进行单队列中断绑核或多队列中断绑核配置。 

增加配置后，可通过执行命令[SHOW VNICQCPU](../mml/1240379.html) 查询配置情况。
...
该配置执行后，需要重启对应类型的虚机后生效。 

 
该配置会根据虚机类型覆盖版本包中vru.json的所有平面绑核策略。 

 
对于被接管（如DPDK）的网口，不执行中断绑核。 

 
如果网口启动多队列，优先使用多队列中断绑核配置。如果网口为单队列，只使用单队列绑核配置。 

 
同一类型和规格的虚机的一个网络平面只能添加一个策略，如果需要修改策略，需删除原有策略后重新添加。 
...
[](None)标识|名称|类型|说明
---|---|---|---
VMTYPE|类型|参数可选性: 必选参数类型: 字符串参数范围: 1-8|该参数用于配置需要进行网口队列中断绑核的虚机类型。该参数可以通过SHOW VMTYPE命令输出信息的类型字段获取。
VMSIZE|规格|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数用于配置需要进行网口队列中断绑核的虚机规格。该参数可以通过SHOW VMTYPE命令输出信息的描述字段获取。
NETTYPE|网络平面|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-2|该参数用于需要进行网口队列中断绑核的网络平面，配置后，会对该网络平面下的所有网口执行中断绑核策略。网络平面有如下选项：MGT：管理平面SVR：业务平面OAM：OAM平面
SQCPU|单队列中断绑核|参数可选性: 任选参数类型: 数字参数范围: 1-64|该参数用于配置网口单队列中断所绑定的vCPU号。例如规格为8核的虚机，进行单队列中断绑核时可以根据实际vCPU负载选择0-7号vCPU中的任意一个。
MQCPU|多队列中断绑核|参数可选性: 任选参数类型: 字符串参数范围: 0-64|该参数用于配置网口多队列中断绑核绑定的CPU号。举例：规格为8核的虚机，支持多队列中断绑核。用户可以根据实际vCPU负载选择0-7号CPU中的多个vCPU，将按照顺序递归方式绑核。假设网口队列数为5，用户输入2/3，那么中断1绑定vCPU-2，中断2绑定vCPU-3，中断3绑定vCPU-2，中断4绑定vCPU-3，中断5绑定CPU-2。假设网口队列为2，用户输入为2/3/4，那么中断1绑定vCPU-2，中断2绑定CPU-3。
...
`
设置类型为GSU，规格为GSU-C8-E的虚机，service平面的多队列中断绑核CPU为：1、2、3。
ADD VNICQCPU: VMTYPE="GSU", VMSIZE="GSU-C8-E",NETTYPE="SVR",MQCPU="1/2/3"
` 


### 删除网口队列中断绑核策略(DEL VNICQCPU) 
### 删除网口队列中断绑核策略(DEL VNICQCPU) 


[](None)功能说明 

该命令用于删除虚机网口队列的中断绑核策略，用户需要根据虚机类型、规格和网络平面进行删除操作，这些参数可以通过执行命令[SHOW VNICQCPU](../mml/1240379.html)查询。

执行后，可通过执行命令[SHOW VNICQCPU](../mml/1240379.html)查询是否删除成功。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMTYPE|类型|参数可选性: 必选参数类型: 字符串参数范围: 1-8|该参数用于配置需要删除的网口队列中断绑核策略对应的虚机类型。该参数可以通过SHOW VNICQCPU命令获取。
VMSIZE|规格|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数用于配置需要删除的网口队列中断绑核策略对应的虚机规格。该参数可以通过SHOW VNICQCPU命令获取。
NETTYPE|网络平面|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-2|该参数用于配置需要删除的网口队列中断绑核策略对应的虚机网络平面。该参数可以通过SHOW VNICQCPU命令获取。
...
`
删除类型为GSU，规格为GSU-C8-E的虚机的service平面的多队列中断绑核策略。
DEL VNICQCPU: VMTYPE="GSU", VMSIZE="GSU-C8-E",NETTYPE="SVR"
` 


### 查询网口队列中断绑核策略(SHOW VNICQCPU) 
### 查询网口队列中断绑核策略(SHOW VNICQCPU) 


[](None)功能说明 

该命令用于查询当前NF中虚机网口的队列中断绑核策略。该命令可以查询到用户通过命令[ADD VNICQCPU](../mml/1240377.html)添加的策略。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMTYPE|类型|参数可选性: 必选参数类型: 字符串参数范围: 1-8|该参数用于显示网口队列中断绑核策略的虚机类型。
VMSIZE|规格|参数可选性: 必选参数类型: 字符串参数范围: 1-32|该参数用于显示网口队列中断绑核策略的虚机规格。
NETTYPE|网络平面|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-2|该参数用于显示网口队列中断绑核策略的网络平面。
SQCPU|单队列中断绑核|参数可选性: 必选参数类型: 字符串参数范围: 0-8|该参数用于显示网口队列中断绑核策略的单队列中断绑核信息。
MQCPU|多队列中断绑核|参数可选性: 必选参数类型: 字符串参数范围: 0-64|该参数用于显示网口队列中断绑核策略的多队列中断绑核信息。
...
(No.1) : SHOW VNICQCPU
类型     规格       网络平面    单队列中断绑核    多队列中断绑核
GSU   GSU-C8-E      service                       1/2/3
GSU   GSU-C8-E      mgt         5
记录数：2
...
系统存在CPU利用率高时，记录TOP3进程和线程以及容器日志信息。  
...
命令执行成功后，新增配置的虚机在CPU冲高告警时，记录TOP3的进程、线程以及容器信息。 
...
[](None)标识|名称|类型|说明
---|---|---|---
vm_name|虚机名称或类型|参数可选性: 必选参数类型: 字符串参数范围: 1-64|该参数表示需要增加虚机资源日志的虚机名称或类型，支持以下几种方式：1、虚机名称，例如：GSU0001。2、虚机类型+规格，中间没有空格，例如：IPUC4。3、虚机类型，例如：IPU。4、DEFAULT_CONFIG，表示对所有虚机生效。按照1、2、3、4的优先级顺序生效，1最高。虚机名称、类型、规格可以使用“SHOW VM”或“SHOW VMTYPE”查询获得，并且大小写需要和查询结果保持一致。
res_log|资源日志开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|该参数用于启用或禁用虚机资源日志记录。
...
`
新增名称为OMU_1的虚机资源日志配置。
ADD VMRESLOG:VM_NAME="OMU_1",RES_LOG="ENABLE"
` 


### 修改虚机资源日志配置(SET VMRESLOG) 
### 修改虚机资源日志配置(SET VMRESLOG) 
...
命令执行成功后，配置的虚机在CPU冲高告警时，打开或者关闭记录TOP3的进程、线程以及容器信息。 
...
`
设置虚机资源日志记录。
SET VMRESLOG:RES_LOG="ENABLE"
` 


### 删除虚机资源日志配置(DEL VMRESLOG) 
### 删除虚机资源日志配置(DEL VMRESLOG) 
...
命令执行成功后，系统不会在CPU冲高告警时，记录TOP3的进程、线程以及容器信息。 
...
`
删除虚机名称为OMU_0的资源日志配置。
DEL VMRESLOG:VM_NAME="OMU_0"
` 


### 显示虚机资源日志配置(SHOW VMRESLOG) 
### 显示虚机资源日志配置(SHOW VMRESLOG) 
...
[](None)标识|名称|类型|说明
---|---|---|---
vm_name|虚机名称或类型|参数可选性: 任选参数类型: 字符串参数范围: 1-64|该参数表示需要增加虚机资源日志的虚机名称或类型，支持以下几种方式：1、虚机名称，例如：GSU0001。2、虚机类型+规格，中间没有空格，例如：IPUC4。3、虚机类型，例如：IPU。4、DEFAULT_CONFIG，表示对所有虚机生效。按照1、2、3、4的优先级顺序生效，1最高。虚机名称、类型、规格可以使用“SHOW VM”或“SHOW VMTYPE”查询获得，并且大小写需要和查询结果保持一致。
...
[](None)标识|名称|类型|说明
---|---|---|---
vm_name|虚机名称或类型|参数可选性: 任选参数类型: 字符串参数范围: 1-64|该参数表示需要增加虚机资源日志的虚机名称。该参数设置为DEFAULT_CONFIG表示对所有虚机的资源日志配置进行设置。
res_log|资源日志开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|该参数用于显示虚机资源日志记录。
...
[](None)标识|名称|类型|说明
---|---|---|---
OPERATERESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义|该参数用于显示重启指定虚机的操作结果，结果包括：操作成功操作超时其他失败虚机不存在备用虚机不在线业务不可以迁移业务迁移失败VM的部署状态不是已部署NF的管理状态是锁定状态，不允许该操作查询NF管理状态失败NF的管理状态是关闭中，不允许该操作正在重启基础虚机，请稍后查询虚机状态系统正在进行其他虚机操作，请稍后再试。VMM重启失败。MANO重启失败。
...
[](None)标识|名称|类型|说明
---|---|---|---
OPERATERESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义|该参数用于显示启动虚机操作的结果，结果包括：操作成功操作超时虚机不存在其他失败系统正在进行其他虚机操作，请稍后再试。虚机运行正常，无需操作。
...
操作前，需确认指定虚机不是仲裁节点，可通过SHOW QUORUM VM命令查看。如果是仲裁节点，则隔离指定虚机前，需要通过MODIFY QUORUM VM命令将仲裁修改到其他虚机上。 
...
VMLABEL|标签|参数可选性: 必选参数类型: 字符串参数范围: 0-128|该参数用于对虚机的说明，方便维护人员对虚机进行标识。例如：STU-C8_Commbo。
...
该命令用于查询指定虚机的CPU占用率、磁盘占用率、内存占用率和内存缓存信息。当占用率过高时，会触发相应的告警。 
...
MEMCACHE|内存缓存(KB)|参数可选性: 必选参数类型: 数字|该参数用于显示当前虚拟机的内存缓存大小，单位是KB。内存缓存大小根据在虚机上执行cat /proc/meminfo命令后解析Cached字段获取。
...
虚机名称 CPU占用率(%) 内存占用率(%) 磁盘占用率(%) 内存缓存(KB)
-------------------------------------------------------------
OMU0001  14           29            17            3676072
-------------------------------------------------------------
记录数：1
...
DESC|描述|参数可选性: 必选参数类型: 字符串参数范围: 0-32|该参数用于显示该NF下与虚机规格有关的描述信息。
...
(No.1) : SHOW VMTYPE:
类型 规格        虚机最大数量 已部署数量   描述
----------------------------------------------------------
OMU  C4          2            2          OMU-C4
GSU  Common-C2M6 2            1          GSU-Common-C2M6
IPU  C4          2            2          IPU-C4
OMU  C2          1            1          OMU-C2
----------------------------------------------------------
记录数：4
...
小心：释放虚机缓存功能为危险命令，可能导致虚机性能降低，非必要不执行。 

OMU虚机上有大量文件操作，可能导致缓存占用大量内存，在没有启用内存水线或者内存水线设置过低（空闲内存可能会很少）的情况下，系统动态内存申请可能会失败。本命令可根据用户输入的虚机名称或者类型，清除指定虚机或指定类型虚机的缓存。 

本操作执行前后，可通过执行命令[SHOW VMDETAIL](../mml/1240305.html)查询虚机缓存情况。


[](None)注意事项 

该命令只能释放部署态为“已部署”且运行状态为“运行中”的虚机缓存，其他状态虚机不支持此操作。可以通过[SHOW VM](../mml/1240300.html)命令查询虚机状态。
...
[](None)标识|名称|类型|说明
---|---|---|---
VMNAMEORTYPE|虚机名称/类型|参数可选性: 必选参数类型: 字符串参数范围: 0-64|该参数用于设置虚机的名称或者类型，用于清除指定名称虚机或指定类型虚机的缓存，可通过SHOW VM命令查看虚机的名称和类型。
...
[](None)标识|名称|类型|说明
---|---|---|---
OPERATERESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-255|该参数用于显示操作结果：操作成功。正在执行相同的命令，请稍后再试！超时！不存在释放缓存虚机或虚机不是正常运行状态！虚机释放缓存失败！
...
如果所操作的VRU属于TMSP或者OAM服务，通过[SHOW VRU](../mml/1240301.html)查询该容器运行正常后，再继续使用该命令！
...
LIMITENABLEFLAG|内存CPU限额生效标记|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-2|该参数用于显示当前NF中部署的该VRU的“CPU配额”和“内存配额”是否生效。否：表示该VRU的“CPU配额”和“内存配额”未生效。是：表示该VRU的“CPU配额”和“内存配额”生效。未配置：表示运维人员未配置过该VRU的“CPU配额”和“内存配额”的生效标记。
...
[SET PASSWD](../mml/1240333.html)命令可以进行虚机密码的修改，增强系统安全性。
[CHECK PASSWD](../mml/1240351.html)命令可以一键检查能否通过admin用户密码SSH接入虚机，使虚机密码检查操作更加方便快捷。
...
命令执行成功后，需要执行[SHOW NTP](../mml/1249504.html)命令检查配置是否正确。
...
该命令用于增加NTP密钥。当需要启动NTP协议的消息鉴权码(MAC)时，使用该命令。命令执行成功后，可以使用[SHOW NTPKEY](../mml/1249524.html)命令查询配置结果。
...
该命令用于修改NTP密钥。当需要修改索引对应的密钥时，使用该命令。命令执行成功后，可以使用[SHOW NTPKEY](../mml/1249524.html)命令查询修改后的配置。
...
该命令用于删除NTP密钥。当需要删除密钥时，使用该命令。命令执行成功后，可以使用[SHOW NTPKEY](../mml/1249524.html)命令查询删除后的配置。
...
该命令忽略[SET NTP](../mml/1249502.html)配置中设置的最大误差阈值，强制同步一次NTP时间，使得本地时间与标准时间保持一致。


[](None)注意事项 

使用该命令前，需要先在[SET NTP](../mml/1249502.html)配置中设置上级NTP服务器的IP地址。
...
需要提前在NTP配置（[SET NTP](../mml/1249502.html)）里启用NTP且配置NTP服务器IP。
...
修改MTU值后，需要通过 [RESET SYSTEM](../mml/1242306.html)命令整局重启，才可以生效。MTU值配置不当会导致配置平面网络不通，会对当前的业务造成重大影响，请慎重操作。
...
查询进程信息([SHOW PROCESSINFO](../mml/1249550.html))：先查询要执行调试函数的进程号。


查询SC进程调试函数([SHOW PROCESSDEBUGINFO](../mml/1249551.html))：然后查询该进程的调试函数。


执行进程调试函数([EXEC PROCESSDEBUG](../mml/1249552.html))：最后执行该进程的特定调试函数。
...
当需要执行[SHOW PROCESSDEBUGINFO](../mml/1249551.html)命令查看SC内的某个进程支持的调试函数时，需要使用该命令确认该进程的进程号。
...
当需要查看进程的调试信息时，需要先执行该命令显示出该进程内允许执行的调试函数，再执行[EXEC PROCESSDEBUG](../mml/1249552.html)命令查看具体调试信息。
...
染色任务可以重复使用，因此再次执行染色功能时，可以根据需求启动已创建的染色任务，启动前可以通过[CLEAR INNER COLORING COUNT](../mml/1242335.html)命令清除之前的染色统计，或者通过[ADD INNER COLORING](../mml/1242330.html)命令创建新的染色任务，后续流程与初次使用相同。可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询已创建的染色任务。对于不需要的染色任务可以通过[DELETE INNER COLORING](../mml/1242331.html)命令进行删除。
...
执行该命令前后，可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询已创建以及新创建的染色任务。

刚创建好的染色任务会被保存但不能立即执行染色功能，需执行[START INNER COLORING](../mml/1242333.html)命令启动该染色任务。


[](None)注意事项 

染色任务的编号具有唯一性不能重复。染色任务的源端信息和目的端信息具有唯一性不能重复，不允许创建源端信息、目的端信息完全一样的两个染色任务。可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询已存在的染色任务。
...
删除染色任务成功后，该染色任务的保存记录将被删除，并无法再启动该染色任务。如误删某染色任务，可以通过[ADD INNER COLORING](../mml/1242330.html)命令重新创建。

执行该命令前后，可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询已创建的染色任务以及某染色任务是否已被删除。


[](None)注意事项 

源端或目的端已启动的染色任务无法删除，需要先停止任务。源端以及目的端的染色任务状态可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询。
...
由于染色任务可以重复使用，已创建或已关闭的染色任务都可以（重新）启动。每次启动染色任务时会显示启动前对应位置染色任务的统计值，可以在启动染色任务前通过[CLEAR INNER COLORING COUNT](../mml/1242335.html)命令清除染色统计。

执行该命令前后，可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询源端和目的端染色任务的状态。
...
执行该命令后，可以通过[SHOW INNER COLORING COUNT](../mml/1242336.html)命令查询染色统计是否已清除。


[](None)注意事项 

已启动的染色任务无法清除染色统计，可以先通过[STOP INNER COLORING](../mml/1242334.html)命令停止染色任务。源端和目的端染色任务的状态可以通过[SHOW INNER COLORING](../mml/1242332.html)命令查询。
...
当需要开启或者关闭虚机操作系统的系统日志上报功能或者需要修改系统日志上报的服务器地址时可以使用[SET OSSYSLOGCFG](../mml/1240332.html)命令。

配置开关打开后，全部虚机的系统运行日志将采集到指定的服务器，进而方便运维人员分析定位网元系统故障。 

可以通过[SHOW OSSYSLOGCFG](../mml/1240331.html)命令查询修改前后的配置信息。
...
执行该命令前后，可以通过[SHOW OSSYSLOGCFG](../mml/1240331.html)命令查询修改前后的配置信息。
...
PORT|端口|参数可选性: 任选参数类型: 数字参数范围: 1-65535|该参数用于设置日志网关端口，即虚机操作系统的系统日志需要上报的服务器端口。
...
[](None)标识|名称|类型|说明
---|---|---|---
OPERATERESULT|操作结果|参数可选性: 必选参数类型: 枚举，参见枚举定义|该参数用于表示执行该命令的操作结果：操作成功。正在执行相同的命令，请稍后再试！超时！其他！首次设置需要填写日志网关地址！配置没有发生变化！无效网关地址！
...
`
修改虚机操作系统的系统日志上报功能配置，打开配置开关，并将日志网关地址设置为192.168.126.126, 端口设置为514。
...
诊断任务可以重复使用，因此再次执行诊断功能时，可以根据需求启动已创建的诊断任务，启动前还可以通过[MODIFY DIAG](../mml/1242347.html)命令修改已创建的诊断任务，或者通过[ADD DIAG](../mml/1242345.html)命令创建新的诊断任务，后续流程与初次使用相同。可以通过[SHOW DIAG](../mml/1242348.html)命令查询已创建的诊断任务。对于不需要的诊断任务可以通过[DELETE DIAG](../mml/1242346.html)命令进行删除。
...
执行该命令前后，可以通过[SHOW DIAG](../mml/1242348.html)命令查询已创建以及新创建的诊断任务。

刚创建好的诊断任务会被保存但不能立即执行诊断功能，需执行[START DIAG](../mml/1242349.html)命令启动该诊断任务。


[](None)注意事项 

诊断任务的编号具有唯一性，并且源端、目的端以及诊断类型都相同的诊断任务也是唯一的不允许重复创建，可以通过[SHOW DIAG](../mml/1242348.html)命令查询已存在的诊断任务，通过[MODIFY DIAG](../mml/1242347.html)命令修改已存在的诊断任务。
...
删除诊断任务成功后，将删除该诊断任务的保存记录，并无法再启动该诊断任务。如误删某诊断任务，可以通过[ADD DIAG](../mml/1242345.html)命令重新创建。

执行该命令前后，可以通过[SHOW DIAG](../mml/1242348.html)命令查询已创建的诊断任务以及某诊断任务是否已被删除。
...
已启动的诊断任务无法删除，需要先停止任务。诊断任务的状态可以通过[SHOW DIAG](../mml/1242348.html)命令查询。
...
执行该命令前后，可以通过[SHOW DIAG](../mml/1242348.html)命令查询修改前后该诊断任务相关参数的值。


[](None)注意事项 

已启动的诊断任务无法修改，需要先停止任务。诊断任务的状态可以通过[SHOW DIAG](../mml/1242348.html)命令查询。
...
`
将任务编号为1的诊断任务的诊断报文发送时间间隔修改为1000毫秒，诊断报文发送总数修改为100个，诊断报文长度修改为1024字节。
MODIFY DIAG:TASKNO=1,PACKETINTERVAL=1000,PACKETNUM=100,PACKETLENGTH=1024
` 
...
由于诊断任务可以重复使用，已创建或已停止的诊断任务都可以（重新）启动。启动诊断任务前，也可以通过[MODIFY DIAG](../mml/1242347.html)命令修改诊断任务。

执行该命令前后，可以通过[SHOW DIAG](../mml/1242348.html)命令查询诊断任务的状态。


[](None)注意事项 

目前，同一个源端只支持同时启动一个诊断任务。暂不支持源端NFS的业务面为内核态的诊断任务，如S规格的CommonS_SIG_0实例。 

可以通过[SHOW NFS](../mml/1242302.html)命令查询当前网元所有NFS实例的规格信息。
...
调用该命令停止诊断任务后，可以通过[SHOW DIAG](../mml/1242348.html)命令查询该诊断任务的状态，但无法再通过[SHOW DIAG RESULT](../mml/1242351.html)命令查询到该任务的诊断结果。
...
执行该命令前，可以通过[SHOW DIAG](../mml/1242348.html)命令查询诊断任务的状态。


[](None)注意事项 

已启动的诊断任务无法查询诊断结果。诊断任务的状态可以通过[SHOW DIAG](../mml/1242348.html)命令查询。
...
THRESHOLD|保活次数门限|参数可选性: 必选参数类型: 数字参数范围: 3-100默认值: 35|本参数用于指定主用Rosng协议栈单元未收到请求消息总次数达到多少时，判定接口处理单元状态异常。
...
`
设置接口处理单元与主用Rosng协议栈单元之间的保活消息参数，保活时间间隔为 1000 毫秒，保活次数门限为 35。
SET ROSNGINTERFACEKEEPALIVE:INTERVAL=1000,THRESHOLD=35
` 
...
THRESHOLD|保活次数门限|参数可选性: 任选参数类型: 数字参数范围: 3-100默认值: 35|本参数用于指定主用Rosng协议栈单元未收到请求消息总次数达到多少时，判定接口处理单元状态异常。
...
本配置用于查询和设置子端口自动配置开关，当要执行自动导入子端口配置等相关操作时，需要先打开此开关。 
...
该组命令包括对子端口自动配置开关的设置和查询操作。默认情况下，该配置开关处于关闭状态，如需打开，可以通过[SET SUBCPAUTOCFG](../mml/1240020.html)命令进行修改，并可以通过[SHOW SUBCPAUTOCFG](../mml/1240021.html)命令查看当前开关状态。
...
当监控人员需要设置子端口自动配置开关时，使用该命令。 

可以通过[SHOW SUBCPAUTOCFG](../mml/1240021.html)命令查询配置信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
autocfgswitch|是否启用自动配置|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: NO|该参数用于设置子端口自动配置开关，即是否启用子端口自动配置功能。各参数选项的含义是：否：关闭子端口自动配置功能。是：启用子端口自动配置功能。子端口自动配置开关默认为关闭。
...
`
修改子端口自动配置开关为开启。
SET SUBCPAUTOCFG:AUTOCFGSWITCH="YES"
` 


### 查询子端口自动配置开关(SHOW SUBCPAUTOCFG) 
### 查询子端口自动配置开关(SHOW SUBCPAUTOCFG) 
...
[](None)标识|名称|类型|说明
---|---|---|---
autocfgswitch|是否启用自动配置|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: NO|该参数用于显示子端口自动配置开关，即是否启用子端口自动配置功能。各参数选项的含义是：否：子端口自动配置功能关闭。是：子端口自动配置功能启用。子端口自动配置开关默认为关闭。
...
本配置用于查询子端口信息，当执行了子端口自动配置的相关操作后，可以通过该配置命令查询自动配置的子端口信息。 
...
该组命令包括[SHOW SUBPORT](../mml/1240022.html)，用于查询子端口配置信息。
...
[](None)标识|名称|类型|说明
---|---|---|---
faportipv4|父端口IP（v4）|参数可选性: 任选参数类型: 字符串|该参数用于指定虚机ipv4类型的父端口。
faportipv6|父端口IP（v6）|参数可选性: 任选参数类型: 字符串|该参数用于指定虚机ipv6类型的父端口。
...
faportipv4|父端口IP（v4）|参数可选性: 任选参数类型: 字符串|该参数用于指定虚机ipv4类型的父端口。
faportipv6|父端口IP（v6）|参数可选性: 任选参数类型: 字符串|该参数用于指定虚机ipv6类型的父端口。
subport|子端口|参数可选性: 任选参数类型: 字符串参数范围: 1-256|该参数用于显示虚机的子端口信息。
...
`
查询虚机的子端口。
SHOW SUBPORT:faportipv4="169.20.0.85", faportipv6="1111:0:0:41::6"

((No.1) : SHOW SUBPORT:faportipv4="169.20.0.85", faportipv6="1111:0:0:41::6"

父端口(v4)     父端口(v6)       子端口 
-----------------------------------------------------------------------------------------------------------------------
169.20.0.85    1111:0:0:41::6   ip:192.169.49.6+mask:255.255.255.0+ipv6:1111:0:0:31::6/64+vlan_id:100+ip_type:IPV4V6   
-----------------------------------------------------------------------------------------------------------------------
记录数：1
...
网元实例化或者IPS等接口板类容器扩容时，网元不能为新弹出的容器自动配置接口和路由，导致新弹出的容器不可用。为了使新弹出的容器弹出后即处于可用状态，需要提供一种模板配置的功能，使网元能根据模板在容器实例化后自动生成接口、路由等配置，并写入ROSng。 
...
开启自动配置模板功能使用该条命令。使用该命令前，需要使用自动模板配置命令[ADD AUTOCFGPROFILE](../mml/1242710.html)填充模板规则。这样在网元实例化或者容器扩容时，网元就能根据模板规则自动生成配置并写入ROSng。
...
### 设置自动配置模板开关(SET AUTOCFGPROFILESWITCH) 
### 设置自动配置模板开关(SET AUTOCFGPROFILESWITCH) 
...
接口板容器实例化或扩容后，网元不能为新弹出的容器自动配置接口和路由，导致新弹出的容器不可用。使能自动配置模板开关后，网元可以根据[ADD AUTOCFGPROFILE](../mml/1242710.html)配置的模板，自动为新弹出的IPS容器完成接口和路由等ROSng配置。


[](None)注意事项 

开启自动配置模板功能后，禁止用户手工修改接口、路由等ROSng配置。手工修改后，网元无法保证配置的一致性。 
...
[](None)标识|名称|类型|说明
---|---|---|---
AUTOCFGPROFILESWITCH|自动配置模板开关|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置自动配置模板开关。数据来源：本端规划。配置原则：配置为DISABLE时，表示默认不启用自动配置模板功能。配置为ENABLE时，表示启用自动配置模板功能。注意，需要人工评估ROSng配置中接口、路由和BFD等配置与配置模板SHOW AUTOCFGPROFILE不冲突才能开启，否则配置会存在冲突。
...
`
开启自动配置模板功能。
SET AUTOCFGPROFILESWITCH:AUTOCFGPROFILESWITCH="ENABLE"
` 


### 查询自动配置模板开关(SHOW AUTOCFGPROFILESWITCH) 
### 查询自动配置模板开关(SHOW AUTOCFGPROFILESWITCH) 
...
[](None)标识|名称|类型|说明
---|---|---|---
AUTOCFGPROFILESWITCH|自动配置模板开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置自动配置模板开关。数据来源：本端规划。配置原则：配置为DISABLE时，表示默认不启用自动配置模板功能。配置为ENABLE时，表示启用自动配置模板功能。注意，需要人工评估ROSng配置（router配置/show running-config）中接口、路由和BFD等配置与配置模板SHOW AUTOCFGPROFILE不冲突才能开启，否则配置会存在冲突。
...
`
查询自动配置模板功能开关状态。
SHOW AUTOCFGPROFILESWITCH

(No.1) : SHOW AUTOCFGPROFILESWITCH:
-----------------ips_113/CommonS_IPS_0----------------
操作维护       自动配置模板开关 
--------------------------------
修改           启用             
--------------------------------
...
执行成功开始时间:2022-09-19 18:35:55 耗时: 3.47秒
...
填充自动配置模板使用该条命令。执行完该命令后，再执行使能自动模板配置开关命令[SET AUTOCFGPROFILESWITCH](../mml/1242708.html)，在网元实例化或者容器扩容时，网元就能根据模板规则自动生成配置并写入ROSng。
...
运营商可以根据网络规划，在模板字段填充规划的ROSng配置，并使能自动配置模板功能开关[SET AUTOCFGPROFILESWITCH](../mml/1242708.html)后，网元会根据设定好的模板组自动生成接口、路由、BFD等配置命令，并自动写入ROSng。

当接口板类型容器如IPS扩容时，无需人工修改ROSng配置，扩容的容器即处于可用状态。 

该命令执行成功后，模板组生成的接口、路由和BFD等配置命令将自动写入ROSng。 


[](None)注意事项 

执行命令前，请注意检查ROSng配置，确保ROSng配置中所有接口状态都是在线的。 

请先进入节点“Rosng配置管理/router配置”，然后执行${show running-config}命令查看是否有接口处于离线状态（off-line）。 
...
[](None)标识|名称|类型|说明
---|---|---|---
PROFILEGROUP|模板组名称|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 0-63默认值: IPS|参数作用：设置模板组名称。数据来源：本端规划。配置原则：配置为IPS时，表示IPS模板组。配置为UPF时，表示UPF模板组。
PORT|接口编号|参数可选性: 必选参数类型: 数字参数范围: 0-31|参数作用：设置接口编号。数据来源：本端规划。配置原则：接口编号为父接口编号。
SUBPORT|子接口编号|参数可选性: 必选参数类型: 数字参数范围: 0-4095|参数作用：设置子接口编号。数据来源：本端规划。配置原则：SUBPORT为0时，表示没有配置子接口。SUBPORT为非0时，表示父接口下配置了子接口。
VLANID|VLAN ID|参数可选性: 必选参数类型: 数字参数范围: 0-4095默认值: 0|参数作用：设置接口VLANID。数据来源：本端规划。配置原则：根据自动配置模板中的SUBPORT参数的设置情况确定。SUBPORT为0时，表示没有配置子接口，此时参数无意义。SUBPORT为非0时，表示配置了子接口，子接口下可以关联VLANID。一个父接口下可以配置512个子接口，同一个父接口下子接口VLANID不能相同；不同父接口下的子接口，VLANID可以相同，也可以不同。
IPVERSION|IP版本|参数可选性: 必选参数类型: 枚举，参见枚举定义参数范围: 2-10默认值: IPv6|参数作用：设置IP版本。数据来源：本端规划。配置原则：配置为IPv4时，表示模板组匹配的IP地址为IPv4。配置为IPv6时，表示模板组匹配的IP地址为IPv6。
VRFNAME|VRF名称|参数可选性: 任选参数类型: 字符串参数范围: 0-32|参数作用：设置VRF名称。数据来源：本端规划。配置原则：字符串格式不包含空格，区分大小写。
MTU|MTU|参数可选性: 任选参数类型: 数字参数范围: 68-9586默认值: 1500|参数作用：设置接口IP协议最大传输单元。数据来源：本端规划。配置原则：IPv4协议取68-9586之间的数值。IPv6协议取1280-9586之间的数值。
SUBNET|子网IP地址和掩码长度|参数可选性: 必选参数类型: 字符串参数范围: 0-50|参数作用：设置子网IP地址/掩码长度。数据来源：本端规划。配置原则：IPv4格式：X.X.X.X/<1-32>，其中每个X为0~255之间的十进制整数。掩码长度取值范围1-32之间的整数。IPv6格式：X:X::X:X/<0-128>。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。<1-128>表示IPv6地址的前缀长度，取值范围1~128。
DESTIPMASK|静态路由目的地址和掩码长度|参数可选性: 任选参数类型: 字符串参数范围: 0-50|参数作用：设置静态路由目的IP。数据来源：本端规划。配置原则：IPv4格式：X.X.X.X/<1-32>，其中每个X为0~255之间的十进制整数。掩码长度取值范围1-32之间的整数。IPv6格式：X:X::X:X/<0-128>。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。<1-128>表示IPv6地址的前缀长度，取值范围1~128。
NEXTHOPLIST|下一跳列表|参数可选性: 任选参数类型: 字符串参数范围: 0-187|参数作用：设置静态路由下一跳列表。数据来源：本端规划。配置原则：默认支持的下一跳数量最大为4个。IPv4格式：X.X.X.X[<,X.X.X.X>...]，其中每个X为0~255之间的十进制整数。IPv6格式：X:X::X:X[<,X:X::X:X>...]。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。
BFDCHECK|静态路由关联BFD检测使能开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置静态路由关联BFD检测使能开关。数据来源：本端规划。配置原则：配置为DISABLE时，表示静态路由不关联BFD检测。配置为ENABLE时，表示静态路由关联BFD检测。
TXINTERVAL|BFD最小发包间隔|参数可选性: 任选参数类型: 数字参数范围: 10-10000默认值: 400|参数作用：设置BFD最小发包间隔参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD发送检测报文间隔。
RXINTERVAL|BFD最小收包间隔|参数可选性: 任选参数类型: 数字参数范围: 10-10000默认值: 400|参数作用：设置BFD最小收包间隔参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD接收检测报文间隔。
MULTIPLIER|BFD检测倍数|参数可选性: 任选参数类型: 数字参数范围: 3-50默认值: 5|参数作用：设置BFD检测倍数参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD检测报文倍数。
SINGLEARMECHO|使能BFD单臂ECHO开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置使能单臂BFD开关。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置为DISABLE时，表示不使用单臂BFD。在BFDCHECK为ENABLE时，配置为ENABLE时，表示使用单臂BFD。
...
[](None)标识|名称|类型|说明
---|---|---|---
PROFILEGROUP|模板组名称|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-63默认值: IPS|参数作用：设置模板组名称。数据来源：本端规划。配置原则：配置为IPS时，表示IPS模板组。配置为UPF时，表示UPF模板组。
PORT|接口编号|参数可选性: 任选参数类型: 数字参数范围: 0-31|参数作用：设置接口编号。数据来源：本端规划。配置原则：接口编号为父接口编号。
SUBPORT|子接口编号|参数可选性: 任选参数类型: 数字参数范围: 0-4095|参数作用：设置子接口编号。数据来源：本端规划。配置原则：SUBPORT为0时，表示没有配置子接口。SUBPORT为非0时，表示父接口下配置了子接口。
VLANID|VLAN ID|参数可选性: 任选参数类型: 数字参数范围: 0-4095默认值: 0|参数作用：设置接口VLANID。数据来源：本端规划。配置原则：根据自动配置模板中的SUBPORT参数的设置情况确定。SUBPORT为0时，表示没有配置子接口，此时参数无意义。SUBPORT为非0时，表示配置了子接口，子接口下可以关联VLANID。一个父接口下可以配置512个子接口，同一个父接口下子接口VLANID不能相同；不同父接口下的子接口，VLANID可以相同，也可以不同。
IPVERSION|IP版本|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 2-10默认值: IPv6|参数作用：设置IP版本。数据来源：本端规划。配置原则：配置为IPv4时，表示模板组匹配的IP地址为IPv4。配置为IPv6时，表示模板组匹配的IP地址为IPv6。
VRFNAME|VRF名称|参数可选性: 任选参数类型: 字符串参数范围: 0-32|参数作用：设置VRF名称。数据来源：本端规划。配置原则：字符串格式不包含空格，区分大小写。
MTU|MTU|参数可选性: 任选参数类型: 数字参数范围: 68-9586默认值: 1500|参数作用：设置接口IP协议最大传输单元。数据来源：本端规划。配置原则：IPv4协议取68-9586之间的数值。IPv6协议取1280-9586之间的数值。
SUBNET|子网IP地址和掩码长度|参数可选性: 任选参数类型: 字符串参数范围: 0-50|参数作用：设置子网IP地址/掩码长度。数据来源：本端规划。配置原则：IPv4格式：X.X.X.X/<1-32>，其中每个X为0~255之间的十进制整数。掩码长度取值范围1-32之间的整数。IPv6格式：X:X::X:X/<0-128>。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。<1-128>表示IPv6地址的前缀长度，取值范围1~128。
DESTIPMASK|静态路由目的地址和掩码长度|参数可选性: 任选参数类型: 字符串参数范围: 0-50|参数作用：设置静态路由目的IP。数据来源：本端规划。配置原则：IPv4格式：X.X.X.X/<1-32>，其中每个X为0~255之间的十进制整数。掩码长度取值范围1-32之间的整数。IPv6格式：X:X::X:X/<0-128>。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。<1-128>表示IPv6地址的前缀长度，取值范围1~128。
NEXTHOPLIST|下一跳列表|参数可选性: 任选参数类型: 字符串参数范围: 0-187|参数作用：设置静态路由下一跳列表。数据来源：本端规划。配置原则：默认支持的下一跳数量最大为4个。IPv4格式：X.X.X.X[<,X.X.X.X>...]，其中每个X为0~255之间的十进制整数。IPv6格式：X:X::X:X[<,X:X::X:X>...]。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。
BFDCHECK|静态路由关联BFD检测使能开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置静态路由关联BFD检测使能开关。数据来源：本端规划。配置原则：配置为DISABLE时，表示静态路由不关联BFD检测。配置为ENABLE时，表示静态路由关联BFD检测。
TXINTERVAL|BFD最小发包间隔|参数可选性: 任选参数类型: 数字参数范围: 10-10000默认值: 400|参数作用：设置BFD最小发包间隔参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD发送检测报文间隔。
...
`
增加一条自动配置模板：PROFILEGROUP为"IPS"，PORT为1，SUBPORT为1，VLANID为10，IPVERSION为"IPv4"，VRFNAME为"test"，MTU为1000，SUBNET为"192.168.1.1/24"，DESTIPMASK为"172.172.172.1/24"，NEXTHOPLIST为"192.168.1.10,192.168.2.10"，其它任选字段为默认值。
ADD AUTOCFGPROFILE:PROFILEGROUP="IPS",PORT=1,SUBPORT=1,VLANID=10,IPVERSION="IPv4",VRFNAME="test",MTU=1000,SUBNET="192.168.1.1/24",DESTIPMASK="172.172.172.1/24",NEXTHOPLIST="192.168.1.10,192.168.2.10";
` 


### 删除自动配置模板(DEL AUTOCFGPROFILE) 
### 删除自动配置模板(DEL AUTOCFGPROFILE) 
...
运营商网络规划发生变更时，需要删除原来的模板组配置时，使用该命令。 

该命令执行成功后，匹配的自动配置命令将自动从ROSng配置删除。 
...
`
删除一条自动配置模板： PROFILEGROUP为"IPS"，PORT为1，SUBPORT为1，VLANID为10，IPVERSION为"IPv4"。
DEL AUTOCFGPROFILE:PROFILEGROUP="IPS",PORT=1,SUBPORT=1,VLANID=10,IPVERSION="IPv4";
` 


### 查看自动配置模板(SHOW AUTOCFGPROFILE) 
### 查看自动配置模板(SHOW AUTOCFGPROFILE) 
...
`
查看自动配置模板组： PROFILEGROUP为"IPS"。
SHOW AUTOCFGPROFILE:PROFILEGROUP="IPS";

(No.1) : SHOW AUTOCFGPROFILE:PROFILEGROUP="IPS"
-----------------ips_113/CommonS_IPS_0----------------
操作维护       模板组名称 接口编号 子接口编号 VLAN ID IP版本 VRF名称 MTU  IP地址和子网掩码长度 静态路由目的地址和掩码长度 下一跳列表                静态路由关联BFD检测使能开关 BFD最小发包间隔 BFD最小收包间隔 BFD检测倍数 使能BFD单臂ECHO开关 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
复制 删除      IPS        1        1          10      IPv4   test    1000 192.168.1.1/24       172.172.172.1/24           192.168.1.10,192.168.2.10 DISABLE                     400             400             5           DISABLE             
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
记录数：1

执行成功开始时间:2022-09-19 18:40:29 耗时: 27.545秒
...
节点用于查询自动配置信息表。使能自动配置模板开关[SET AUTOCFGPROFILESWITCH](../mml/1242708.html)，且配置了自动配置模板组后，模板会根据环境部署IPU/PFU虚机，创建可用于生成ROSng配置的信息表。该信息表可用于在OMU重启时，避免已有ROSng配置重复写入ROSng。
...
[](None)标识|名称|类型|说明
---|---|---|---
IFNAME|接口名称|参数可选性: 任选参数类型: 字符串参数范围: 12-32|参数作用：设置接口名称。数据来源：本端规划。配置原则：名称格式：xgei-<0-63>/<0-3>/<0-31>/<0-31>[.<0-4095>]。若配置父接口名称，形如：xgei-1/0/0/1；若配置子接口名称，形如：xgei-1/0/0/1.1。
IPVERSION|IP版本|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 2-10默认值: IPv6|参数作用：设置IP版本。数据来源：本端规划。配置原则：配置为IPv4时，表示模板组匹配的IP地址为IPv4。配置为IPv6时，表示模板组匹配的IP地址为IPv6。
...
---|---|---|---
IFNAME|接口名称|参数可选性: 任选参数类型: 字符串参数范围: 12-32|参数作用：设置接口名称。数据来源：本端规划。配置原则：名称格式：xgei-<0-63>/<0-3>/<0-31>/<0-31>[.<0-4095>]。若配置父接口名称，形如：xgei-1/0/0/1；若配置子接口名称，形如：xgei-1/0/0/1.1。
VLANID|VLAN ID|参数可选性: 任选参数类型: 数字参数范围: 0-4095默认值: 0|参数作用：设置接口VLANID。数据来源：本端规划。配置原则：当IFNAME为父接口时，表示没有配置子接口，此时参数无意义。当IFNAME为子接口时，可以关联VLANID。一个父接口下可以配置512个子接口，同一个父接口下子接口VLANID不能相同；不同父接口下的子接口，VLANID可以相同，也可以不同。
IPVERSION|IP版本|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 2-10默认值: IPv6|参数作用：设置IP版本。数据来源：本端规划。配置原则：配置为IPv4时，表示模板组匹配的IP地址为IPv4。配置为IPv6时，表示模板组匹配的IP地址为IPv6。
VRFNAME|VRF名称|参数可选性: 任选参数类型: 字符串参数范围: 0-32|参数作用：设置VRF名称。数据来源：本端规划。配置原则：字符串格式不包含空格，区分大小写。
MTU|MTU|参数可选性: 任选参数类型: 数字参数范围: 68-9586默认值: 1500|参数作用：设置接口IP协议最大传输单元。数据来源：本端规划。配置原则：IPv4协议取68-9586之间的数值。IPv6协议取1280-9586之间的数值。
SUBNET|子接口IP地址和掩码长度|参数可选性: 任选参数类型: 字符串参数范围: 0-50|参数作用：设置子接口IP地址/掩码长度。数据来源：本端规划。配置原则：IPv4格式：X.X.X.X/<1-32>，其中每个X为0~255之间的十进制整数。掩码长度取值范围1-32之间的整数。IPv6格式：X:X::X:X/<0-128>。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。<1-128>表示IPv6地址的前缀长度，取值范围1~128。
DESTIPMASK|静态路由目的地址和掩码长度|参数可选性: 任选参数类型: 字符串参数范围: 0-50|参数作用：设置静态路由目的IP。数据来源：本端规划。配置原则：IPv4格式：X.X.X.X/<1-32>，其中每个X为0~255之间的十进制整数。掩码长度取值范围1-32之间的整数。IPv6格式：X:X::X:X/<0-128>。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。<1-128>表示IPv6地址的前缀长度，取值范围1~128。
NEXTHOPLIST|下一跳列表|参数可选性: 任选参数类型: 字符串参数范围: 0-187|参数作用：设置静态路由下一跳列表。数据来源：本端规划。配置原则：默认支持的下一跳数量最大为4个。IPv4格式：X.X.X.X[<,X.X.X.X>...]，其中每个X为0~255之间的十进制整数。IPv6格式：X:X::X:X[<,X:X::X:X>...]。X:X::X:X表示将要在接口上配置的地址，遵循RFC2373第2.2节中的规定，以16位为一组，中间用“:”格开。
BFDCHECK|静态路由关联BFD检测使能开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置静态路由关联BFD检测使能开关。数据来源：本端规划。配置原则：配置为DISABLE时，表示静态路由不关联BFD检测。配置为ENABLE时，表示静态路由关联BFD检测。
TXINTERVAL|BFD最小发包间隔|参数可选性: 任选参数类型: 数字参数范围: 10-10000默认值: 400|参数作用：设置BFD最小发包间隔参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD发送检测报文间隔。
RXINTERVAL|BFD最小收包间隔|参数可选性: 任选参数类型: 数字参数范围: 10-10000默认值: 400|参数作用：设置BFD最小收包间隔参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD接收检测报文间隔。
MULTIPLIER|BFD检测倍数|参数可选性: 任选参数类型: 数字参数范围: 0-50默认值: 5|参数作用：设置BFD检测倍数参数。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置此参数可以控制BFD检测报文倍数。
SINGLEARMECHO|使能BFD单臂ECHO开关|参数可选性: 任选参数类型: 枚举，参见枚举定义参数范围: 0-1默认值: DISABLE|参数作用：设置使能单臂BFD开关。数据来源：本端规划。配置原则：在BFDCHECK为DISABLE时，参数无意义。在BFDCHECK为ENABLE时，配置为DISABLE时，表示不使用单臂BFD。在BFDCHECK为ENABLE时，配置为ENABLE时，表示使用单臂BFD。
...
`
查看自动配置信息： IFNAME为xgei-1/0/1/1.1。
SHOW AUTOCFGINFO:IFNAME="xgei-1/0/1/1.1";

(No.1) :SHOW AUTOCFGINFO:IFNAME="xgei-1/0/1/1.1"
-----------------ips_113/CommonS_IPS_0----------------
操作维护       接口名称       VLAN ID IP版本 VRF名称 MTU(byte) 子网IP地址和掩码长度 静态路由目的地址和掩码长度 下一跳列表                静态路由关联BFD检测使能开关 BFD最小发包间隔(millisecond) BFD最小收包间隔(millisecond) BFD检测倍数 使能BFD单臂ECHO开关 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
复制 删除      xgei-1/0/1/1.1 10      IPv4   test    1000      192.168.1.1/24       172.172.172.1/24           192.168.1.10,192.168.2.10 DISABLE                     400                          400                          5           DISABLE             
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
记录数：1

执行成功开始时间:2022-09-21 09:36:23 耗时: 1.571秒
