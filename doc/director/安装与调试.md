...
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572934755338.png)按钮，选择基础设施→数据中心→概览
...
物理资源|查看该DC下的物理资源详情。
##### 相关任务 
在数据中心详情页面，单击基本信息栏中的[]images/1648172893876.png)，可编辑数据中心的基本信息，如[图4](10-%E6%B7%BB%E5%8A%A0%E6%95%B0%E6%8D%AE%E4%B8%AD%E5%BF%83.html#%E6%B7%BB%E5%8A%A0%E6%95%B0%E6%8D%AE%E4%B8%AD%E5%BF%83-65E75BDE__9b5b1894-81a8-4cb4-97fd-978033de0d1f)所示。
图4  编辑数据中心
[]images/6.png)
#### 配置云环境 
##### 添加云环境 
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572503370180.png)按钮，选择基础设施→数据中心→容器云
...
单击添加按钮，完成容器云的添加。
##### 结果 
等待数秒，参数正确的容器云状态栏变为[]images/1563267052981.png)。
##### 相关任务 
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/5522e732cef042f0909bc46e98630785.png)按钮，选择基础设施→数据中心→网络环境
...
使用获得相应操作权限的账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1586252573389.png)按钮，选择基础设施→虚拟资源→网络
，默认打开SDN页面。在左侧导航树中选择网络→云网络
，打开云网络页面。
单击Qos策略，切换至Qos策略页签。
...
使用获得相应操作权限的账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572512498538.png)按钮，选择运维→拓扑→云网络拓扑
...
使用领域管理员账户登录TECS Director。
##### 相关信息 
TECS Director中领域管理员和组织管理员都支持上传镜像操作，领域管理员上传的镜像支持所有组织使用；组织管理员上传的VDC镜像只支持本组织使用。组织管理员上传VDC镜像的操作步骤参见[上传VDC镜像（可选）](40-%E4%B8%8A%E4%BC%A0VDC%E9%95%9C%E5%83%8F.html)。
镜像源文件支持本地文件、ftp网络文件和http(s)网络文件上传三种方式。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572511862617.png)按钮，选择基础设施→虚拟资源→镜像
...
镜像已上传至镜像仓库并通过审核。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1648714509173.png)按钮，选择基础设施→虚拟资源→镜像
...
使用领域管理员账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1591083384054.png)按钮，选择基础设施→虚拟资源→计算→规格
...
使用领域管理员账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1647935739707.png)按钮，选择基础设施→虚拟资源→计算→规格
...
使用领域管理员账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572519402460.png)按钮，选择基础设施→虚拟资源→计算→规格
，打开规格页面。
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1610614524204.png)按钮，选择基础设施→虚拟资源→计算
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1602583138414.png)按钮，选择基础设施→虚拟资源→存储
，默认打开云硬盘页面。
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1602231390080.png)按钮，选择基础设施→虚拟资源→存储
，默认打开云硬盘页面。
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572521512258.png)按钮，选择基础设施→虚拟资源→计算
...
本节介绍安全管理中心的配置过程。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1656039497207.png)按钮，选择基础设施→虚拟资源→安全
...
介绍如何创建集群的网络资源。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1658213859690.png)按钮，选择基础设施→容器资源→集群管理
...
介绍如何创建集群的对接配置。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1656641174421.png)按钮，选择基础设施→容器资源→集群管理
...
介绍如何为集群预置镜像资源。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1658214362177.png)按钮，选择基础设施→数据中心→云环境远程管理
...
介绍如何添加集群规格。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1656642644130.png)按钮，选择基础设施→容器资源→集群管理
...
介绍如何创建容器集群。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1658214775503.png)按钮，选择基础设施→容器资源→集群管理
...
使用获得相应操作权限的账户登录TECS Director。 
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572573768650.png)按钮，选择运营→租户资源管理→组织管理
...
使用领域管理员账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1602661238113.png)按钮，选择运营→租户资源管理→组织管理
...
单击保存，完成VDC和云环境用户的绑定。
##### 相关任务 
在VIM用户管理页面，单击右侧用户行的[]images/1579251265587.png)按钮，可将VDC与云环境用户解绑，解绑后的用户出现在左侧的用户列表中。
#### 绑定VDC和云环境租户 
##### 摘要 
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1587470388085.png)按钮，选择运营→租户资源管理→VDC
...
已创建组织。 
##### 相关信息 
TECS Director支持批量导入组织管理员，具体步骤参见[批量导入组织用户](8544922.html)。
##### 步骤 
...
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1634805504591.png)按钮，选择运营→租户资源管理→组织管理
，打开组织管理页面。
单击组织名称，进入组织详情页面。 
...
使用获得相应操作权限的账户登录TECS Director。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1619334461527.png)按钮，选择运营→租户资源管理→组织管理
...
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1579772408488.png)按钮，选择运营→租户资源管理→组织管理
...
使用组织管理员账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1602666040581.png)按钮，选择运营→租户资源管理→组织管理
...
已创建子组织。 
##### 相关信息 
TECS Director支持批量导入子组织管理员，具体步骤参见[批量导入组织用户](8544922.html)。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1582701656862.png)按钮，选择更多→安全管理→用户管理
...
已创建子组织和子组织管理员。 
##### 相关信息 
给子组织分配VDC的方式是将所属组织中已有的VDC分配给子组织。组织中的VDC共有3种使用状态，参见[表1](1579771346598.html#%E7%BB%99%E9%83%A8%E9%97%A8%E5%88%86%E9%85%8DVDC-65E93412__0cc7af22-43e8-42dd-8907-286f34f3df20)。
使用状态|说明
---|---
...
共享|VDC可以被所有子组织使用
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1582879189592.png)按钮，选择运营→租户资源管理→组织管理
，打开组织管理页面。
...
已创建组织或子组织。 
##### 相关信息 
TECS Director支持批量导入端用户，具体步骤参见[批量导入组织用户](8544922.html)。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1602657893452.png)按钮，选择更多→安全管理→用户管理
...
已删除该子组织的所有下级子组织。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1582700361852.png)按钮，选择运营→租户资源管理→组织管理
，打开组织管理页面。
...
daisy中全局安全组开关已打开。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1595918753199.png)按钮，选择运营→租户资源管理→组织资源管理
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1610678491608.png)按钮，选择运营→租户资源管理→组织资源管理
...
根据规划配置相关参数，单击添加按钮。
##### 相关任务 
发布虚机时可选择已创建的密钥对进行配置，具体操作参见[发布虚机](44-%E5%8F%91%E5%B8%83%E8%99%9A%E6%9C%BA.html)。
#### 创建云硬盘 
##### 摘要 
...
使用组织管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572863639547.png)按钮，选择运营→租户资源管理→组织管理
，打开组织管理页面。
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572916296333.png)按钮，选择更多→系统管理→系统设置
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572916526877.png)按钮，选择更多→系统管理→系统设置
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572916729210.png)按钮，选择更多→系统管理→系统设置
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1573787101632.png)按钮，选择更多→系统管理→系统设置
...
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1616555035782.png)按钮，选择更多→系统管理→系统设置
...
使用领域管理员登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1602469275742.png)按钮，选择更多→系统管理→系统设置
，默认打开北向设置页面，在左侧导航树中选择系统设置→证书管理
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1579164847329.png)按钮，选择更多→系统管理→配置中心
...
使用领域管理员账户登录TECS Director。
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1573789841921.png)按钮，选择运维→告警管理→告警设置
...
使用领域管理员账户登录TECS Director。
###### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572918643256(%E9%87%8D%E7%94%A81).png)按钮，选择更多→系统管理→备份恢复
...
已获得License文件。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1587626090255.png)按钮，选择更多→系统管理→系统设置
...
网络、规划和镜像等都创建完毕。 
##### 步骤 
单击TECS Director顶部菜单栏中的[]images/1572920445928.png)按钮，选择运维→运维分析→诊断工具
...
##### 前提 
已创建对接用户。具体操作参见“[在TECS OpenStack创建对接用户](%E5%9C%A8Provider%E5%88%9B%E5%BB%BA%E5%AF%B9%E6%8E%A5%E7%94%A8%E6%88%B7.html)”。
##### 步骤 
...
##### 相关信息 
本任务中使用的配置数据参见[表1](1557385399111.html#%E6%96%B0%E5%BB%BAXX-0B9872C5__e62fdc0b-6962-4fb5-b875-26bbbd0d9394)。
配置参数|数值
---|---
...
##### 步骤 
在浏览器地址栏输入阿里云地址https://account.aliyun.com/，输入用户名及密码，单击登录按钮，如[图1](%E5%9C%A8%E9%98%BF%E9%87%8C%E4%BA%91%E9%85%8D%E7%BD%AE%E5%AF%B9%E6%8E%A5%E5%AF%86%E9%92%A5%E5%92%8C%E5%AF%86%E9%92%A5ID.html#task1__%E7%99%BB%E5%BD%95%E9%98%BF%E9%87%8C%E4%BA%91-1A01902A)所示。
图1  登录阿里云
...
##### 前提 
已创建对接用户。具体操作参见“[在Uniview创建对接用户](%E5%9C%A8Uniview%E5%88%9B%E5%BB%BA%E5%AF%B9%E6%8E%A5%E7%94%A8%E6%88%B7.html)”。
##### 步骤 
以Domain管理员账户登录TECS Director系统。
单击导航按钮，选择基础设施→数据中心
，打开数据中心页面。
...
#### 步骤 
在浏览器地址输入栏中，输入主用站点容灾配置环境登录地址（https://<主用站点地址>:1043/myportal），单击回车键，如[图1](1610094926618.html#zecceb706e0a04292b81b9c8eaebe38b6__c9757ee6-32ef-42ba-bb13-d94a9ea307e9)所示。
图1  登录主用站点
[]images/snap600.png)
...
介绍如何配置资源北向接口对接。 
#### 步骤 
单击TECS Director顶部菜单栏中的[]images/1655950067269.png)按钮，选择更多→安全管理→用户管理
...
介绍如何对接性能统计北向文件。 
#### 步骤 
单击导航按钮[]images/1655950099442.png)，选择更多→系统管理→系统设置
，打开北向设置页面。
单击性能北向FTP服务器设置页签，显示性能北向FTP服务器配置参数。
...
介绍如何配置告警SNMP北向对接。 
#### 步骤 
单击导航按钮[]images/1657075386447.png)，选择运维→告警管理→告警设置→接口管理
