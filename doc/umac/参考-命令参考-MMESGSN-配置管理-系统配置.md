...
父主题： [编码计划配置](../../zh-CN/tree/N_1254251.html)
...
该命令用于新增子系统类型的编码计划。需要增加常用的子系统描述ID，如SCCP、HLR、MSC、VLR、MAP、AUC、EIR、BSSAP、RANAP、SGSN、GGSN等。增加后，可以通过[SHOW MPLAN](1260181.html)命令查询。
...
父主题： [QoS配置](../../zh-CN/tree/N_1254260.html)
...
父主题： [SGSN QoS配置](../../zh-CN/tree/N_12542610.html)
...
通常情况下，SGSN按正常的QoS协商流程来决定MS最后使用的QoS，当通过本地维护终端的“[ADD IMSI QOSLMT](1262040.html)”命令，将“是否强制使用默认QoS”选择为“是”时，将使用本命令配置的默认QoS做为用户的协商QoS。


除此之外，该命令还受到安全变量“是否支持基于IMSI号段和接入类型控制QoS”（ID为786447）的影响，当此安全变量设置为：[SET SOFTWARE PARAMETER](1268001.html) :PARAID=786447,PARAVALUE=1时，SGSN将使用通过[ADD QOSTPL](1262035.html)命令配置QoS参数来进行QoS协商。
...
父主题： [默认QoS配置](../../zh-CN/tree/N_1254261.html)
...
父主题： [分级服务配置](../../zh-CN/tree/N_1254264.html)
...
父主题： [PIE参数配置](../../zh-CN/tree/N_12542641.html)
...
父主题： [用户级别与最大上下行速率配置](../../zh-CN/tree/N_12542642.html)
...
父主题： [THP配置](../../zh-CN/tree/N_12542643.html)
...
配置QoS模板。由于多个IMSI号段使用的QoS策略可能相同，所以将QoS策略单独配置称为QoS模板。 
                        ...
                        配置IMSI号段QoS上限配置（命令为：
                        [ADD IMSI QOSLMT](../mml/1262040.html)
...
配置此模板后，SGSN可以根据此模板定义的QoS参数来限制UE的QoS能力，详细内容参见[ADD IMSI QOSLMT](1262040.html)命令。
...
父主题： [QoS模板配置](../../zh-CN/tree/N_1254265.html)
...
IMSI号段QoS上限配置流程如下： 
                        ...
                        [SET IMSI QOSLMT SPRT](../mml/1269201.html)
                        。
                        ...
                        [SET IMSI QOSLMT DEFAULT](../mml/1262045.html)
                        。
...
父主题： [IMSI号段QoS上限配置](../../zh-CN/tree/N_1254266.html)
...
使用此功能需要先开启软件参数，对应的软件参数为“SGSN是否支持基于IMSI号段和接入类型限制QoS”。配置命令为： [SET SOFTWARE PARAMETER](1268001.html) :PARAID=786447,PARAVALUE=1; 。


在配置此命令之前，需要通过[ADD QOSTPL](1262035.html)命令配置QoS模板。
...
如果系统根据用户的IMSI号码、无线侧的接入类型及RNC ID（无线侧为Iu接入时），没有匹配到通过[ADD IMSI QOSLMT](1262040.html)命令设置的对应的“Iu接入QoS模板标识”或“Gb接入QoS模板标识”，
...
IMSI号段签约QoS提升功能的配置过程如下： 
                        ...
                        配置QoS提升模板，命令为
                        [ADD QOS UPGRADE TPL](../mml/1262073.html)
                        ...
                        [ADD IMSI UPGRADE QOS](../mml/1262048.html)
...
父主题： [IMSI号段签约QoS提升配置](../../zh-CN/tree/N_1254267.html)
...
系统通过一个预先设定的QoS提升模板规定了用户的上/下行MBR范围及可以提升到对应的数值，后续可以将此QoS模板与用户的IMSI关联，SGSN可以根据用户的IMSI号码提升用户签约QoS数据中的上/下行MBR（具体命令参见[ADD IMSI UPGRADE QOS](1262048.html)。
...
父主题： [QoS提升模板配置](../../zh-CN/tree/N_12542671.html)
...
在执行此命令前，必须确认：对应的“QoS模板标识”没有被某个IMSI号段关联，即通过[SHOW IMSI UPGRADE QOS](1262051.html)命令查询不到对应的记录，否则，需要先通过命令删除此“QoS模板标识”与IMSI号段的关联，此命令才能执行成功。
...
配置该命令前确认已经通过[ADD QOS UPGRADE TPL](1262073.html)命令配置了QoS提升模板。
...
父主题： [IMSI号段QoS提升配置](../../zh-CN/tree/N_12542672.html)
...
Smart QoS指SGSN记录UE不能接受的MBR和GBR的上限，在下次PDP激活或二次激活时，指定的MBR或GBR要比记录的UE的MBR和GBR的上限值要小，SGSN通过Smart QoS配置确定UE能接受的MRB和GBR的上限值。 
                ...
                [SET SMART QOS SPRT](../mml/1262061.html)
                。
...
父主题： [Smart QoS配置](../../zh-CN/tree/N_12542691.html)
...
在设置本命令前，需要通过[SET SMART QOS SPRT](1262061.html)命令设置SGSN支持Smart QoS功能。
...
父主题： [RAB指派流程QoS配置](../../zh-CN/tree/N_125426101.html)
...
父主题： [RAU流程QoS重协商和通知UE配置](../../zh-CN/tree/N_125426102.html)
...
父主题： [MME QoS配置](../../zh-CN/tree/N_12542611.html)
...
父主题： [QoS转换时的默认Pre-R8 QoS参数](../../zh-CN/tree/N_1254269.html)
...
父主题： [QCI相关配置](../../zh-CN/tree/N_125224302.html)
...
父主题： [标准QCI到Pre-R8 QoS映射配置](../../zh-CN/tree/N_125224300.html)
...
父主题： [扩展QCI到Pre-R8 QoS映射模板配置](../../zh-CN/tree/N_125224312.html)
...
该模板配置后，可以通过命令[ADD EXQCI](1262089.html)新增扩展QCI到该模板的映射。
...
删除前，需要先删除映射模板关联的扩展QCI到Pre-R8 QoS的映射关系，删除命令为[DEL EXQCI](1262091.html)。
...
配置扩展QCI到Pre-R8 QoS映射的过程如下： 
                        ...
                        把支持扩展QCI的开关打开，配置命令为：
                        [SET EXQCI SPRT](../mml/1262086.html)
                        。
                        ...
                        [ADD EXQCI TPL](../mml/1262081.html)
                        。
...
父主题： [扩展QCI配置](../../zh-CN/tree/N_125224322.html)
...
父主题： [MME支持大于256Mbps速率控制配置](../../zh-CN/tree/N_12542692.html)
...
父主题： [QoS控制策略配置](../../zh-CN/tree/N_125426921.html)
...
父主题： [用户级QoS控制配置](../../zh-CN/tree/N_125426922.html)
...
父主题： [会话级QoS控制配置](../../zh-CN/tree/N_125426923.html)
...
父主题： [承载级QoS控制配置](../../zh-CN/tree/N_125426924.html)
...
父主题： [默认承载ARP和QCI控制配置](../../zh-CN/tree/N_125426925.html)
...
需要通过命令[SET SOFTWARE PARAMETER](1268001.html)打开软件参数“修正UE AMBR(786551)”开关，本配置才能够生效。
...
父主题： [缺省UE AMBR配置](../../zh-CN/tree/N_125426926.html)
...
父主题： [公共QoS配置](../../zh-CN/tree/N_12542612.html)
...
父主题： [DSCP映射配置](../../zh-CN/tree/N_1254262.html)
...
父主题： [PFI映射配置](../../zh-CN/tree/N_1254263.html)
...
父主题： [SGSN对等PLMN配置](../../zh-CN/tree/N_1254280.html)
...
父主题： [默认对等PLMN配置](../../zh-CN/tree/N_1254281.html)
...
父主题： [对等PLMN Profile配置](../../zh-CN/tree/N_1254282.html)
...
父主题： [IMSI号段对等PLMN配置](../../zh-CN/tree/N_1254283.html)
...
父主题： [Diameter配置](../../zh-CN/tree/N_1254252.html)
...
父主题： [Diameter协议栈基本配置](../../zh-CN/tree/N_12621004.html)
...
父主题： [Diameter AVP Profile配置](../../zh-CN/tree/N_1254286.html)
...
删除某Profile时，需要先删除Profile在[SET DIAMROUTE](1262136.html)（diameter基础协议消息），[SET DIAMADJ](1262151.html)（diameterS6a口业务消息），[SET DIAMGMLCADJ](1262189.html)（diameterSlg口业务消息）或[SET DIMMEG ANALYSIS](1262606.html)（diameter消息分析结果索引）中的关联关系。具体删除关联关系的方法为在上述四条命令中指定参数PROFILEID/AVPPROID的值为0即可。
...
MME向HSS发送消息时，获取路由过程如下： 
                        ...
                        和
                        [ADD DIMOFC ANALYSIS](../mml/1261005.html)
                        。
                        ...
                        [ADD DIAMADJROUTE](../mml/1262145.html)
                        。
                        ...
                        [ADD DIAMROUTEGROUP](../mml/1262140.html)
                        。
                        ...
                        [ADD DIAMROUTE](../mml/1262135.html)
                        。
                        ...
                        [ADD DIAMLINKGROUP](../mml/1262130.html)
                        。其中，SCTP连接标识已经在Diameter偶联中配置，对应的配置命令为：
                        [ADD SCTP](../mml/CommonS_SIG->ADD SCTP.html)
                        。
...
MME向GMLC发送消息，获取路由过程如下： 
                        ...
                        [ADD MDNAL](../mml/1261015.html)
                        和
                        [ADD DIMGMLC ANALYSIS](../mml/1262195.html)
                        。
                        ...
                        [ADD DIAMGMLCADJ](../mml/1262188.html)
                        。
                        ...
                        [ADD DIAMGMLCROUTE](../mml/1262183.html)
                        。
...
父主题： [Diameter连接路由配置](../../zh-CN/tree/N_1254287.html)
...
父主题： [Diameter连接配置](../../zh-CN/tree/N_1254288.html)
...
该命令需要引用某条SCTP链路，配置前，需要先配置SCTP链路，SCTP链路的配置参见[ADD SCTP](../mml/1402536.html)。
...
删除前，需要先将该Diameter连接在Diameter链路组配置中去关联，Diameter链路组配置数据查询参见[SHOW DIAMLINKGROUP](1262133.html)。
...
父主题： [Diameter链路组配置](../../zh-CN/tree/N_12542871.html)
...
删除前，需要先将该Diameter链路组在Diameter路由配置中去关联，Diameter路由配置数据查询参见[SHOW DIAMROUTE](1262138.html)。
...
父主题： [Diameter路由配置](../../zh-CN/tree/N_12542872.html)
...
删除前，需要先将该Diameter路由在Diameter路由组配置中去关联，Diameter路由组配置数据查询参见[SHOW DIAMROUTEGROUP](1262143.html)。
...
父主题： [Diameter路由组配置](../../zh-CN/tree/N_12542873.html)
...
删除前，需要先将该Diameter路由组在Diameter局向路由配置中去关联，Diameter局向路由配置数据查询参见[SHOW DIAMADJROUTE](1262148.html)。
...
父主题： [Diameter局向路由配置](../../zh-CN/tree/N_12542874.html)
...
删除前，需要先将该Diameter局向路由在Diameter局向配置中去关联，Diameter局向配置数据查询参见[SHOW DIAMADJ](1262153.html)。
...
配置后，MME在对用户的IMSI进行号码分析，得到Diameter局向后，通过此处设置的局向路由，向用户归属的HSS发送消息。 
                ...
                [ADD DIM AVP PROFILE](../mml/1262160.html)
...
父主题： [Diameter局向配置](../../zh-CN/tree/N_12542875.html)
...
删除前，需要先将该Diameter局向在Diameter邻接局号码分析结果配置中去关联，Diameter邻接局号码分析结果配置数据查询参见[SHOW DIMOFC ANALYSIS](1261008.html)。
...
父主题： [Diameter EIR 配置](../../zh-CN/tree/N_12542876.html)
...
父主题： [Diameter GMLC配置](../../zh-CN/tree/N_1252294.html)
...
父主题： [Diameter GMLC局向路由配置](../../zh-CN/tree/N_12522941.html)
...
删除Diameter GMLC局向路由前需要确保该局向路由没有被任何Diameter GMLC局向关联，查询命令参见[SHOW DIAMGMLCADJ](1262191.html)。
...
父主题： [Diameter GMLC局向配置](../../zh-CN/tree/N_12522942.html)
...
删除Diameter GMLC局向时要确保该局向没有被Diameter GMLC号码分析结果索引所关联。参见[SHOW DIMGMLC ANALYSIS](1262198.html)。
...
MME向SMC发送消息，，获取路由过程如下： 
                        ...
                        [ADD MDNAL](../mml/1261015.html)
                        和
                        [ADD DIMSMC ANALYSIS](../mml/1262630.html)
                        。
                        ...
                        [ADD DIAMSMCADJ](../mml/1262625.html)
                        。
                        ...
                        [ADD DIAMSMCROUTE](../mml/1262620.html)
                        。
...
父主题： [Diameter SMC配置](../../zh-CN/tree/N_126262605.html)
...
父主题： [Diameter SMC局向路由配置](../../zh-CN/tree/N_126262606.html)
...
删除Diameter SMC局向路由前需要确保该局向路由没有被任何Diameter SMC局向关联，查询命令参见[SHOW DIAMSMCADJ](1262628.html)。
...
父主题： [Diameter SMC局向配置](../../zh-CN/tree/N_126262607.html)
...
删除Diameter SMC局向时要确保该局向没有被Diameter SMC号码分析结果索引所关联。参见[SHOW DIMSMC ANALYSIS](1262633.html)。
...
[](None)功能描述 
                ...
                [ADD DIAMADJROUTE](../mml/1262145.html)
                和
                [ADD DIMMEG ANALYSIS](../mml/1262605.html)
                命令中选择配置的Feature能力模板。
...
父主题： [Support Feature管理](../../zh-CN/tree/N_12626002.html)
...
当需要删除某Support Feature模板，需确定此模板未在命令[ADD DIAMADJ](1262150.html), [ADD DIAMADJROUTE](1262145.html)和[ADD DIMMEG ANALYSIS](1262605.html)命令中被使用。
...
父主题： [Diameter SCEF配置](../../zh-CN/tree/N_1261410011.html)
...
父主题： [Diameter消息控制配置](../../zh-CN/tree/N_12697235.html)
...
父主题： [Gb接入配置](../../zh-CN/tree/N_1254390.html)
...
父主题： [网络业务实体配置](../../zh-CN/tree/N_1244391.html)
...
删除NSE前，如果是FR承载，需要先通过[DEL NSVC](../mml/1262328.html)命令删除该NSE下的NSVC配置。如果是IP承载，需要先通过[DEL IP NSVC](1262351.html)命令删除该NSE下的IP NSVC配置，通过[DEL REMOTE ENDPOINT](1262347.html)命令删除该NSE下的远端端点配置。
...
父主题： [NSE保护路由区配置](../../zh-CN/tree/N_1244392.html)
...
父主题： [本端IP端点配置](../../zh-CN/tree/N_1244393.html)
...
删除本端端点前，需要先通过[DEL IP NSVC](1262351.html)命令删除引用了该本端端点的IP NSVC配置
...
配置远端IP端点的流程如下： 
                        ...
                        [ADD REMOTE ENDPOINT](../mml/1262345.html)
...
父主题： [远端IP端点配置](../../zh-CN/tree/N_1244394.html)
...
删除远端端点前，需要先通过[DEL IP NSVC](1262351.html)命令删除引用了该远端端点的IP NSVC配置。
...
配置IP网络业务虚连接的流程如下： 
                        ...
                        配置本端IP端点，参见
                        [ADD LOCAL ENDPOINT](../mml/1262340.html)
                        。
...
父主题： [IP网络业务虚连接配置](../../zh-CN/tree/N_1244395.html)
...
父主题： [Gb口网络管理](../../zh-CN/tree/N_1244400.html)
...
配置SGs数据的大致流程如下： 
                        ...
                        配置SGs路由。配置命令参见
                        [ADD SGS ROUTE](../mml/1262173.html)
                        ;
                        ...
                        配置路由组。 配置命令参见
                        [ADD SGS ROUTE GROUP](../mml/1262169.html)
                        ;
...
父主题： [SGs口配置](../../zh-CN/tree/N_12522801.html)
...
父主题： [SGs基本配置](../../zh-CN/tree/N_12522811.html)
...
父主题： [SGs连接路由配置](../../zh-CN/tree/N_125228311.html)
...
父主题： [SGs连接配置](../../zh-CN/tree/N_125228411.html)
...
执行该命令前需要先删除SGs路由，以确保删除的SGs连接没有被SGs路由关联。查询命令参见[SHOW SGS ROUTE](1262176.html)。
...
父主题： [SGs路由配置](../../zh-CN/tree/N_125228511.html)
...
执行该命令前通常需要执行删除SGs路由组操作，以确保删除的SGs路由没有被SGs路由组关联。 查询命令参见[SHOW SGS ROUTE GROUP](1262172.html)。
...
父主题： [SGs路由组配置](../../zh-CN/tree/N_125228611.html)
...
执行该命令前通常需要执行删除SGs局向操作，以确保删除的SGs路由组没有被SGs局向路由组关联。 查询命令参见[SHOW SGS OFFICE ROUTE GROUP](1262168.html)。
...
父主题： [SGs局向路由组配置](../../zh-CN/tree/N_125228711.html)
...
执行该命令前需要确保该SGs局向路由组没有被任何MSC/VLR配置关联，查询命令参见[SHOW MSCVLR](1262253.html)。


如果被删除的SGs局向路由已经与某VLR局向配置关联，需要先删除SGs局向路由与该VLR 局向之间的关联关系。 可以通过[SHOW VLROFFICE](1261264.html)命令查看VLR局向路由与VLR 局向之间的关联关系，通过[DEL VLROFFICE](1261263.html)命令删除。
...
使用该命令之前，需要MME支持SGs接口，配置命令为[SET SGSFLAG](1260253.html):SGSFLAG="YES"。
...
父主题： [SGs与EMM拒绝原因映射配置](../../zh-CN/tree/N_12522813.html)
...
该配置生效，需要MME支持SGs接口。查询MME是否支持SGs接口配置命令为[SHOW SGSFLAG](1260254.html)。
...
配置VLR POOL的相关配置命令如下： 
                        ...
                        配置VLR局向，配置命令为
                        [ADD VLROFFICE](../mml/1261261.html)
                        。
                        ...
                        [ADD LAIVLRPOOL](../mml/1261272.html)
                        。
...
父主题： [SGs口VLR POOL管理](../../zh-CN/tree/N_1252284.html)
...
该命令执行前，需要先执行SGs局向路由组配置。 配置命令参见 [ADD SGS OFFICE ROUTE GROUP](1262165.html)。
...
父主题： [SGs口VLR局向配置](../../zh-CN/tree/N_12522840.html)
...
如果被删除的VLR局向已经被某VLR POOL管理，需要先删除VLR局向与该VLR POOL之间的关联关系。 可以通过[SHOW VLRPOOL](1261270.html)命令查看VLR局向与VLR POOL之间的关联关系，通过[DEL VLRPOOL](1261269.html)命令删除。


如果被删除的VLR局向已经被MME特定VLR局向业务控制配置关联，需要先删除VLR局向与该VLR局向业务控制配置之间的关联关系。 可以通过[SHOW MOLVLR](1261259.html)命令查看VLR局向与VLR POOL之间的关联关系，通过[DEL MOLVLR](1261258.html)命令删除。
...
VLR局向标识需要通过命令[ADD VLROFFICE](1261261.html)进行配置。


一个VLR POOL最多支持32个VLR局向。 


需要通过命令[SET SOFTWARE PARAMETER](1268001.html)打开移动管理参数“支持VLR POOL组网”开关，本配置才能够生效。
...
父主题： [SGs口VLR POOL配置](../../zh-CN/tree/N_12522843.html)
...
如果被删除的VLRPOOL已经被某LAI关联，需要先删除VLRPOOL与该LAI之间的关联关系。 可以通过[SHOW LAIVLRPOOL](1261275.html)命令查看VLRPOOL与LAI之间的关联关系，通过[DEL LAIVLRPOOL](1261274.html)命令删除。
...
父主题： [SGs口VLR POOL NRI配置](../../zh-CN/tree/N_1252284_4.html)
...
父主题： [VLR POOL NRI长度配置](../../zh-CN/tree/N_1252284_4_1.html)
...
父主题： [POOL内VLR NRI值配置](../../zh-CN/tree/N_1252284_4_2.html)
...
位置区名需要通过命令[ADD LAI](1262230.html)进行配置。


VLR POOL标识需要通过命令[ADD VLRPOOL](1261267.html)进行配置。
...
父主题： [SGs口选择VLR POOL配置](../../zh-CN/tree/N_12522842.html)
...
父主题： [基于IMSI的SGs口控制配置](../../zh-CN/tree/N_12523850.html)
...
父主题： [SGs口IMSI控制策略配置](../../zh-CN/tree/N_125238501.html)
...
父主题： [SGs口IMSI配置](../../zh-CN/tree/N_125238502.html)
...
父主题： [基于APN的SGs口控制配置](../../zh-CN/tree/N_125228503.html)
...
MME根据不同的业务流程控制是否对用户鉴权，MME支持的可控制的流程包括IMSI附着、局内GUTI附着、RAT内局间附着、跨RAT局间附着、局内正常TAU、局内周期性TAU、RAT内局间TAU、跨RAT局间TAU、局内切换后TAU、RAT内局间切换后TAU、跨RAT局间切换后TAU、业务请求、Detach请求。用户在进行上述流程时，MME根据IMSI号段或者全局缺省IMSI号段配置选择对应的策略进行鉴权控制。流程如下： 
                    ...
                    [ADD MME IMSI AUTH](../mml/1261155.html)
                    ...
                    [ADD MME IMSI AUTH](../mml/1261277.html)
                    ）中配置的缺省鉴权策略进行控制。
...
父主题： [MME IMSI鉴权配置](../../zh-CN/tree/N_1254385.html)
...
父主题： [MME GUTI重分配配置](../../zh-CN/tree/N_1252297.html)
...
"SGSN IMSI鉴权配置" 设置用户IMSI号段的鉴权策略。 
                ...
                [SET SECURITY PARAMETER](../mml/1268035.html)
                ）进行配置。
...
父主题： [SGSN IMSI鉴权配置](../../zh-CN/tree/N_1254490.html)
...
父主题： [DNS配置](../../zh-CN/tree/N_1241491.html)
...
父主题： [DNS全局配置](../../zh-CN/tree/N_124149101.html)
...
父主题： [DNS服务器配置](../../zh-CN/tree/N_124149102.html)
...
父主题： [DNS服务器组配置](../../zh-CN/tree/N_124149103.html)
...
父主题： [DNS Profile配置](../../zh-CN/tree/N_124149104.html)
...
父主题： [DNS服务器链路状态检测配置](../../zh-CN/tree/N_124149105.html)
...
父主题： [DNS TCP链路配置](../../zh-CN/tree/N_124149106.html)
