...
本功能用于设置AMF 是否在?INITIAL CONTEXT SETUP REQUEST和HANDOVER REQUEST消息中携带Masked IMEISV。携带的前提是要配置获取IMEISV，必须先通过[SET AMFMOBCFG](../mml/1100006.html)命令设置“获取IMEISV”。具体为SET AMFMOBCFG:AMFGETIMEI="GETIMEISV" 
...
本功能用于配置操作员通过[ACTIVE REBALANC START](../mml/1106052.html)命令（Namf_Communication模式下）命令启动主动负载重平衡时，是否开启AMF负荷卸载优化功能。
