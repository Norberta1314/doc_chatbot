...
#### 实现原理 
###### 系统架构 
本特性的网络架构图如[图2](1590567320023.html#T_2017510842497__%E7%BD%91%E7%BB%9C%E6%9E%B6%E6%9E%84%E5%9B%BE-FDA98006)所示。
图2  网络架构图
...
###### 协议栈 
Gb口协议栈如[图3](1590567320023.html#T_2017510842497__Gb%E5%8F%A3%E5%8D%8F%E8%AE%AE%E6%A0%88-FDA9DC28)所示。
图3  Gb口协议栈
...
#### O&M相关 
###### 命令 
新增配置项参见[表1](1590567320023.html#T_20175108424914__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
配置项|命令
---|---
全局数据配置|SHOW NITZ
SET NITZ|全局数据配置
...
###### 性能统计 
新增性能计数器参见[表3](1590567320023.html#T_20175108424914__%E6%96%B0%E5%A2%9E%E6%80%A7%E8%83%BD%E8%AE%A1%E6%95%B0%E5%99%A8-FDADC421)。
性能计数器名称
---
...
#### 配置过程 
配置[SET QOS DEFAULT](../../MMESGSN\zh-CN\mml\1262000.html)命令。
...
#### 应用场景 
应用场景图如[图3](#T_201512301723953__0a22046e-c885-4e65-9804-4fee579d6622)所示。
图3  3G无线接入网络共享
...
#### 实现原理 
###### 系统架构 
Iu接口过载控制网络结构如[图1](1584759714115.html#T_2017510842497__c56f177f-26d7-4e45-b40d-15718e9f655c)所示。
图1  Iu接口过载控制网络结构
...
###### 协议栈 
Iu接口协议栈如[图2](1584759714115.html#T_2017510842497__0f0f0387-61cf-446b-8257-c8fb74db5cec)所示。
图2  Iu接口协议栈
...
###### 业务流程 
Iu接口过载控制业务流程如[图4](1584759714115.html#T_2017510842497__5f527904-3d3e-43e2-ab33-4098ca1a097d)所示。
图4  Iu接口过载控制业务流程
...
动态管理该特性不涉及动态管理。 
###### 性能统计 
新增性能计数器参见[表3](1584759714115.html#T_20175108424914__044ba5b4-5f2b-4b8c-aa9f-9530d959f11f)。
测量类型|描述
---|---
...
SGSN和RNC基本业务正常。 
#### 配置过程 
执行[SET OVERLOAD BASIC PARA](../../MMESGSN\zh-CN\mml\1261200.html)命令，配置过负荷基本参数。
...
#### 实现原理 
###### 系统架构 
MAP接口拥塞控制的系统架构如[图1](1603156550801.html#T_2017510842497__5639a60e-aaa8-43ab-b503-11dad0a12b63)所示（涉及红线标识的接口）。
图1  MAP接口拥塞控制的系统架构图
...
###### 本网元实现 
SGSN过负荷控制功能如[图3](1603156550801.html#T_2017510842497__aff494cd-8bd7-4c39-ab50-eec78bf3e5c9)所示。
图3  过负荷控制功能
...
已完成SGSN基本数据配置。 
#### 配置过程 
根据本网元SGSN实际负荷以及邻接HLR/SMC网元负荷能力，执行[ADD SGSN OFFICE SERVICE MAXIMUM](../../MMESGSN\zh-CN\mml\1261243.html)命令，新增SGSN特定局向业务控制配置。
#### 配置实例 
###### 场景说明 
...
#### 配置过程 
执行[SET SOFTWARE PARAMETER](../../MMESGSN\zh-CN\mml\1268001.html)命令，配置软件参数。
#### 配置实例 
###### 场景说明 
将无线拥塞控制功能配置为开启。 
###### 数据规划 
...
#### 实现原理 
###### 系统架构 
本特性的系统架构如[图1](1604566195584.html#d0e292__ded50ee3-f3cc-4e54-a5f9-eca2cdf0f517)所示。
图1  系统架构图
[]images/1604566196204.png)
###### 涉及的网元 
异常信令管控由SGSN和GGSN配合完成，具体参见[表1](1604566195584.html#d0e292__FunctionOfInvolvedNEs-27063B05)。
网元|功能
---|---
...
要预先规划FAKE APN。 
#### 配置过程 
执行命令[SET SGSN SIGSRESTRAIN FLAG](../../MMESGSN\zh-CN\mml\1260866.html)，打开“SGSN支持信令风暴抑制”功能开关。
