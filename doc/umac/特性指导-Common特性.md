...
#### 描述 
###### 定义 
3GPP TS 23.501标准规范中，提出了计算和存储分离的概念，对NF的状态数据进行统一存储，实现业务逻辑与状态数据分离，如[图1](1565265726679.html#T_2017510842494__%E4%B8%9A%E5%8A%A1%E9%80%BB%E8%BE%91%E4%B8%8E%E7%8A%B6%E6%80%81%E6%95%B0%E6%8D%AE-BA432C9C)所示，将状态数据存储在UDSF中。
图1  业务逻辑与状态数据
...
#### 实现原理 
###### 系统架构 
根据核心网云化的三层结构，NFV架构中各个节点的关系如[图1](1565265908588.html#T_2017510842497__NFV%E4%B8%89%E5%B1%82%E6%9E%B6%E6%9E%84-347B1D57)所示。
图1  NFV三层架构
[]images/1565265909400.png)
###### 涉及的网元 
各节点的功能说明参见[表1](1565265908588.html#T_2017510842497__%E7%BB%84%E7%BD%91%E8%AF%B4%E6%98%8E-B967A0AB)。
架构|节点|描述|对应的产品
---|---|---|---
...
#### 实现原理 
##### 系统架构 
本特性涉及的系统架构如[图3](1565265911682.html#new3bb07657a6dc4b7eb44d41e763ea93b3__%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84%E5%9B%BE-AF55812F)所示。
图3  系统架构图
...
实例化已经完成，系统已经接入EM系统。 
#### 配置过程 
使用[SET AUTOHEALINGGLB](../../Commons_TMSP\zh-cn\mml\1240000.html)命令，修改自愈全局配置。
...
#### 实现原理 
###### 系统架构 
维护人员通过升级管理对网元版本进行升级，系统架构如[图1](1575284370947.html#T_2017510842497__1cdb4294-fb30-4473-b170-05ae1d947871)所示。
...
#### 实现原理 
###### 系统架构 
AMF部分备份功能的网络架构如[图1](1592451357882.html#T_2017510842497__3f479bcd-5dbd-4510-b875-fad4fcc8504b)所示。该功能由AMF Set内的各AMF，以及gNodeB、NRF、SMF、PCF等共同实现。
图1  网络架构图
...
EM网管能正常连接并登录。 
#### 配置过程 
执行[ADD GUAMICFG](../../Namf_MP\zh-cn\mml\1100503.html)命令，设置可接管局AMF的GUAMI信息。
...
#### 实现原理 
###### 系统架构 
AMF全量容灾备份功能网络架构如[图1](1575451432649%EF%BC%88%E9%87%8D%E7%94%A81%EF%BC%89.html#T_2017510842497__1e77f50b-8c5f-4a37-9d22-07ac686863a5)所示，功能由AMF Set内的各AMF、以及gNodeB、NRF、SMF、PCF等共同实现。
图1  AMF全量容灾备份功能网络架构
...
###### 系统架构 
[图2](1575449734663.html#T_2017510842497__VLAN%E5%BA%94%E7%94%A8%E7%A4%BA%E6%84%8F%E5%9B%BE-216DA614)是一个VLAN应用，3台交换机在不同的区域，分别连接3台办公机，这3台办公机分别属于不同的VLAN，比如不同的终端用户，同一个虚线框表示同一个VLAN。
图2  VLAN应用示意图
...
#### 配置实例 
###### 场景说明 
利用VLAN子接口技术，实现同一物理以太网接口上不同VLAN用户的接入和路由，如[图1](1575449737349.html#T_20175108424919__VLAN%E6%8E%A5%E5%8F%A3%E9%85%8D%E7%BD%AE%E5%AE%9E%E4%BE%8B%E6%8B%93%E6%89%91%E5%9B%BE-4979C20D)所示。
图1  VLAN接口配置实例拓扑图
...
#### 应用场景 
以MME为例，MME在3GPP网络中的位置如[图1](#T_201512301723953__7dbf56a9-fc10-4a92-b662-119d9b7b15ef)所示。
...
本特性不涉及系统架构。 
###### 协议栈 
协议栈如[图1](1575361258993.html#T_2017510842497__df02cf4f-a739-472c-b39b-da98504f0f8a)所示。
图1  IP协议栈
...
AMF与邻接NF正常通信 
#### 配置过程 
执行[SET AMFGTPCADDRCFG](../../Namf_MP\zh-cn\mml\1100501.html)命令，配置AMF GTPC地址。
...
#### 实现原理 
###### 系统架构 
本特性涉及的系统架构如[图3](1642643091683GDvVro.html#T_2017510842497__56e7b2c3-b1ea-424d-9e22-fef21610c1cb)所示。
图3  DSCP映射系统架构
...
###### 协议栈 
本特性涉及的IP协议栈如[图4](1642643091683GDvVro.html#T_2017510842497__13d88a04-71a2-41ec-b611-63284192b8cd)所示。
图4  协议栈
[]images/%E5%8D%8F%E8%AE%AE%E6%A0%88.png)
###### 本网元实现 
AMF/MME/SGSN的DSCP映射的功能说明参见[表2](1642643091683GDvVro.html#T_2017510842497__89249133-b7b8-4462-9a01-08b2ea93ad71)
DSCP映射功能|说明
---|---
...
#### 实现原理 
###### 系统架构 
5GC核心网组网图如[图1](1575595978468.html#T_2017510842497__706c576f-0b27-4bb9-8ea3-85bde2035a62)所示。
...
基本协议不涉及具体网元的功能。 
###### 协议栈 
协议栈如[图2](1575595978468.html#T_2017510842497__09f08c6e-af00-48b3-8657-7cb3ee487509)所示。
图2  SBI协议栈
...
TLS连接正常 
#### 配置过程 
执行[ADD CLIENTPROFILE](../../CommonS_HTTP_LB\zh-cn\mml\1220001.html)命令，新增HTTP客户端模板配置。
...
#### 实现原理 
###### 系统架构 
如[图1](1575452308092.html#T_2017510842497__5cce1519-46c4-45e6-97a3-dfb357da111f)示，可以在DeviceA上配置一条目的地址为10.42.16.1，出接口为interface1的静态路由。
图1  静态路由架构图
...
#### 配置实例 
###### 场景说明 
如[图1](1575452310262.html#T_20175108424919__%E9%9D%99%E6%80%81%E8%B7%AF%E7%94%B1%E9%85%8D%E7%BD%AE%E5%AE%9E%E4%BE%8B%E5%9B%BE-225B6C05)所示，ZXUN uMAC对接Router 1的接口配置IP地址为10.6.1.1，Router 1对接ZXUN uMAC的接口配置IP地址为10.6.1.2，同属于10.6.1.X网段；Router 1对接Router
...
###### 本网元实现 
路由负荷分担包括两种方式，per-packet（包模式）和per-destination（流模式），两种方式的优缺点参见[表2](1575452311719.html#T_2017510842497__%E8%B7%AF%E7%94%B1%E8%B4%9F%E8%8D%B7%E5%88%86%E6%8B%85%E6%96%B9%E5%BC%8F-00653E39)。
类别|描述|优点|缺点
---|---|---|---
...
#### 配置实例 
###### 场景说明 
以OSPF协议为例，在同一个邻居节点在同一区域有多条链路可达，且其链路代价相同，启用IPv4等价路由，则可实现OSPF的IPv4等价路由，如[图1](1575452313660.html#T_20175108424919__IPv4%E5%A4%9A%E4%B8%8B%E4%B8%80%E8%B7%B3%E8%B7%AF%E7%94%B1%E7%A4%BA%E6%84%8F%E5%9B%BE-22CE282C)所示。
图1  IPv4等价路由示意图
...
###### 系统架构 
NTP的系统架构如[图1](1575452752947.html#T_2017510842497__NTP%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84%E5%8E%9F%E7%90%86-7747B523)所示。
图1  NTP系统架构原理
...
###### 本网元实现 
NTP的基本工作原理如[图2](1575452752947.html#T_2017510842497__fig_-1276-30D93949)所示。
图2  NTP系统架构原理
...
###### 业务流程 
如[图2](1575452752947.html#T_2017510842497__fig_-1276-30D93949)所示，业务流程如下：
...
###### 本网元实现 
EM跟踪功能由跟踪界面、任务管理、数据采集、数据监控与处理、解码组成，与数据库和文件系统交互，如[图2](1584775208719.html#T_2017510842497__%E7%B3%BB%E7%BB%9F%E7%BB%84%E6%88%90-B5B0C06B)所示。
...
#### 实现原理 
###### 系统架构 
该特性涉及到的网络结构如[图1](1631500644269.html#T_2017510842497__e9617281-a8cb-46b1-8906-3329f3dba4e6)所示。
图1  系统架构
...
#### O&M相关 
###### 命令 
本特性新增配置项参见[表1](1631500644269.html#T_20175108424914__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
配置项|命令
---|---
...
#### 实现原理 
###### 系统架构 
本特性涉及到的网络结构如[图1](1595819610648.html#T_2017510842497__bbbce70e-8390-4b1d-bfdb-e24a08dcfaa8)所示。
图1  服务化接口安全的组网图
...
###### 协议栈 
各接口均为SBI接口，对应的协议栈如[图2](1595819610648.html#T_2017510842497__7ca86a58-9d31-402f-989d-da1c4e077cc9)所示。
图2  SBI接口协议
...
AMF系统正常运行。 
#### 配置过程 
执行[SET STATICAUTHPOLICY](../../Namf_MP\zh-cn\mml\1100696.html)命令，设置静态授权策略。
...
#### 实现原理 
###### 系统架构 
GTP消息检查功能的系统架构如[图1](1601168556557.html#T_2017510842497__8e54664a-3f74-43b9-97b4-b7da3a68e960)所示。
图1  系统架构-GTP消息检查
...
###### 业务流程 
GTP-C消息过滤流程如[图2](1601168556557.html#T_2017510842497__c75a3dce-2760-4e6c-bdd5-a1cd7dcd4475)所示。
图2  GTP-C消息过滤流程图
...
EM（AMF网元）环境能正常连接。 
#### 配置过程 
执行[SET GTPSECCHKSWITCH](../../Namf_MP\zh-cn\mml\1100783.html) 命令，设置GTP安全检查开关 ，选择是否要进行GTP安全检查。
