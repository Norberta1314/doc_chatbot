...
计数器描述 : 
MS通过Iu口接入的情况下，测量单个路由区激活过程中由于ODB导致的PDP去活次数。 
测量触发点 : 
用户（Iu口接入）在激活过程中，由于ODB原因而激活失败时统计。 
采集方式 : 
CC 
# C405510079 每路由区ODB引起的PDP激活失败次数-GSM 

计数器描述 : 
MS通过Gb口接入的情况下，测量单个路由区激活过程中由于ODB导致的PDP去活次数。 
测量触发点 : 
用户（Gb口接入）在激活过程中，由于ODB原因而激活失败时统计。 
采集方式 : 
CC 
# C405510080 每路由区MS激活会话建立总时长(毫秒)-UMTS 
计数器描述 : 
每路由区有效MS（Iu口接入）激活会话建立总时长（单位：毫秒）。 
测量触发点 : 
...
计数器描述 : 
每路由区有效MS（Gb口接入）激活会话建立总时长（单位：毫秒）。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内由于重激活原因引起的SGSN向MS（3G接入）发起的去激活会话请求次数。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内MS（3G接入）发起双栈的PDP上下文激活，只允许IPv4的PDP类型的PDP激活成功次数。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内MS（2G接入）发起双栈的PDP上下文激活，只允许IPv4的PDP类型的PDP激活成功次数。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内MS（3G接入）发起双栈的PDP上下文激活，只允许IPv6的PDP类型的PDP激活成功次数。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内MS（2G接入）发起双栈的PDP上下文激活，只允许IPv6的PDP类型的PDP激活成功次数。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内MS（3G接入）发起双栈的PDP上下文激活，只允许单地址承载的PDP激活成功次数。 
测量触发点 : 
...
计数器描述 : 
统计单个路由区内MS（2G接入）发起双栈的PDP上下文激活，只允许单地址承载的PDP激活成功次数。 
测量触发点 : 
...
计数器描述 : 
采集周期内，区分路由区统计MS激活会话成功次数（针对3G用户统计）。 
测量触发点 : 
...
计数器描述 : 
采集周期内区分路由区统计GGSN发起去激活流程中，由于其他原因导致的流程失败次数（针对2G用户统计）。 
测量触发点 : 
（针对2G用户统计）GGSN发起去激活流程，由于其他原因导致流程失败时进行统计。 
采集方式 : 
CC 
# C405510193 每路由区GGSN去激活会话总时长(毫秒)-GSM 

计数器描述 : 
采集周期内区分路由区统计GGSN发起去激活流程总时长（针对2G用户统计）。 
测量触发点 : 
（针对2G用户统计）流程成功时间减去流程开始时间为GGSN发起去激活流程的时长，一个周期结束时区分路由区统计本周期内流程时长的总和。 
采集方式 : 
CC 
# C405510194 每路由区GGSN去激活会话最大时长(毫秒)-GSM 

计数器描述 : 
采集周期内区分路由区统计GGSN发起去激活流程最大时长（针对2G用户统计）。 
测量触发点 : 
（针对2G用户统计）流程成功时间减去流程开始时间为GGSN发起去激活流程的时长，一个周期结束时区分路由区统计本周期内流程时长的最大值。 
采集方式 : 
MAX 
# C405510195 每路由区GGSN去激活会话最小时长(毫秒)-GSM 

计数器描述 : 
采集周期内区分路由区统计GGSN发起去激活流程最小时长（针对2G用户统计）。 
测量触发点 : 
（针对2G用户统计）流程成功时间减去流程开始时间为GGSN发起去激活流程的时长，一个周期结束时区分路由区统计本周期内流程时长的最小值。 
采集方式 : 
MIN 
