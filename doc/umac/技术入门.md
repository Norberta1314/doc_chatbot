...
系统架构 3GPP定义的4/5G互操作的系统架构如[图1](#T_1554257199539__ba784754-237e-4108-b270-daa1efca9b92)所示。
图1  4/5G互操作系统架构
...
消息功能 在EPS和5GS相互切换过程中，源侧MME通过N26接口发送该消息给目标侧AMF，或者源侧AMF通过N26皆苦发送该消息给目标侧MME，作为切换过程中重定位流程的一部分。 
 说明： 
