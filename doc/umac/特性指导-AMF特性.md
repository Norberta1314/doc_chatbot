...
###### 业务流程 
架构融合不涉及业务流程变化。[图6](1567480150864.html#T_2017510842497__4240aa59-fec5-4826-bf2b-8e92516c59a4)描述如何实现融合节点的选择。
图6  融合节点选择
...
#### 实现原理 
##### 系统架构 
3GPP标准规范定义的5GC服务化架构示意图如[图1](1567498003933.html#new902a4610dcfa4cbd8cf007d4b6316577__b1ba43f8-95ab-4d4e-b969-af46c2499940)所示。
图1  5GC服务化架构
...
AMF各项对接和业务配置完毕。 
#### 配置过程 
1.执行[ADD NRFNODECFG](../../Namf_MP\zh-cn\mml\1100598.html)命令配置NRF地址。
...
无 
#### 配置过程 
通过[SET NITZCFG](../../Namf_Communication\zh-cn\mml\1100236.html)命令，修改网络标识和时区配置。
#### 配置实例 
###### 配置场景 
...
RAN和各NF基本业务正常 
#### 配置过程 
通过[SET AMFMOBCFG](../../Namf_Communication\zh-cn\mml\1100006.html)命令，修改AMF移动性配置。
#### 配置实例 
###### 配置场景 
...
#### 配置过程 
使用[SET AMFLOCALOFFICECFG](../../Namf_MP\zh-cn\mml\1100574.html)命令，AMF本局配置，配置AMF本局缺省的PLMN信息，包含移动国家码和移动网络码。
...
5GC中AMF网元运行正常。 
#### 配置过程 
当需要给终端下发NI或者TZ时，执行[SET NITZCFG](../../Namf_Communication\zh-cn\mml\1100236.html)命令，哪些流程期望下发NITZ，则设置该流程对应的参数值携带NITZ。
#### 配置实例 
###### 场景说明 
场景一：
UE首次接入AMF时，AMF将NITZ信息传递给UE。
...
#### 实现原理 
##### 系统架构 
在5G网络中，用户通过AMF接入网络，组网架构如[图1](#T_2017510842497__b1514641-a2f2-4284-91e7-678d6d71bb60)所示。UE在不同的区域接入网络时，AMF可以对UE进行接入控制。
图1  组网架构
...
##### 业务流程 
本特性的业务流程如[图2](#T_2017510842497__6063a58e-9ec4-4f10-8c89-3d401007a2b1)所示。
图2  业务流程
...
#### O&M相关 
##### 命令 
新增的配置项参见[表1](#T_20175108424914__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
配置项|命令
---|---
...
##### 告警和通知 
新增的告警和通知参见[表3](#T_20175108424914__%E5%91%8A%E8%AD%A6%E5%92%8C%E9%80%9A%E7%9F%A5AlarmsAndNotifications-24EE20FD)。
告警和通知
---
...
#### 实现原理 
###### 系统架构 
本特性涉及的系统架构如[图1](1611812649601.html#T_2017510842497__c25c877d-ab0a-4915-af8a-6d772eb7e514)所示。
图1  系统架构图
...
AMF网管能正常连接 
#### 配置过程 
根据场景需求，执行[SET 5GODBCFG](../../Namf_Communication\zh-cn\mml\1104148.html)命令，设置ODB参数。
#### 配置实例 
###### 场景一 
场景说明
...
##### 业务流程 
AN释放UE上下文流程如[图2](1567503903443.html#new3b3d817f006e40dc89ccabb95f25409f__AN%E9%87%8A%E6%94%BEUE%E4%B8%8A%E4%B8%8B%E6%96%87-AC5A64EB)所示。
图2  AN释放UE上下文
...
#### 实现原理 
##### 系统架构 
本特性涉及的系统架构如[图1](1567503908007.html#new72d7fa2e89ce4a3e84251d20f9a7fc6b__%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84-A48FEA15)所示。
图1  系统架构
...
#### 配置过程 
通过[ADD PAGINGPOLICYCFG](../../Namf_MT\zh-cn\mml\1107006.html)命令增加寻呼策略配置。策略内容包括寻呼方式、寻呼消息发送间隔、寻呼的重发次数、批量寻呼发送的个数、用于填写寻呼消息字段中的寻呼优先级。
...
#### 应用场景 
###### 概述 
常见的寻呼场景有三种，参见[表2](1567503913367.html#T_2017510842495__%E5%BA%94%E7%94%A8%E5%9C%BA%E6%99%AF-3473ACCD)。在保证一定寻呼成功率基础上，根据不同场景选择不同的寻呼策略。
编号|应用场景|寻呼需求|寻呼策略
---|---|---|---
...
#### O&M相关 
###### 命令 
新增配置项参见[表5](1567503913367.html#T_20175108424914__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
配置项|命令
---|---
...
###### 配置过程 
[SET MTBASICCFG](../../Namf_MT\zh-cn\mml\1107004.html)
...
#### 实现原理 
##### 系统架构 
本特性涉及的系统架构如[图1](1567503917056.html#new5fef8f0cd1b04719b293b6a52221bccc__%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84-ADC96EF0)所示。
图1  系统架构
...
###### 业务流程 
下发Masked IMEISV的流程如[图1](1611907835937.html#T_2017510842497__f608cb00-9c19-4906-9c43-4e55a6f77a9c)和[图2](1611907835937.html#T_2017510842497__4c1de07b-e498-4991-b50f-3e6da8b9eaa4)所示。
...
#### O&M相关 
###### 命令 
新增配置项参见[表1](1611907835937.html#T_20175108424914__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
配置项|命令
---|---
...
#### 实现原理 
###### 系统架构 
基于机器学习的智能寻呼系统架构如[图1](1663052948129hqbJRw.html#T_2017510842497__89f1ff70-d387-4fc6-a0ec-0f7e14e98ff4)所示。
图1  系统架构
...
#### 实现原理 
##### 系统架构 
切换流程相关的系统架构如[图1](1567560946944.html#newed1a68ed094643e69fc7cd7a54fe20c2__301c0bb8-c2b5-4aab-a659-c024e9d08951)所示。
图1  系统架构
...
#### 实现原理 
##### 系统架构 
切换流程相关的系统架构如[图1](1567560952179.html#newac36ccd8181f4929a059dfcab4559e62__%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84-AC444F98)所示。
图1  系统架构
...
#### 实现原理 
###### 系统架构 
5G系统架构如[图1](1583302882431.html#T_2017510842497__dd22c864-4384-4984-91b4-8c79b422545e)所示。
图1  系统架构
...
###### 协议栈 
本特性涉及的接口说明参见[表1](1583302882431.html#T_2017510842497__7b1479a1-0574-41c8-b419-7cbde5ce44ef)。
接口|描述|协议栈
---|---|---
N1|UE与AMF间逻辑接口|ZUF-79-19-001 N1
...
###### 业务流程 
UE发起PDU会话建立请求，DNN更正的流程如[图3](1583302882431.html#T_2017510842497__66af5220-7eb4-4751-96cf-6976b16c32ea)所示。
图3  UE请求PDU会话建立DNN更正
...
#### O&M相关 
###### 命令 
新增命令参见[表2](1583302882431.html#T_20175108424914__%E6%96%B0%E5%A2%9E%E9%85%8D%E7%BD%AE%E9%A1%B9-24E0BB59)。
配置项|命令
---|---
...
已完成初始配置。 
#### 配置过程 
执行[SET DNNCORRECT POLICY](../../Namf_Communication\zh-cn\mml\1100110.html)命令，开启DNN更正功能。
...
#### 实现原理 
###### 系统架构 
5GC组网架构如[图1](1568105118810.html#T_2017510842497__808308fa-f9de-4ad8-8e42-7aecd1ea255d)所示。
图1  系统架构
...
AMF网管能正常连接。 
#### 配置过程 
使用[SET DEFAUTHSTRATEGY](../../Namf_Communication\zh-cn\mml\1100428.html)命令，设置缺省的鉴权策略。
...
#### 调整特性 
使用[SET DEFPRETIMER](../../Namf_Communication\zh-cn\mml\1100198.html)命令修改AMF有名定时器时长。
...
#### 实现原理 
###### 系统架构 
5GC组网架构如[图1](1612320584502.html#T_2017510842497__3fedf5c1-cc6e-473f-bb58-a710394ccb3a)所示。
图1  5GC系统架构
...
###### 业务流程 
EAP-AKA'认证方式中，网络侧鉴权功能由AUSF负责，AMF只参与AUSF和UE之间鉴权信息的传递，以及最终KAMF密钥的推演。完整的EAP-AKA‘认证流程如[图2](1612320584502.html#T_2017510842497__cbe9393d-b82f-4f18-bc63-c57c5fa527b3)所示。
图2  EAP-AKA‘认证流程
...
#### 实现原理 
###### 系统架构 
PEI检查的系统架构如[图1](1576047502643.html#T_2017510842497__29c7778e-584a-46ff-82f0-e77f3f87d597)所示。
图1  PEI检查系统架构
...
###### 业务流程 
PEI检查的流程如[图2](1576047502643.html#T_2017510842497__10b23809-d29b-4a06-a5cd-9a4f3a03cc00)所示。
图2  PEI检查流程
...
与5G-EIR之间链路状态正常。 
#### 配置过程 
执行[SET PEICHECKCONFIG](../../Namf_Communication\zh-cn\mml\1104268.html)命令，设置AMF是否支持PEI检查、初始注册等各个流程是否进行PEI检查、AMF给EIR携带的参数、是否限制灰\黑名单\未知设备接入、是否发送用户灰/黑名单状态告警通知等配置项，以便灵活地控制PEI检查过程。可执行[SHOW PEICHECKCONFIG](../../Namf_Communication\zh-cn\mml\1104269.html)命令，查询PEI检查配置信息。
...
#### 实现原理 
###### 系统架构 
用户接入网络切片的组网结构如[图1](1567561523370.html#T_2017510842497__e6f2011e-9a1d-4b79-8ef9-44fb567a6011)所示。
图1  系统架构
...
#### 实现原理 
###### 系统架构 
本特性的组网结构如[图1](1645062683485yLFfym.html#T_2017510842497__7ab14055-a491-475d-bdbc-24dbfd1860aa)所示。
图1  组网结构
...
###### 业务流程 
详细的注册更新流程如[图2](1645062683485yLFfym.html#T_2017510842497__d820703c-e1bb-440b-bb4e-8bfa02a747ae)所示。
图2  注册更新流程
...
#### 实现原理 
###### 系统架构 
用户接入网络切片的组网结构如[图1](16430053228356i4G6n.html#T_2017510842497__90c376b7-881c-40c5-951a-a04128609974)所示。
图1  系统架构图
...
#### 实现原理 
###### 系统架构 
本特性涉及的系统架构图如[图1](1617881329399.html#T_2017510842497__eded7d12-4cdf-441d-a602-4a72d185c2be)、[图2](1617881329399.html#T_2017510842497__e3eb229a-12c4-460d-84c9-56ede1e1a470)所示。
图1  HR漫游场景下系统架构图
...
EM网管能正常连接并登录。 
#### 配置过程 
执行命令[SET 5GINTERWORKCFG](../../Namf_Communication\zh-cn\mml\1100078.html)，开启I-SMF/V-SMF重选、切片智能推导、4G到5G切换过程中AMF重选和4G到5G切换过程中本地切片选择功能。
#### 配置实例 
###### 场景一 
场景说明
...
#### 实现原理 
###### 系统架构 
5G系统架构如[图1](1617881677246.html#T_2017510842497__78c86379-bc44-4800-8fa5-57236c096852)所示。
图1  5G系统架构
...
###### 业务流程 
UE发起PDU会话建立请求，切片选择流程如[图5](1617881677246.html#T_2017510842497__85de2434-17cf-45c4-871d-0c61402ad759)所示。
图5  PDU会话建立切片选择流程
...
无。 
#### 配置过程 
执行[SET DEFAULT SLICE SELECTION POLICY](../../Namf_Communication\zh-cn\mml\1104200.html)命令，配置缺省切片选择策略。
...
###### 协议栈 
AMF与SMF之间的N11接口协议栈，基于HTTP RESTful服务化接口提供服务，如[图5](%E7%89%B9%E6%80%A7%E6%8F%8F%E8%BF%B0.html#T_2017510842497__69fa4dcc-1684-48c3-a542-c37efdd9fe7b)所示。
图5  N11接口协议栈
...
###### 业务流程 
SMF选择功能是在UE请求PDU会话的流程中执行的，参见[UE请求PDU会话建立流程中SMF选择](%E7%89%B9%E6%80%A7%E6%8F%8F%E8%BF%B0.html#T_2017510842497__d4e5938d-08de-4641-bedf-cee701da1b2c)。
...
AMF网元运行正常。 
#### 配置过程 
执行[SET DEFARFSPPOLICY](../../Namf_Communication\zh-cn\mml\1100392.html)命令，设置缺省RFSP策略。“缺省RFSP策略配置”用于设置AMF全局的缺省RFSP策略。
...
#### 实现原理 
###### 系统架构 
本特性涉及的互操作架构图如[图2](ZUF-79-12-001-1-%E7%89%B9%E6%80%A7%E6%8F%8F%E8%BF%B0.html#T_2017510842497__17246dd0-8e8d-445e-b184-d90a50ab3c43)所示。
...
#### 实现原理 
###### 系统架构 
本特性涉及的互操作架构图如[图2](1-%E7%89%B9%E6%80%A7%E6%8F%8F%E8%BF%B0.html#T_2017510842497__1a403cef-555e-465b-ad14-090be817e7bc)所示。
图2  4G和5G互操作架构图
...
#### 实现原理 
###### 系统架构 
VoNR中，5G网络是一个IP-CAN，通过IP实现UE和IMS实体之间的连通的网络实体和接口集合。5GC、RAN都需支持VoNR。网络中需要部署IMS网络，该业务网络与5G网络需互连互通。如[图1](1575010669301.html#T_2017510842497__928a78ff-3ceb-486c-b45e-e81526c437ec)所示。
图1  5G语音业务架构(VoNR)
...
###### 协议栈 
本特性涉及到的协议栈如[图2](1575010669301.html#T_2017510842497__88a9e410-a024-4af8-bfd6-8f8bf8943373)、[图3](1575010669301.html#T_2017510842497__54cb6777-9c9d-4497-9d2a-a6b22809b042)、[图4](1575010669301.html#T_2017510842497__6638ed5a-da2f-4f5d-aa45-d60f1ba4cce1)所示。
图2  AMF和其他NF的接口协议栈
...
#### O&M相关 
###### 命令 
与该特性相关的配置项参见[表1](1575010669301.html#T_20175108424914__26c37ea1-61f0-4683-aff8-39dd976a3f9d)。
配置项|命令
---|---
...
AMF网管能正常连接。 
#### 配置过程 
执行[SET 5GVONRCFG](../../Namf_Communication\zh-cn\mml\1100076.html)命令配置是否支持IMS VoPS业务，配置是否检查UE无线能力。
...
###### 背景知识 
支持紧急呼叫是移动通讯网络的基本要求，在5G SA网络架构下支持紧急呼叫有以下三种方案，具体参见[表1](1568686801530.html#T_2017510842494__e386c09e-b79e-43a7-93ba-cd0ac2fe2e4f)。方案1和方案2另有特性专门描述，本特性描述的是方案3。
编号|名称|描述|适用场景
---|---|---|---
...
AMF网管能正常连接。 
#### 配置过程 
执行[SET EMERGSRVFALLBACKPLY](../../Namf_Communication\zh-cn\mml\1100226.html)命令，进行默认紧急业务回落策略配置；
...
###### 背景知识 
紧急业务从2G/3G网络语音呼叫发展而来，2G/3G、4G、5G的语音呼叫存在差异，紧急业务语音上也存在差异，差异分析参见[表1](1583119423360.html#T_2017510842494__f6647da6-61b2-45d0-b576-35cf0a60bb16)。
...
#### 实现原理 
###### 系统架构 
本地用户紧急业务呼叫的系统架构如[图1](1583119423360.html#T_2017510842497__bb0d60f9-45a9-44b9-a050-62803de28fb3)所示。
图1  非漫游场景的5G系统架构
...
EM网管能正常连接AMF网元。 
#### 配置过程 
执行[SET EMERGSRVPLY](../../Namf_Communication\zh-cn\mml\1100265.html)命令，配置紧急业务策略。策略项包括：
支持紧急业务 
支持无卡用户紧急业务 
紧急注册鉴权 
鉴权失败放行紧急业务 
...
UDM|向AMF请求用户最新的位置更新信息，将得到的网络信息发送给IMS；向AMF发起被叫域问询。
###### 协议栈 
本特性涉及到的协议栈如[图2](1596788113883.html#T_2017510842497__d00e6f4f-15c8-4e74-b8be-5f2c75dc655b)所示。
图2  AMF和其他NF的接口协议栈
...
#### 配置过程 
1. 执行[SET 5GVONRCFG](../../Namf_Communication\zh-cn\mml\1100076.html)命令，配置AMF是否支持VoNR功能、及其AMF是否支持UE无线能力检查功能。
...
###### 系统架构 
本特性涉及到的网络结构如[图1](1583302507847.html#T_2017510842497__594dd164-625c-4b09-8339-a603ca763622)和[图2](1583302507847.html#T_2017510842497__a9ea3796-c958-49af-bfa2-e88bfb74e43b)所示。
...
#### 配置过程 
执行[SET SMSPOLICY](../../Namf_Communication\zh-cn\mml\1100240.html)命令，配置AMF支持SMS over NAS功能，以及用户去注册时通知SMSF。
...
##### 业务流程 
UE位置变化通知的流程如[图2](1575258102000.html#new216c1db393384fe4aba5188c54a5484b__UE%E4%BD%8D%E7%BD%AE%E5%8F%98%E5%8C%96%E9%80%9A%E7%9F%A5%E7%9A%84%E6%B5%81%E7%A8%8B%E5%9B%BE-A41C085C)所示。
图2  UE位置变化通知的流程图
...
#### 实现原理 
###### 系统架构 
支持LADN的架构如[图1](1575269998726.html#T_2017510842497__e5c5a61a-d662-4be5-9a24-8dd643ad48eb)所示。
图1  图1  支持LADN架构图
...
###### 业务流程 
支持LADN业务流程如[图2](1575269998726.html#T_2017510842497__d9303b7f-4822-4516-aa26-55a3976b35e0)所示。
图2  支持LADN业务流程图
...
#### 配置过程 
执行[ADD AMFLADN](../../Namf_Communication\zh-cn\mml\1100051.html)命令，增加LADN标识及对应的DNN。
...
###### 业务流程 
PCF通过SMF订阅PRA位置的流程如[图1](1583395958788.html#T_2017510842497__ebd8e598-85d4-47da-934e-73cbdc61177f)所示。
...
EM能正常连接并登录。 
#### 配置过程 
执行[SET PRAPOLICY](../../Namf_MP\zh-cn\mml\1100839.html)命令，设置支持PRA订阅功能，决定是否基于CPU控制PRA状态报告以及是否在PRA变更时触发Location Reportong Control消息。
...
#### 实现原理 
###### 系统架构 
LCS由UE、gNodeB（NG-RAN）、AMF、LMF、GMLC、UDM、LCS Client共同完成。LCS非漫游场景的网络架构如[图1](1595301468597.html#T_2017510842497__7a1ad95e-6138-4f40-8466-6a86a81729aa)所示。
图1  LCS网络架构-非漫游场景
...
#### O&M相关 
###### 命令 
新增配置命令参见[表1](1595301468597.html#T_20175108424914__52f22b94-8c01-4e89-a380-e28610773427)。
配置项|命令
---|---
...
### 特性配置 
#### 配置说明 
如果启用LCS功能，需开启license（uMAC_AMF_7232），并通过[SET LCSSWITCH](../../Namf_MP\zh-cn\mml\1100658.html)命令打开定位功能开关。由于默认的LMF发现模式为本地策略，可通过[ADD LMFNODECFG](../../Namf_MP\zh-cn\mml\1100660.html)、[ADD LMFLOCALADDRPOOL](../../Namf_MP\zh-cn\mml\1100728.html)命令配置目标LMF地址，通过SET LMFADDRCHOICEPOLICY命令修改地址类型（默认IPV4）。
...
#### 实现原理 
###### 系统架构 
LCS由UE、gNodeB（NG-RAN）、AMF、LMF、GMLC、UDM、LCS Client共同完成。LCS非漫游场景的网络架构如[图1](1631588337711.html#T_2017510842497__7a1ad95e-6138-4f40-8466-6a86a81729aa)所示。
图1  LCS网络架构-非漫游场景
...
#### O&M相关 
###### 命令 
新增配置命令参见[表1](1631588337711.html#T_20175108424914__52f22b94-8c01-4e89-a380-e28610773427)。
配置项|命令
---|---
定位开关配置|SET LCSSWITCH
SHOW LCSSWITCH|定位开关配置
...
#### 实现原理 
###### 系统架构 
AMF负载均衡在gNodeB与AMF Set内的各AMF之间执行，网络架构如[图1](1575275696960.html#T_2017510842497__fab87b2a-4312-4f83-b56a-43b042ad5b92)所示。
图1  系统架构
...
#### 实现原理 
###### 系统架构 
AMF负载重平衡由AMF Set内的某AMF发起，其中gNodeB，AMF，SMF，PCF，UDM配合完成负载重平衡的过程，其系统架构如[图1](1575275699881.html#T_2017510842497__9c8ebe50-3bbf-4ab6-a639-a3a069ab14cd)所示。
图1  系统架构
...
###### 业务流程 
对于N2接口的过载控制功能，是AMF与gNodeB之间实现N2 Overload Start和N2 Overload Stop的流程。AMF的N2接口过载控制功能流程如[图2](1575275702302.html#T_2017510842497__218f59ee-bf2d-4af0-8ae6-8d79f76a86c1)所示。
图2  N2接口过负荷控制
...
#### 配置过程 
执行[SET OLCPULEVELCFG](../../Namf_MP\zh-cn\mml\1100580.html)命令，修改CPU负荷等级配置。
...
#### 实现原理 
###### 系统架构 
终端异常信令管控网络架构如[图1](1599035323984.html#T_2017510842497__f0af3f54-38a3-4658-a4ef-8cef533a99d5)所示。
图1  终端异常信令管控网络架构
...
###### 业务流程 
注册请求异常信令管控流程如[图2](1599035323984.html#T_2017510842497__1d850e49-5081-4c93-bd2f-4a72d047cb3c)所示。
图2  注册请求异常信令管控流程图
...
AMF与网管之间连接正常。 
#### 配置过程 
执行[SET ABNORMALSIGMCPOLICY](../../Namf_Communication\zh-cn\mml\1104011.html)命令，进行AMF异常信令管控的策略配置。
...
#### 实现原理 
###### 系统架构 
系统架构如[图1](1631500794214.html#T_2017510842497__3f31d1de-9dec-480b-8519-031cb7ca2dc5)所示。
图1  系统架构图
...
###### 业务流程 
动态流控流程如[图2](1631500794214.html#T_2017510842497__064149c8-e104-4b9a-80d3-97ae2eb9a9eb)所示。
图2  动态流控流程
...
#### 配置过程 
执行[SET AMF AUTOCTL BASIC PARA](../../Namf_Communication\zh-cn\mml\1104360.html)命令，设置AMF自动业务控制基本参数。
...
###### 业务流程 
双连接时增加辅助基站的业务流程如[图4](1565263395083.html#T_2017510842497__SecondaryNodeAddition%E6%B5%81%E7%A8%8B%E5%9B%BE-B58B3136)所示。
...
#### 实现原理 
###### 系统架构 
5G MOCN组网架构如[图3](1565263398208.html#T_2017510842497__c5b1d990-47e2-42c5-b22a-f70b015a29db)所示，其中AMF A属于运营商A，AMF B属于运营商B，共享无线接入网。
图3  5G MOCN组网架构
...
系统正常运行。 
#### 配置过程 
在AMF节点下，执行[SET AMFSUPPORTMOCN](../../Namf_Communication\zh-cn\mml\1100041.html)命令，设置支持MOCN。
#### 配置实例 
###### 场景说明 
设置AMF支持MOCN功能。 
###### 配置步骤 
...
#### 实现原理 
###### 系统架构 
系统网络架构如[图1](1599212131333.html#T_2017510842497__8c378f98-ac52-4fa5-af95-0e4926b1c7b7)所示。
图1  5G系统网络架构
...
###### 背景知识 
SA组网时，无线可以采用双连接方式，如[图1](1617878200470.html#T_2017510842494__0215c0ae-77a2-40ff-bf90-772d2e1146cb)所示。Secondary Node可以和Master Node是同一RAT类型的Node，也可以是不同RAT类型的Node。
图1  双连接架构图
...
#### 实现原理 
###### 系统架构 
SA组网时，无线可以采用双连接方式，AMF支持第二RAT用量数据上报的系统架构如[图2](1617878200470.html#T_2017510842497__7063beaa-c886-4fa3-8523-b6aa5bb5f70f)所示。Secondary Node可以和Master Node是同一RAT类型的Node，也可以是不同RAT类型的Node。
...
#### 配置过程 
执行命令[ SET 5GDUALCONN](../../Namf_Communication\zh-cn\mml\1104154.html):IFAMFDUALCONN="YES",IFSUPUSAGEREPORT="YES"， 设置AMF支持双连接功能， 且支持Secondary RAT Usage Reporting功能。
#### 配置实例 
###### 场景说明 
...
###### 背景知识 
如[图1](1665540374404BZuvEu.html#T_2017510842494__ae7cd98b-fc30-4387-916f-5d817f578d52)所示，园区基站同时连接大网和园区应急网络，其中园区应急AMF下发给基站的权重为0。
...
#### 实现原理 
###### 系统架构 
N2接口惯性运行的系统架构如[图2](1665540374404BZuvEu.html#T_2017510842497__39e3853f-5d93-4a8e-8ee6-33709351fd8a)所示。
图2  N2接口惯性运行系统架构
...
###### 协议栈 
该特性涉及的接口协议栈参见[表1](1665540374404BZuvEu.html#T_2017510842497__f00f87c6-2e48-4c72-8c19-b044fda1c1ee)。
接口|协议栈信息参考
---|---
N2|ZUF-79-19-002 N2
N11|ZUF-79-19-004 N11
...
已完成了初始配置。 
#### 配置过程 
执行[SET INERTIAOPPLYCFG](../../Namf_MP\zh-cn\mml\1100963.html)命令，修改惯性运行策略配置。
其中惯性运行策略参数：
...
### 实现原理 
#### 涉及的网元 
涉及的NF参见[表1](#T_2017510842497__ef455a32-6d1c-4139-b7b4-1700315e7256)。
NF|说明
---|---
AMF|AMF通过N17口向5G-EIR请求终端设备状态。
5G-EIR|5G-EIR通过N17口向AMF提供终端设备状态。
#### 协议栈 
AMF与5G-EIR间的接口协议栈如[图1](#T_2017510842497__0272acde-3c9e-4621-82e2-529fc702c537)所示。
图1  AMF与5G-EIR间的接口协议栈
[]images/1642683775137.png)
#### 消息描述 
AMF和5G-EIR通过服务操作的调用，实现消息交互。AMF和5G-EIR在N17接口提供的服务参见[表2](#T_2017510842497__cb3f9568-0fed-42c4-849a-653b80694625)。
NF|服务|操作|操作语义|说明
---|---|---|---|---
...
EM网管能正常连接并登录。 
#### 配置过程 
执行[SET ROAMINGPOLICY](../../Namf_Communication\zh-cn\mml\1100259.html)命令，配置全局的漫游策略参数。
...
###### 业务流程 
I-SMF选择，AMF涉及的业务流程如[表1](1576048013659.html#T_2017510842497__df8c99c3-da50-4137-b427-4678b9e90a1a)所示。
场景|业务流程
---|---
...
### 特性配置 
#### 配置说明 
I-SMF有以下两种不同的发现方式，可以通过[SET NFDISCOVERYMODE CONFIG](../../Namf_Communication\zh-cn\mml\1100128.html)命令来配置NF发现模式，从而配置I-SMF发现方式。
NRF发现I-SMF。 
本地配置发现I-SMF。 
...
#### 应用场景 
用户跨大区/省移动后，原来的A-SMF无法服务于当前区域，AMF在PDU会话中插入I-SMF，I-SMF和A-SMF在不同区域。如[图1](1617881273403.html#T_2017510842495__674d0859-abb1-4e57-adf9-832821977da4)所示。
...
AMF支持I-SMF功能。 
#### 配置过程 
执行[SET PDUREBUILD POLICY](../../Namf_MP\zh-cn\mml\1100873.html)命令，设置PDU会话重建策略为支持。
...
#### 实现原理 
###### 系统架构 
AMF支持SMF故障网络及架构图如[图1](1600221465332.html#T_2017510842497__c514faef-06fb-4f94-bb1b-171c80bc5046)所示。
图1  SMF容灾架构示意图
...
#### 实现原理 
###### 系统架构 
AMF支持UDM容灾网络架构图如[图1](1600222077713.html#T_2017510842497__92eac7a4-3c96-4662-90e8-ed0691ddb1b3)所示。
图1  UDM容灾框架示意图
...
#### 实现原理 
###### 系统架构 
AMF支持PCF容灾网络架构图如[图1](1600222116338.html#T_2017510842497__2eb7e55b-7189-474a-b3d7-e5fafa1edaa4)所示。
图1  PCF容灾框架示意图
...
#### 实现原理 
###### 系统架构 
AMF支持NRF容灾功能网络架构如[图1](1600222150321.html#T_2017510842497__1888f2b6-f43f-4a13-b702-458e5cb318c9)、[图2](1600222150321.html#T_2017510842497__fe33862a-0216-47b2-9713-d9b694675d9f)、[图3](1600222150321.html#T_2017510842497__c548366a-394b-4a95-9274-34adf0d17cde)所示。
...
EM网管能正常连接并登录。 
#### 配置过程 
执行[ADD NRFNODECFG](../../Namf_MP\zh-cn\mml\1100598.html)命令，配置主用/备用NRF的IP地址参数。
...
#### 实现原理 
###### 系统架构 
AMF支持NSSF容灾功能网络架构如[图1](1600222179978.html#T_2017510842497__bb73242b-0f22-45c2-96a9-0acfe91c71ea)、[图2](1600222179978.html#T_2017510842497__9b2171cd-bb16-4741-8ee7-828054580251)所示。
图1  NSSF主备工作方式
...
#### 实现原理 
###### 系统架构 
AMF支持SMSF容灾网络架构图如[图1](1600222216019.html#T_2017510842497__8fb16cd0-a282-467b-892b-190e806221c1)所示。
图1  SMF容灾架构示意图
...
#### 实现原理 
###### 系统架构 
AMF处理基于UDM的P-CSCF Restoration通知业务流程架构如[图1](1605865557904.html#z070d1d2f8e2c4625ad51ede8d4f34906__0a234e9b-0129-4bde-a995-a1a317b24c91)所示。
...
AMF网管能正常连接。 
#### 配置过程 
配置功能开关和默认策略。执行[SET UDMPCSCFRESTORCFG](../../Namf_MP\zh-cn\mml\1100854.html)命令，设置AMF是否支持”基于UDM的P-CSCF故障恢复功能”、AMF是否支持”无IMS会话的P-CSCF故障恢复功能”。
#### 配置实例 
###### 场景说明 
